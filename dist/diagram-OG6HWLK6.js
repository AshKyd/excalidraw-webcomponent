import { _ as w, a1 as he, F as ee, H as K, L as ue, e as pe, l as Q, bc as P, d as j, b as fe, a as me, q as ge, t as ye, g as Se, s as ve, I as xe, bd as be, A as we } from "./index.js";
import { s as Ce } from "./chunk-2J33WTMH.js";
import { p as Te } from "./chunk-4BX2VUAB.js";
import { p as Le } from "./wardley-L42UT6IY.js";
...
function te(t, a) {
  ...
  for (var l = new U(t), n, r = [l], i, d, h, m; n = r.pop(); )
    if ((d = a(n.data)) && (m = (d = Array.from(d)).length))
      for (n.children = d, h = m - 1; h >= 0; --h)
        r.push(i = d[h] = new U(d[h])), i.parent = n, i.depth = n.depth + 1;
...
function Je(t, a, l, n, r, i) {
  for (var d = [], h = a.children, m, c, u = 0, b = 0, s = h.length, x, S, v = a.value, p, g, M, N, z, E, V; u < s; ) {
    ...
    d.push(m = { value: p, dice: x < S, children: h.slice(u, b) }), m.dice ? je(m, l, n, r, v ? n += S * p / v : i) : Ue(m, l, n, v ? l += x * p / v : r, i), v -= p, u = b;
  }
  return d;
}
...
function Qe() {
  var t = Ke, a = !1, l = 1, n = 1, r = [0], i = q, d = q, h = q, m = q, c = q;
  function u(s) {
  ...
  return u.round = function(s) {
    ...
    return arguments.length ? (i = typeof s == "function" ? s : G(+s), u) : i;
...
var et = /* @__PURE__ */ w((t, a) => {
  ...
  Y.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", (e) => e.y1 - e.y0).attr("class", "treemapLeaf").attr("fill", (e) => e.parent ? g(e.parent.data.name) : g(e.data.name)).attr("style", (e) => P({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles).attr("fill-opacity", 0.3).attr("stroke", (e) => e.parent ? g(e.parent.data.name) : g(e.data.name)).attr("stroke-width", 3), Y.append("clipPath").attr("id", (e, o) => `clip-${a}-${o}`).append("rect").attr("width", (e) => Math.max(0, e.x1 - e.x0 - 4)).attr("height", (e) => Math.max(0, e.y1 - e.y0 - 4)), Y.append("text").attr("class", "treemapLabel").attr("x", (e) => (e.x1 - e.x0) / 2).attr("y", (e) => (e.y1 - e.y0) / 2).attr("style", (e) => {
    ...
    f.attr("y", k);
    const H = o.x1 - o.x0, ce = o.y1 - o.y0 - 4, de = H - 8;
  ...
  const a = he(), l = ee(), n = K(a, l.themeVariables), r = K(st, t), i = r.titleColor ?? n.titleColor, d = r.labelColor ?? n.textColor, h = r.valueColor ?? n.textColor;
  return `
  .treemapNode.section {
...
//# sourceMappingURL=diagram-OG6HWLK6.js.map
