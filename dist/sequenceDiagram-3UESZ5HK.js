import { _ as g, o as er, c as $, d as Bt, l as at, j as Me, e as rr, f as ar, k as P, b as De, s as sr, q as ir, a as nr, g as or, t as cr, v as lr, J as hr, A as dr, i as Vt, u as Z, a2 as Q, a3 as Nt, a4 as Be, a5 as Tr, F as Wt, a6 as pr, a7 as Ve } from "./index.js";
import { a as Er, b as re, g as dt, d as ur, e as ae, f as se } from "./chunk-ND2GUHAM.js";
import { I as fr } from "./chunk-QZHKN3VN.js";
var jt = (function() {
  var e = /* @__PURE__ */ g(function(ut, w, v, k) {
    for (v = v || {}, k = ut.length; k--; v[ut[k]] = w) ;
    return v;
  }, "o"), t = [1, 2], a = [1, 3], r = [1, 4], i = [2, 4], n = [1, 9], s = [1, 11], l = [1, 12], E = [1, 14], d = [1, 15], c = [1, 17], x = [1, 18], u = [1, 19], O = [1, 25], p = [1, 26], f = [1, 27], _ = [1, 28], I = [1, 29], L = [1, 30], b = [1, 31], S = [1, 32], A = [1, 33], N = [1, 34], B = [1, 35], V = [1, 36], q = [1, 37], U = [1, 38], G = [1, 39], X = [1, 40], j = [1, 42], H = [1, 43], st = [1, 44], tt = [1, 45], it = [1, 46], Y = [1, 47], C = [1, 4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 49, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], Pt = [1, 74], m = [1, 80], D = [1, 81], lt = [1, 82], et = [1, 83], W = [1, 84], ie = [1, 85], ne = [1, 86], oe = [1, 87], ce = [1, 88], le = [1, 89], he = [1, 90], de = [1, 91], Te = [1, 92], pe = [1, 93], Ee = [1, 94], ue = [1, 95], fe = [1, 96], _e = [1, 97], ge = [1, 98], xe = [1, 99], Ie = [1, 100], ye = [1, 101], Re = [1, 102], Oe = [1, 103], Le = [1, 104], be = [1, 105], me = [2, 78], At = [4, 5, 17, 51, 53, 54], kt = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 51, 53, 54, 56, 61, 62, 63, 64, 73], Ae = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], zt = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 49, 51, 53, 54, 56, 61, 62, 63, 64, 73], Se = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 51, 53, 54, 56, 61, 62, 63, 64, 73], Ut = [5, 52], K = [70, 71, 72, 73], ot = [1, 151], Gt = {
    ...
    parse: /* @__PURE__ */ g(function(w) {
      var v = this, k = [0], y = [], z = [null], o = [], St = this.table, T = "", vt = 0, we = 0, Qe = 2, Ne = 1, $e = o.slice.call(arguments, 1), J = Object.create(this.lexer), gt = { yy: {} };
      ...
      function Pe() {
        var nt;
        return nt = y.pop() || J.lex() || Ne, typeof nt != "number" && (nt instanceof Array && (y = nt, nt = y.pop()), nt = v.symbols_[nt] || nt), nt;
      }
      g(Pe, "lex");
      for (var rt, xt, ct, Zt, Ot = {}, Ct, Tt, ke, Mt; ; ) {
        if (xt = k[k.length - 1], this.defaultActions[xt] ? ct = this.defaultActions[xt] : ((rt === null || typeof rt > "u") && (rt = Pe()), ct = St[xt] && St[xt][rt]), typeof ct > "u" || !ct.length || !ct[0]) {
          ...
          J.showPosition ? Qt = "Parse error on line " + (vt + 1) + `:
` + J.showPosition() + `
Expecting ` + Mt.join(", ") + ", got '" + (this.terminals_[rt] || rt) + "'" : Qt = "Parse error on line " + (vt + 1) + ": Unexpected " + (rt == Ne ? "end of input" : "'" + (this.terminals_[rt] || rt) + "'"), this.parseError(Qt, {
        ...
        switch (ct[0]) {
          case 1:
            k.push(rt), z.push(J.yytext), o.push(J.yylloc), k.push(ct[1]), rt = null, we = J.yyleng, T = J.yytext, vt = J.yylineno, Jt = J.yylloc;
            break;
          case 2:
...
`;
...
}, "drawPopup"), qt = /* @__PURE__ */ g(function(e) {
  ...
  var p = O;
  r || (M++, Object.keys(t.links || {}).length && !a.forceMenus && p.attr("onclick", qt(`actor${M}_popup`)).attr("cursor", "pointer"), p.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", l).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), p = O.append("g"), t.actorCnt = M, t.links != null && p.attr("id", "root-" + M), E === "neo" && p.attr("data-look", "neo"));
  const f = dt();
  var _ = "actor";
  ...
  if (pt.has(d) && (b.style("stroke", u[N % u.length]), b.style("fill", x[N % u.length]), S.style("stroke", u[N % u.length]), S.style("fill", x[N % u.length])), t.properties?.icon) {
    ...
    q.charAt(0) === "@" ? ae(p, U, G, q.substr(1)) : se(p, U, G, q);
  }
  Et(a, Q(t.description))(
    t.description,
    p,
  ...
  return t.height = A.height + (a?.sequence?.labelBoxHeight ?? 0), r || (M++, O.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", l).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = M), Et(a, Q(t.description))(
    t.description,
    p,
    _.x,
    _.y + (r ? 15 : 30),
  ...
  let f = p;
  r || (M++, Object.keys(t.links || {}).length && !a.forceMenus && f.attr("onclick", qt(`actor${M}_popup`)).attr("cursor", "pointer"), f.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", l).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), f = p.append("g"), t.actorCnt = M, t.links != null && f.attr("id", "root-" + M), c === "neo" && f.attr("data-look", "neo"));
  const _ = dt();
  let I = "actor";
...
`;
  ...
  const N = i.get(t.name) ?? 0;
  return pt.has(d) ? (f.style("stroke", u[N % u.length]), f.style("fill", x[N % u.length])) : f.style("stroke", O), Et(a, Q(t.description))(
    t.description,
    f,
    A.x,
    L + 35 * I - (E === "neo" ? 10 : 0),
  ...
  let f = Q(p.text) ? await Kt(u, p, t) : mt(u, p);
  if (t.sectionTitles !== void 0) {
    for (const [_, I] of Object.entries(t.sectionTitles))
      if (I.message) {
        p.text = I.message, p.x = t.startx + (t.stopx - t.startx) / 2, p.y = t.sections[_].y + n + s, p.class = "sectionTitle", p.anchor = "middle", p.valign = "middle", p.tspan = !1, p.fontFamily = d, p.fontSize = c, p.fontWeight = x, p.wrap = t.wrap, Q(p.text) ? (t.starty = t.sections[_].y, await Kt(u, p, t)) : mt(u, p);
        let L = Math.round(
...
}, "insertArrowFilledHead"), qr = /* @__PURE__ */ g(function(e, t) {
  ...
  newActivation: /* @__PURE__ */ g(function(e, t, a) {
    const r = a.get(e.from), i = Ht(e.from).length || 0, n = r.x + r.width / 2 + (i - 1) * h.activationWidth / 2;
  ...
  const l = Q(s.text) ? await Kt(i, s) : mt(i, s), E = Math.round(
...
async function qe(e, t) {
  ...
  const { startx: a, stopx: r, message: i } = t, n = P.splitBreaks(i).length, s = Q(i), l = s ? await Nt(i, $()) : Z.calculateTextDimensions(i, Rt(h));
  if (!s) {
    const x = l.height / n;
...
var jr = /* @__PURE__ */ g(async function(e, t, a, r, i, n) {
  const { startx: s, stopx: l, starty: E, message: d, type: c, sequenceIndex: x, sequenceVisible: u } = t, O = Z.calculateTextDimensions(d, Rt(h)), p = re();
  p.x = Math.min(s, l), p.y = E + 10, p.width = Math.abs(l - s), p.class = "messageText", p.dy = "1em", p.text = d, p.fontFamily = h.messageFontFamily, p.fontSize = h.messageFontSize, p.fontWeight = h.messageFontWeight, p.anchor = h.messageAlign, p.valign = "center", p.textMargin = h.wrapPadding, p.tspan = !1, Q(p.text) ? await Kt(e, p, { startx: s, stopx: l, starty: a }) : mt(e, p);
  const f = O.width;
  let _;
  if (s === l) {
  ...
  if (h.arrowMarkerAbsolute && (I = pr(!0)), _.attr("stroke-width", 2), _.attr("stroke", "none"), _.style("fill", "none"), (c === r.db.LINETYPE.SOLID_TOP || c === r.db.LINETYPE.SOLID_TOP_DOTTED) && _.attr("marker-end", "url(" + I + "#" + n + "-solidTopArrowHead)"), (c === r.db.LINETYPE.SOLID_BOTTOM || c === r.db.LINETYPE.SOLID_BOTTOM_DOTTED) && _.attr("marker-end", "url(" + I + "#" + n + "-solidBottomArrowHead)"), (c === r.db.LINETYPE.STICK_TOP || c === r.db.LINETYPE.STICK_TOP_DOTTED) && _.attr("marker-end", "url(" + I + "#" + n + "-stickTopArrowHead)"), (c === r.db.LINETYPE.STICK_BOTTOM || c === r.db.LINETYPE.STICK_BOTTOM_DOTTED) && _.attr("marker-end", "url(" + I + "#" + n + "-stickBottomArrowHead)"), (c === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE || c === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED) && _.attr("marker-start", "url(" + I + "#" + n + "-solidBottomArrowHead)"), (c === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE || c === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED) && _.attr("marker-start", "url(" + I + "#" + n + "-solidTopArrowHead)"), (c === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE || c === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED) && _.attr("marker-start", "url(" + I + "#" + n + "-stickBottomArrowHead)"), (c === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE || c === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED) && _.attr("marker-start", "url(" + I + "#" + n + "-stickTopArrowHead)"), (c === r.db.LINETYPE.SOLID || c === r.db.LINETYPE.DOTTED) && _.attr("marker-end", "url(" + I + "#" + n + "-arrowhead)"), (c === r.db.LINETYPE.BIDIRECTIONAL_SOLID || c === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (_.attr("marker-start", "url(" + I + "#" + n + "-arrowhead)"), _.attr("marker-end", "url(" + I + "#" + n + "-arrowhead)")), (c === r.db.LINETYPE.SOLID_POINT || c === r.db.LINETYPE.DOTTED_POINT) && _.attr("marker-end", "url(" + I + "#" + n + "-filled-head)"), (c === r.db.LINETYPE.SOLID_CROSS || c === r.db.LINETYPE.DOTTED_CROSS) && _.attr("marker-end", "url(" + I + "#" + n + "-crosshead)"), u || h.showSequenceNumbers) {
    ...
    X > 5 ? G = "7px" : X > 3 && (G = "9px"), e.append("line").attr("x1", V).attr("y1", a).attr("x2", V).attr("y2", a).attr("stroke-width", 0).attr("marker-start", "url(" + I + "#" + n + "-sequencenumber)"), e.append("text").attr("x", V).attr("y", a + 4).attr("font-family", "sans-serif").attr("font-size", G).attr("text-anchor", "middle").attr("class", "sequenceNumber").text(x);
  }
...
function ht(e, t, a, r, i) {
  ...
  if (t.id && t.message && e[t.id]) {
    ...
    t.message = Z.wrapLabel(`[${t.message}]`, s - 2 * h.wrapPadding, l), t.width = s, t.wrap = !0;
    const E = Z.calculateTextDimensions(t.message, l), d = P.getMax(E.height, h.labelBoxHeight);
...
var ea = /* @__PURE__ */ g(async function(e, t, a, r) {
  ...
  const j = He(c, x, f, d), { bounds: H } = R.getBounds();
  ...
  I && c.append("text").text(I).attr("x", (H.stopx - H.startx) / 2 - 2 * h.diagramMarginX).attr("y", -25), rr(c, tt, Y, h.useMaxWidth);
  const C = I ? 40 : 0, Pt = x.size && s === "neo" ? 30 : 0;
  c.attr(
    "viewBox",
    H.startx - h.diagramMarginX + " -" + (h.diagramMarginY + C) + " " + Y + " " + (tt + C + Pt)
  ...
  for (const i of t)
    if (e.get(i.to) && e.get(i.from)) {
      ...
      if (i.placement === a.db.PLACEMENT.LEFTOF && !n.prevActor || i.placement === a.db.PLACEMENT.RIGHTOF && !n.nextActor)
        continue;
      const s = i.placement !== void 0, l = !s, E = s ? Lt(h) : Rt(h), d = i.wrap ? Z.wrapLabel(i.message, h.width - 2 * h.wrapPadding, E) : i.message, x = (Q(d) ? await Nt(i.message, $()) : Z.calculateTextDimensions(d, E)).width + 2 * h.wrapPadding;
...
async function Xe(e, t, a) {
  ...
  for (const n of e.keys()) {
    ...
    const l = Q(s.description) ? await Nt(s.description, $()) : Z.calculateTextDimensions(s.description, te(h));
  ...
  return a.forEach((n) => {
    ...
    l += E, l -= 2 * h.boxTextMargin, n.wrap && (n.name = Z.wrapLabel(n.name, l - 2 * h.wrapPadding, s));
...
var aa = /* @__PURE__ */ g(async function(e, t, a) {
  ...
  let E = Q(e.message) ? await Nt(e.message, $()) : Z.calculateTextDimensions(
    l ? Z.wrapLabel(e.message, h.width, Lt(h)) : e.message,
    Lt(h)
  );
  const d = {
  ...
  return e.placement === a.db.PLACEMENT.RIGHTOF ? (d.width = l ? P.getMax(h.width, E.width) : P.getMax(
    ...
    r.width / 2 + i.width / 2,
    E.width + 2 * h.noteMargin
  ), d.startx = n - d.width + (r.width - h.actorMargin) / 2) : e.to === e.from ? (E = Z.calculateTextDimensions(
    l ? Z.wrapLabel(e.message, P.getMax(h.width, r.width), Lt(h)) : e.message,
    Lt(h)
  ), d.width = l ? P.getMax(h.width, r.width) : P.getMax(r.width, h.width, E.width + 2 * h.noteMargin), d.startx = n + (r.width - d.width) / 2) : (d.width = Math.abs(n + r.width / 2 - (s + i.width / 2)) + h.actorMargin, d.startx = n < s ? n + r.width / 2 - h.actorMargin / 2 : s + i.width / 2 - h.actorMargin / 2), l && (d.message = Z.wrapLabel(
    e.message,
  ...
  for (const d of e) {
    switch (d.type) {
      ...
      case r.db.LINETYPE.ACTIVE_START:
        {
          const x = t.get(d.from ? d.from : d.to.actor), u = Ht(d.from ? d.from : d.to.actor).length, O = x.x + x.width / 2 + (u - 1) * h.activationWidth / 2, p = {
            startx: O,
...
//# sourceMappingURL=sequenceDiagram-3UESZ5HK.js.map
