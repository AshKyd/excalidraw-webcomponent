...
function Qe(r, e) {
  return rc(r) || ic(r, e) || Xs(r, e) || sc();
}
function mn(r) {
  return tc(r) || nc(r) || Xs(r) || oc();
}
function uc(r, e) {
...
var je = typeof window > "u" ? null : window, To = je ? je.navigator : null;
je && je.document;
var lc = rr(""), ev = rr({}), vc = rr(function() {
}), fc = typeof HTMLElement > "u" ? "undefined" : rr(HTMLElement), La = function(e) {
  return e && e.instanceString && $e(e.instanceString) ? e.instanceString() : null;
}, he = function(e) {
  return e != null && rr(e) == lc;
}, $e = function(e) {
  return e != null && rr(e) === vc;
}, Ve = function(e) {
  return !Tr(e) && (Array.isArray ? Array.isArray(e) : e != null && e instanceof Array);
}, Me = function(e) {
  return e != null && rr(e) === ev && !Ve(e) && e.constructor === Object;
}, cc = function(e) {
  return e != null && rr(e) === ev;
}, ae = function(e) {
...
}, er = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))", bc = "rgb[a]?\\((" + er + "[%]?)\\s*,\\s*(" + er + "[%]?)\\s*,\\s*(" + er + "[%]?)(?:\\s*,\\s*(" + er + "))?\\)", wc = "rgb[a]?\\((?:" + er + "[%]?)\\s*,\\s*(?:" + er + "[%]?)\\s*,\\s*(?:" + er + "[%]?)(?:\\s*,\\s*(?:" + er + "))?\\)", xc = "hsl[a]?\\((" + er + ")\\s*,\\s*(" + er + "[%])\\s*,\\s*(" + er + "[%])(?:\\s*,\\s*(" + er + "))?\\)", Ec = "hsl[a]?\\((?:" + er + ")\\s*,\\s*(?:" + er + "[%])\\s*,\\s*(?:" + er + "[%])(?:\\s*,\\s*(?:" + er + "))?\\)", Cc = "\\#[0-9a-fA-F]{3}", Tc = "\\#[0-9a-fA-F]{6}", nv = function(e, t) {
  ...
  return (Ve(e) ? e : null) || Pc(e) || kc(e) || Bc(e) || Dc(e);
}, Ac = {
...
function uv() {
  if (Oo) return oi;
  Oo = 1;
  var r = Qs(), e = Oc(), t = Nc(), a = "[object Null]", n = "[object Undefined]", i = r ? r.toStringTag : void 0;
  function s(o) {
...
function Vc() {
  ...
  function s(o, u, l) {
    ...
    function E(A) {
      return g = A, d = setTimeout(S, u), p ? w(A) : h;
    }
    function C(A) {
    ...
    function P() {
      ...
      if (v = arguments, f = this, y = A, R) {
        if (d === void 0)
          return E(y);
        if (m)
          return clearTimeout(d), d = setTimeout(S, u), w(y);
      }
      return d === void 0 && (d = setTimeout(S, u)), h;
    }
    return P.cancel = B, P.flush = D, P;
  }
  return fi = s, fi;
}
var qc = Vc(), Fa = /* @__PURE__ */ Oa(qc), ci = je ? je.performance : null, lv = ci && ci.now ? function() {
  return ci.now();
} : function() {
  return Date.now();
}, _c = (function() {
  ...
  return _c(e);
}, Xr = lv, Ct = 9261, vv = 65599, _t = 5381, fv = function(e) {
...
var _o = !0, Kc = console.warn != null, Xc = console.trace != null, Js = Number.MAX_SAFE_INTEGER || 9007199254740991, dv = function() {
  return !0;
}, xn = function() {
  return !1;
}, Go = function() {
  ...
  return e == null ? e : Ve(e) ? e.slice() : Me(e) ? Yc(e) : e;
}, Zc = function(e) {
  return e.slice();
}, gv = function(e, t) {
  for (
...
})(), Kr = typeof Map < "u" ? Map : jc, ed = "undefined", rd = /* @__PURE__ */ (function() {
  function r(e) {
...
})(), ra = (typeof Set > "u" ? "undefined" : rr(Set)) !== ed ? Set : rd, In = function(e, t) {
  ...
  return e = {
    ...
    for (var C = function() {
      ...
      if (_ === !1)
        return 1;
      for (var N = A.connectedEdges().filter(function(ee) {
        return (!i || ee.source().same(A)) && m.has(ee);
      }), V = 0; V < N.length; V++) {
        var Y = N[V], J = Y.connectedNodes().filter(function(ee) {
          return !ee.same(A) && p.has(ee);
        }), Z = J.id();
        J.length !== 0 && !h[Z] && (J = J[0], l.push(J), e.bfs && (h[Z] = !0, v.push(J)), f[Z] = Y, c[Z] = c[R] + 1);
      }
    }, x; l.length !== 0 && (x = C(), !(x !== 0 && x === 1)); )
      ;
    for (var S = o.collection(), k = 0; k < v.length; k++) {
      var B = v[k], D = f[B.id()];
      D != null && S.push(D), S.push(B);
    }
    return {
      path: o.collection(S),
...
var on = { exports: {} }, td = on.exports, Wo;
function ad() {
    ...
    (function() {
      ...
      n = Math.floor, f = Math.min, a = function(p, m) {
        ...
        if (b == null && (b = a), E = p.slice(0, m), !E.length)
          return E;
        for (i(E, b), S = p.slice(m), C = 0, x = S.length; C < x; C++)
          w = S[C], u(E, w, b);
        return E.sort(b).reverse();
      }, h = function(p, m, b) {
        var w, E, C, x, S, k, B, D, P;
        ...
        for (i(p, b), P = [], S = 0, D = f(m, p.length); 0 <= D ? S < D : S > D; 0 <= D ? ++S : --S)
          P.push(s(p, b));
        return P;
      }, y = function(p, m, b, w) {
        var E, C, x;
        ...
        var w, E, C, x, S;
        for (b == null && (b = a), E = p.length, S = m, C = p[m], w = 2 * m + 1; w < E; )
          x = w + 1, x < E && !(b(p[w], p[x]) < 0) && (w = x), p[m] = p[w], m = w, w = 2 * m + 1;
        return p[m] = C, y(p, S, m, b);
      }, t = (function() {
...
var di, $o;
function nd() {
  return $o || ($o = 1, di = ad()), di;
}
var id = nd(), Va = /* @__PURE__ */ Oa(id), sd = vr({
  root: null,
  weight: function(e) {
    return 1;
  },
  ...
  aStar: function(e) {
    ...
    var l = n.id(), v = i.id(), f = {}, c = {}, h = {}, d = new Va(function(_, N) {
      return c[_.id()] - c[N.id()];
    }), y = new ra(), g = {}, p = {}, m = function(N, V) {
      d.push(N), y.add(V);
    }, b, w, E = function() {
    ...
    for (var x = 0; d.size() > 0; ) {
      if (E(), x++, w === v) {
        for (var S = [], k = i, B = v, D = p[B]; S.unshift(k), D != null && S.unshift(D), k = g[B], k != null; )
          B = k.id(), D = p[B];
        return {
          found: !0,
          distance: f[w],
  ...
  floydWarshall: function(e) {
    for (var t = this.cy(), a = fd(e), n = a.weight, i = a.directed, s = n, o = this.byGroup(), u = o.nodes, l = o.edges, v = u.length, f = v * v, c = function(Y) {
      return u.indexOf(Y);
    }, h = function(Y) {
      return u[Y];
    ...
    for (var m = new Array(f), b = new Array(f), w = 0; w < l.length; w++) {
      ...
      if (C !== x) {
        var S = c(C), k = c(x), B = S * v + k, D = s(E);
        if (d[B] > D && (d[B] = D, m[B] = k, b[B] = E), !i) {
          var P = k * v + S;
          !i && d[P] > D && (d[P] = D, m[P] = S, b[P] = E);
        }
      }
    }
    for (var A = 0; A < v; A++)
    ...
    var q = function(Y) {
      return (he(Y) ? t.filter(Y) : Y)[0];
    }, _ = function(Y) {
      return c(q(Y));
    }, N = {
      distance: function(Y, J) {
        var Z = _(Y), ee = _(J);
        return d[Z * v + ee];
      },
      path: function(Y, J) {
        var Z = _(Y), ee = _(J), re = h(Z);
        if (Z === ee)
          return re.collection();
        if (m[Z * v + ee] == null)
          return t.collection();
        var ne = t.collection(), X = Z, F;
        for (ne.merge(re); Z !== ee; )
          X = Z, Z = m[Z * v + ee], F = b[X * v + Z], ne.merge(F), ne.merge(h(Z));
        return ne;
      }
    };
    return N;
  ...
  bellmanFord: function(e) {
    var t = this, a = dd(e), n = a.weight, i = a.directed, s = a.root, o = n, u = this, l = this.cy(), v = this.byGroup(), f = v.edges, c = v.nodes, h = c.length, d = new Kr(), y = !1, g = [];
    ...
    for (var p = f.length, m = function(me) {
      ...
      for (var ge = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : s, se = b(me), de = [], ce = se; ; ) {
        if (ce == null)
          return t.spawn();
        var xe = m(ce), be = xe.edge, Se = xe.pred;
        if (de.unshift(ce[0]), ce.same(ge) && de.length > 0)
          break;
        be != null && de.unshift(be), ce = Se;
      }
      return u.spawn(de);
    }, C = 0; C < h; C++) {
      var x = c[C], S = m(x);
    ...
    for (var k = !1, B = function(me, ge, se, de, ce, xe) {
      var be = de.dist + xe;
      be < ce.dist && !se.same(de.edge) && (ce.dist = be, ce.pred = me, ce.edge = se, k = !0);
    }, D = 1; D < h; D++) {
      k = !1;
      for (var P = 0; P < p; P++) {
        var A = f[P], R = A.source(), L = A.target(), I = o(A), M = m(R), O = m(L);
        B(R, L, A, M, O, I), i || B(L, R, A, O, M, I);
      }
      if (!k)
        break;
    }
    if (k)
      for (var q = [], _ = 0; _ < p; _++) {
        var N = f[_], V = N.source(), Y = N.target(), J = o(N), Z = m(V).dist, ee = m(Y).dist;
        if (Z + J < ee || !i && ee + J < Z)
          if (y || (ze("Graph contains a negative weight cycle for Bellman-Ford"), y = !0), e.findNegativeWeightCycles !== !1) {
            var re = [];
            Z + J < ee && re.push(V), !i && ee + J < Z && re.push(Y);
            for (var ne = re.length, X = 0; X < ne; X++) {
              var F = re[X], H = [F];
              H.push(m(F).edge);
              for (var W = m(F).pred; H.indexOf(W) === -1; )
                H.push(W), H.push(m(W).edge), W = m(W).pred;
              H = H.slice(H.indexOf(W));
              for (var U = H[0].id(), te = 0, le = 2; le < H.length; le += 2)
                H[le].id() < U && (U = H[le].id(), te = le);
              H = H.slice(te).concat(H.slice(0, te)), H.push(H[0]);
              var De = H.map(function(we) {
                return we.id();
              }).join(",");
              q.indexOf(De) === -1 && (g.push(u.spawn(H)), q.push(De));
            }
          } else
            break;
      }
  ...
  kargerStein: function() {
    ...
    var L = function(q) {
      ...
      return q.forEach(function(N) {
        _.merge(N), N.connectedEdges().forEach(function(V) {
          e.contains(V) && !S.contains(V) && _.merge(V);
        });
      }), _;
    }, I = [L(k), L(B)], M = {
      cut: S,
...
}, Pd = (gi = Math.hypot) !== null && gi !== void 0 ? gi : function(r, e) {
...
function Ad(r, e) {
  ...
  var t = function(S, k) {
    ...
    for (var k = 0, B = 0; B < S.length; B++) {
      var D = S[B], P = S[(B + 1) % S.length];
      k += D.x * P.y - P.x * D.y;
    }
    return k / 2;
  }, u = function(S, k, B, D) {
    var P = a(k, S), A = a(D, B), R = i(P, A);
    if (Math.abs(R) < 1e-9)
      return t(S, n(P, 0.5));
    var L = i(a(B, S), A) / R;
    return t(S, n(P, L));
  ...
  for (var p = f.map(function(x, S) {
    var k = t(l[S], n(x, e)), B = t(l[(S + 1) % v], n(x, e));
    return {
      p1: k,
      p2: B
    };
...
function Rd(r, e, t, a, n, i) {
  var s = qd(r, e, t, a, n), o = Ad(s, i), u = mr();
...
var wv = function(e, t, a, n, i, s, o) {
  ...
  if (c) {
    var x = a - v + l - o, S = n + f + o, k = a + v - l + o, B = S;
    if (d = nt(e, t, a, n, x, S, k, B, !1), d.length > 0)
      return d;
  }
  if (h) {
    var D = a - v - o, P = n - f + l - o, A = D, R = n + f - l + o;
    if (d = nt(e, t, a, n, D, P, A, R, !1), d.length > 0)
      return d;
  }
  var L;
  {
  ...
  {
    var O = a + v - l, q = n - f + l;
    if (L = ya(e, t, a, n, O, q, l + o), L.length > 0 && L[0] >= O && L[1] <= q)
      return [L[0], L[1]];
  }
  {
    var _ = a + v - l, N = n + f - l;
    if (L = ya(e, t, a, n, _, N, l + o), L.length > 0 && L[0] >= _ && L[1] >= N)
      return [L[0], L[1]];
  }
  {
    var V = a - v + l, Y = n + f - l;
    if (L = ya(e, t, a, n, V, Y, l + o), L.length > 0 && L[0] <= V && L[1] >= Y)
      return [L[0], L[1]];
  }
  return [];
}, Md = function(e, t, a, n, i, s, o) {
  var u = o, l = Math.min(a, i), v = Math.max(a, i), f = Math.min(n, s), c = Math.max(n, s);
  return l - u <= e && e <= v + u && f - u <= t && t <= c + u;
}, Ld = function(e, t, a, n, i, s, o, u, l) {
  var v = {
    x1: Math.min(a, o, i) - l,
    x2: Math.max(a, o, i) + l,
    y1: Math.min(n, u, s) - l,
  ...
  if (m !== 0) {
    ...
    return g === 0 || p === 0 ? pi(e, a, o) === o ? [o, u] : pi(e, a, i) === i ? [i, s] : pi(i, o, a) === a ? [a, n] : [] : [];
}, qd = function(e, t, a, n, i) {
...
function yi(r, e) {
  ...
  var i = [].concat(mn(t(r)), mn(t(e))), s = Cr(i), o;
  try {
    for (s.s(); !(o = s.n()).done; ) {
...
var Hd = vr({
  ...
  pageRank: function(e) {
    for (var t = Hd(e), a = t.dampingFactor, n = t.precision, i = t.iterations, s = t.weight, o = this._private.cy, u = this.byGroup(), l = u.nodes, v = u.edges, f = l.length, c = f * f, h = v.length, d = new Array(c), y = new Array(f), g = (1 - a) / f, p = 0; p < f; p++) {
      for (var m = 0; m < f; m++) {
        var b = p * f + m;
        d[b] = 0;
      }
    ...
    for (var w = 0; w < h; w++) {
      ...
      if (C !== x) {
        var S = l.indexOfId(C), k = l.indexOfId(x), B = s(E), D = k * f + S;
        d[D] += B, y[S] += B;
      }
    }
...
var Yo = vr({
  ...
  closenessCentralityNormalized: function(e) {
    for (var t = Yo(e), a = t.harmonic, n = t.weight, i = t.directed, s = this.cy(), o = {}, u = 0, l = this.nodes(), v = this.floydWarshall({
      weight: n,
      directed: i
    }), f = 0; f < l.length; f++) {
...
var $d = vr({
  ...
  betweennessCentrality: function(e) {
    for (var t = $d(e), a = t.directed, n = t.weight, i = n != null, s = this.cy(), o = this.nodes(), u = {}, l = {}, v = 0, f = {
      set: function(b, w) {
        l[b] = w, w > v && (v = w);
      },
      get: function(b) {
    ...
    for (var y = function() {
      for (var b = o[g].id(), w = [], E = {}, C = {}, x = {}, S = new Va(function(J, Z) {
        return x[J] - x[Z];
      }), k = 0; k < o.length; k++) {
        var B = o[k].id();
        E[B] = [], C[B] = 0, x[B] = 1 / 0;
      }
      for (C[b] = 1, x[b] = 0, S.push(b); !S.empty(); ) {
        var D = S.pop();
        if (w.push(D), i)
          for (var P = 0; P < u[D].length; P++) {
            ...
            var I = n(L);
            A = A.id(), x[A] > x[D] + I && (x[A] = x[D] + I, S.nodes.indexOf(A) < 0 ? S.push(A) : S.updateItem(A), C[A] = 0, E[A] = []), x[A] == x[D] + I && (C[A] = C[A] + C[D], E[A].push(D));
          }
        else
          for (var M = 0; M < u[D].length; M++) {
            var O = u[D][M].id();
            x[O] == 1 / 0 && (S.push(O), x[O] = x[D] + 1), x[O] == x[D] + 1 && (C[O] = C[O] + C[D], E[O].push(D));
          }
      }
      for (var q = {}, _ = 0; _ < o.length; _++)
        q[o[_].id()] = 0;
      for (; w.length > 0; ) {
        for (var N = w.pop(), V = 0; V < E[N].length; V++) {
          var Y = E[N][V];
          q[Y] = q[Y] + C[Y] / C[N] * (1 + q[N]);
        }
...
var Ud = vr({
  ...
  for (var t = 0; t < e.length; t++)
    for (var a = 0; a < e.length; a++)
      t != a && rh(e[t], e[a]) && e.splice(a, 1);
  return e;
}, Zo = function(e) {
  for (var t = this.nodes(), a = this.edges(), n = this.cy(), i = Kd(e), s = {}, o = 0; o < t.length; o++)
    s[t[o].id()] = o;
  for (var u = t.length, l = u * u, v = new Array(l), f, c = 0; c < l; c++)
    v[c] = 0;
  for (var h = 0; h < a.length; h++) {
    var d = a[h], y = s[d.source().id()], g = s[d.target().id()], p = Xd(d, i.attributes);
    v[y * u + g] += p, v[g * u + y] += p;
  }
  Yd(v, u, i.multFactor), Cv(v, u);
  for (var m = !0, b = 0; m && b < i.maxIterations; )
    m = !1, f = Qd(v, u, i.expandFactor), v = Jd(f, u, i.inflateFactor), jd(v, f, l, 4) || (m = !0), b++;
  var w = eh(v, u, t, n);
  return w = th(w), w;
}, ah = {
  markovClustering: Zo,
  ...
  for (var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : nh, o = n, u, l, v = 0; v < e; v++)
    u = t(v), l = a(v), o = i(o, u, l);
  return s(o);
}, Zt = {
  euclidean: function(e, t, a) {
    return e >= 2 ? va(e, t, a, 0, Jo, ih) : va(e, t, a, 0, Qo);
  },
...
var oh = vr({
  ...
  var t = this.cy(), a = this.nodes(), n = null, i = io(e), s = new Array(i.k), o = {}, u;
  i.testMode ? typeof i.testCentroids == "number" ? (i.testCentroids, u = mi(a, i.k, i.attributes)) : rr(i.testCentroids) === "object" ? u = i.testCentroids : u = mi(a, i.k, i.attributes) : u = mi(a, i.k, i.attributes);
  for (var l = !0, v = 0; l && v < i.maxIterations; ) {
    for (var f = 0; f < a.length; f++)
      n = a[f], o[n.id()] = Sv(n, u, i.distance, i.attributes, "kMeans");
    l = !1;
    for (var c = 0; c < i.k; c++) {
      var h = kv(c, a, o);
      if (h.length !== 0) {
        for (var d = i.attributes.length, y = u[c], g = new Array(d), p = new Array(d), m = 0; m < d; m++) {
          ...
          g[m] = p[m] / h.length, uh(g[m], y[m], i.sensitivityThreshold) || (l = !0);
        }
  ...
  var t = this.cy(), a = this.nodes(), n = null, i = io(e), s = new Array(i.k), o, u = {}, l, v = new Array(i.k);
  i.testMode ? typeof i.testCentroids == "number" || (rr(i.testCentroids) === "object" ? o = i.testCentroids : o = jo(a, i.k)) : o = jo(a, i.k);
  for (var f = !0, c = 0; f && c < i.maxIterations; ) {
    for (var h = 0; h < a.length; h++)
      n = a[h], u[n.id()] = Sv(n, o, i.distance, i.attributes, "kMedoids");
    f = !1;
    for (var d = 0; d < o.length; d++) {
      ...
      if (y.length !== 0) {
        ...
        for (var g = 0; g < y.length; g++)
          l = eu(y[g], y, i.attributes), l < v[d] && (v[d] = l, o[d] = y[g], f = !0);
        s[d] = t.collection(y);
      }
    }
    c++;
  ...
  for (var o, u, l, v = 2 / (i.m - 1), f = 0; f < a.length; f++)
    for (var c = 0; c < n.length; c++) {
      o = 0;
      for (var h = 0; h < a.length; h++)
        u = Tn(i.distance, n[c], a[f], i.attributes, "cmeans"), l = Tn(i.distance, n[c], a[h], i.attributes, "cmeans"), o += Math.pow(u / l, v);
      e[c][f] = 1 / o;
    }
}, gh = function(e, t, a, n) {
  ...
  var t = this.cy(), a = this.nodes(), n = io(e), i, s, o, u, l;
  ...
  for (var m = !0, b = 0; m && b < n.maxIterations; )
    m = !1, dh(s, a, o, l, n), hh(o, u, s, a, n), lh(o, u, n.sensitivityThreshold) || (m = !0), b++;
  return i = gh(a, o, n, t), {
    clusters: i,
  ...
  for (var s = 0, o = 1 / 0, u, l = i.attributes, v = function(k, B) {
    return Nn(i.distance, l.length, function(D) {
      return l[D](k);
    }, function(D) {
      return l[D](B);
    }, k, B);
  ...
  if (!e) return [];
  var n = [], i = [], s = [];
  return t === 0 ? (e.left && Ht(e.left, n), e.right && Ht(e.right, i), s = n.concat(i), [a.collection(s)]) : t === 1 ? e.value ? [a.collection(e.value)] : (e.left && Ht(e.left, n), e.right && Ht(e.right, i), [a.collection(n), a.collection(i)]) : e.value ? [a.collection(e.value)] : (e.left && (n = Ls(e.left, t - 1, a)), e.right && (i = Ls(e.right, t - 1, a)), n.concat(i));
}, au = function(e) {
  for (var t = this.cy(), a = this.nodes(), n = bh(e), i = n.attributes, s = function(b, w) {
  ...
  for (var t = this.cy(), a = this.nodes(), n = Eh(e), i = {}, s = 0; s < a.length; s++)
    i[a[s].id()] = s;
  var o, u, l, v, f, c;
  ...
  for (var d = 0; d < o; d++)
    for (var y = 0; y < o; y++)
      d !== y && (l[d * o + y] = Ch(n.distance, a[d], a[y], n.attributes));
  v = Th(l, n.preference);
  for (var g = 0; g < o; g++)
    l[g * o + g] = v;
  f = new Array(u);
  ...
  for (var b = new Array(o), w = new Array(o), E = new Array(o), C = 0; C < o; C++)
    b[C] = 0, w[C] = 0, E[C] = 0;
  for (var x = new Array(o * n.minIterations), S = 0; S < x.length; S++)
    x[S] = 0;
  var k;
  for (k = 0; k < n.maxIterations; k++) {
    ...
    for (var N = 0, V = 0; V < o; V++) {
      var Y = c[V * o + V] + f[V * o + V] > 0 ? 1 : 0;
      x[k % n.minIterations * o + V] = Y, N += Y;
    }
    if (N > 0 && (k >= n.minIterations - 1 || k == n.maxIterations - 1)) {
      for (var J = 0, Z = 0; Z < o; Z++) {
        E[Z] = 0;
        for (var ee = 0; ee < n.minIterations; ee++)
          E[Z] += x[ee * o + Z];
  ...
  for (var re = Sh(o, f, c), ne = kh(o, l, re), X = {}, F = 0; F < re.length; F++)
    X[re[F]] = [];
  for (var H = 0; H < a.length; H++) {
    var W = i[a[H].id()], U = ne[W];
    U != null && X[U].push(a[H]);
  }
  for (var te = new Array(re.length), le = 0; le < re.length; le++)
    te[le] = t.collection(X[re[le]]);
  return te;
}, Dh = {
  ...
  hierholzer: function(e) {
    ...
    var a = Bh(e), n = a.root, i = a.directed, s = this, o = !1, u, l, v;
    ...
    i ? s.forEach(function(m) {
      ...
      if (m.isNode()) {
        ...
        C == 1 ? u ? o = !0 : u = b : x == 1 ? l ? o = !0 : l = b : (x > 1 || C > 1) && (o = !0), f[b] = [], m.outgoers().forEach(function(S) {
          S.isEdge() && f[b].push(S.id());
        });
      } else
    ...
    if (l && u)
      ...
      v || (v = s[0].id());
    var d = function(b) {
      for (var w = b, E = [b], C, x, S; f[w].length; )
        C = f[w].shift(), x = c[C][0], S = c[C][1], w != S ? (f[S] = f[S].filter(function(k) {
          return k != C;
        }), w = S) : !i && w != x && (f[x] = f[x].filter(function(k) {
          return k != C;
...
[Sa, od, ud, vd, cd, hd, yd, Wd, Ut, Kt, Rs, ah, ph, wh, Dh, Ph, Ah, Rh].forEach(function(r) {
  ye(Dv, r);
});
var Bv = 0, Pv = 1, Av = 2, Or = function(e) {
...
var ta = typeof Promise < "u" ? Promise : Or, Is = function(e, t, a) {
  var n = Ys(e), i = !n, s = this._private = ye({
    duration: 1e3
  }, t, a);
...
function Fh() {
  if (gu) return Si;
  gu = 1;
  var r = Ih(), e = Nh(), t = Na(), a = zh(), n = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, s = Function.prototype, o = Object.prototype, u = s.toString, l = o.hasOwnProperty, v = RegExp(
...
var fg = vg(), cg = /* @__PURE__ */ Oa(fg), us, Ju;
function dg() {
  if (Ju) return us;
  Ju = 1;
  var r = so(), e = (function() {
...
function gg() {
  if (el) return vs;
  el = 1;
  var r = hg(), e = Lv(), t = Object.prototype, a = t.hasOwnProperty;
  function n(i, s, o) {
    var u = i[s];
...
var bg = mg(), wg = /* @__PURE__ */ Oa(bg), hs, nl;
function xg() {
  if (nl) return hs;
  nl = 1;
  function r(e, t) {
...
function Eg() {
  if (il) return gs;
  il = 1;
  var r = Ov(), e = xg(), t = zn(), a = za(), n = Iv(), i = oo(), s = Nv();
  function o(u) {
    return t(u) ? r(u, i) : a(u) ? [u] : e(n(s(u)));
  }
  return gs = o, gs;
}
var Cg = Eg(), Tg = /* @__PURE__ */ Oa(Cg), Sg = {
  // access data field
  data: function(e) {
    var t = {
      field: "data",
    ...
    return e = ye({}, t, e), function(n, i) {
      ...
      if (he(n)) {
        var f = n.indexOf(".") !== -1, c = f && Tg(n);
        if (s.allowGetting && i === void 0) {
          var h;
          return v && (s.beforeGet(v), c && v._private[s.field][n] === void 0 ? h = cg(v._private[s.field], c) : h = v._private[s.field][n]), h;
          ...
          if (d) {
            ...
            for (var g = 0, p = l.length; g < p; g++) {
              var m = l[g];
              s.canSet(m) && (c && v._private[s.field][n] === void 0 ? wg(m._private[s.field], c, i) : m._private[s.field][n] = i);
            }
...
var Rg = function(e) {
  for (var t, a, n, i = 0; i < Ns.length; i++) {
    var s = Ns[i], o = s.name, u = e.match(s.regexObj);
    if (u != null) {
      a = u, t = s, n = o;
      var l = u[0];
  ...
  for (var e = function(v) {
    ...
    switch (c) {
      ...
      case ue.COMPOUND_SPLIT: {
        var C = i(v.left, f), x = i(v.subject, f), S = i(v.right, f);
        return C + (C.length > 0 ? " " : "") + x + S;
      }
      case ue.TRUE:
        return "";
    }
...
gt.updateCompoundBounds = function() {
  ...
  function t(s) {
    ...
    var b = h(v.width.val - f.w, y, g), w = b.biasDiff, E = b.biasComplementDiff, C = h(v.height.val - f.h, p, m), x = C.biasDiff, S = C.biasComplementDiff;
    o.autoPadding = d(f.w, f.h, s.pstyle("padding"), s.pstyle("padding-relative-to").value), o.autoWidth = Math.max(f.w, v.width.val), c.x = (-w + f.x1 + f.x2 + E) / 2, o.autoHeight = Math.max(f.h, v.height.val), c.y = (-x + f.y1 + f.y2 + S) / 2;
  }
  for (var a = 0; a < this.length; a++) {
...
var Dr = function(e) {
  ...
  if (!t.cy().headless()) {
    ...
    if (o !== "none") {
      ...
      f.x1 = u - s, f.y1 = l - s, f.x2 = u + s, f.y2 = l + s, f.w = f.x2 - f.x1, f.h = f.y2 - f.y1, un(f, 1), Lr(e, f.x1, f.y1, f.x2, f.y2);
    }
  }
}, ys = function(e, t, a) {
  if (!t.cy().headless()) {
    ...
    if (o) {
      var u = t.pstyle("text-halign"), l = t.pstyle("text-valign"), v = fa(s, "labelWidth", a), f = fa(s, "labelHeight", a), c = fa(s, "labelX", a), h = fa(s, "labelY", a), d = t.pstyle(n + "text-margin-x").pfValue, y = t.pstyle(n + "text-margin-y").pfValue, g = t.isEdge(), p = t.pstyle(n + "text-rotation"), m = t.pstyle("text-outline-width").pfValue, b = t.pstyle("text-border-width").pfValue, w = b / 2, E = t.pstyle("text-background-padding").pfValue, C = 2, x = f, S = v, k = S / 2, B = x / 2, D, P, A, R;
      if (g)
      ...
      N.x1 = D, N.y1 = A, N.x2 = P, N.y2 = R, N.w = P - D, N.h = R - A, N.leftPad = L, N.rightPad = I, N.topPad = M, N.botPad = O;
      var V = g && p.strValue === "autorotate", Y = p.pfValue != null && p.pfValue !== 0;
      if (V || Y) {
        var J = V ? fa(i.rstyle, "labelAngle", a) : p.pfValue, Z = Math.cos(J), ee = Math.sin(J), re = (D + P) / 2, ne = (A + R) / 2;
        if (!g) {
          switch (Jt(u.value)) {
            case "left":
              re = P;
        ...
        var X = function(we, me) {
          return we = we - re, me = me - ne, {
            x: we * Z - me * ee + re,
            y: we * ee + me * Z + ne
          };
        }, F = X(D, A), H = X(D, R), W = X(P, A), U = X(P, R);
        D = Math.min(F.x, H.x, W.x, U.x), P = Math.max(F.x, H.x, W.x, U.x), A = Math.min(F.y, H.y, W.y, U.y), R = Math.max(F.y, H.y, W.y, U.y);
      }
      var te = q + "Rot", le = _[te] = _[te] || {};
      le.x1 = D, le.y1 = A, le.x2 = P, le.y2 = R, le.w = P - D, le.h = R - A, Lr(e, D, A, P, R), Lr(i.labelBounds.all, D, A, P, R);
    }
    return e;
  }
}, ol = function(e, t) {
  ...
  var a = e._private.cy, n = a.styleEnabled(), i = a.headless(), s = mr(), o = e._private, u = e.isNode(), l = e.isEdge(), v, f, c, h, d, y, g = o.rstyle, p = u && n ? e.pstyle("bounds-expansion").pfValue : [0], m = function(De) {
  ...
  if (b) {
    ...
    var S = Math.max(E, x), k = 0, B = 0;
    if (n && (k = e.pstyle("width").pfValue, B = k / 2), u && t.includeNodes) {
      var D = e.position();
      d = D.x, y = D.y;
      var P = e.outerWidth(), A = P / 2, R = e.outerHeight(), L = R / 2;
      v = d - A, f = d + A, c = y - L, h = y + L, Lr(s, v, c, f, h), n && ol(s, e), n && t.includeOutlines && !i && ol(s, e), n && Ug(s, e);
    } else if (l && t.includeEdges)
      if (n && !i) {
        var I = e.pstyle("curve-style").strValue;
        if (v = Math.min(g.srcX, g.midX, g.tgtX), f = Math.max(g.srcX, g.midX, g.tgtX), c = Math.min(g.srcY, g.midY, g.tgtY), h = Math.max(g.srcY, g.midY, g.tgtY), v -= B, f += B, c -= B, h += B, Lr(s, v, c, f, h), I === "haystack") {
          var M = g.haystackPts;
          if (M && M.length === 2) {
          ...
          if (_ != null)
            for (var N = 0; N < _.length; N++) {
              var V = _[N];
              v = V.x - B, f = V.x + B, c = V.y - B, h = V.y + B, Lr(s, v, c, f, h);
            }
        }
      } else {
        var Y = e.source(), J = Y.position(), Z = e.target(), ee = Z.position();
        if (v = J.x, f = ee.x, c = J.y, h = ee.y, v > f) {
          var re = v;
          v = f, f = re;
        }
        if (c > h) {
        ...
        v -= B, f += B, c -= B, h += B, Lr(s, v, c, f, h);
      }
    if (n && t.includeEdges && l && (ja(s, e, "mid-source"), ja(s, e, "mid-target"), ja(s, e, "source"), ja(s, e, "target")), n) {
      var X = e.pstyle("ghost").value === "yes";
      if (X) {
        var F = e.pstyle("ghost-offset-x").pfValue, H = e.pstyle("ghost-offset-y").pfValue;
        Lr(s, s.x1 + F, s.y1 + H, s.x2 + F, s.y2 + H);
      }
    }
    var W = o.bodyBounds = o.bodyBounds || {};
    Uo(W, s), ln(W, p), un(W, 1), n && (v = s.x1, f = s.x2, c = s.y1, h = s.y2, Lr(s, v - S, c - S, f + S, h + S));
    var U = o.overlayBounds = o.overlayBounds || {};
    Uo(U, s), ln(U, p), un(U, 1);
    var te = o.labelBounds = o.labelBounds || {};
    te.all != null ? Dd(te.all) : te.all = mr(), n && t.includeLabels && (t.includeMainLabels && ys(s, e, null), l && (t.includeSourceLabels && ys(s, e, "source"), t.includeTargetLabels && ys(s, e, "target")));
  }
  return s.x1 = Dr(s.x1), s.y1 = Dr(s.y1), s.x2 = Dr(s.x2), s.y2 = Dr(s.y2), s.w = Dr(s.x2 - s.x1), s.h = Dr(s.y2 - s.y1), s.w > 0 && s.h > 0 && b && (ln(s, p), un(s, 1)), s;
}, $v = function(e) {
  ...
  if (a.bbCache == null ? (n = Kg(e, Pa), a.bbCache = n, a.bbCachePosKey = Uv(e)) : n = a.bbCache, !o) {
    var u = e.isNode();
    n = mr(), (t.includeNodes && u || t.includeEdges && !u) && (t.includeOverlays ? rt(n, a.overlayBounds) : rt(n, a.bodyBounds)), t.includeLabels && (t.includeMainLabels && (!i || t.includeSourceLabels && t.includeTargetLabels) ? rt(n, a.labelBounds.all) : (t.includeMainLabels && rt(n, a.labelBounds.mainRot), t.includeSourceLabels && rt(n, a.labelBounds.sourceRot), t.includeTargetLabels && rt(n, a.labelBounds.targetRot))), n.w = n.x2 - n.x1, n.h = n.y2 - n.y1;
  }
  return n;
}, Pa = {
  includeNodes: !0,
...
gt.boundingBox = function(r) {
  ...
  if (t && this.length === 1 && !a(this[0]))
    ...
    for (var u = 0; u < i.length; u++) {
      var l = i[u];
      a(l) && l.dirtyBoundingBoxCache(), rt(e, ul(l, n));
    }
  }
...
}, ip = Object.keys(fl).reduce(function(r, e) {
  var t = fl[e], a = np(e);
  return r[e] = function() {
...
var Yv = /^([^.]+)(\.(?:[^.]+))?$/, op = ".*", Zv = {
  ...
  context: null
}, cl = Object.keys(Zv), up = {};
function Gn() {
  for (var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : up, e = arguments.length > 1 ? arguments[1] : void 0, t = 0; t < cl.length; t++) {
    var a = cl[t];
    this[a] = r[a] || Zv[a];
  }
  this.context = e || this.context, this.listeners = [], this.emitting = 0;
}
var ct = Gn.prototype, Qv = function(e, t, a, n, i, s, o) {
  ...
  for (var n = Ve(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
    ...
    if (!ot(s)) {
      var o = s.match(Yv);
      if (o) {
        var u = o[1], l = o[2] ? o[2] : null, v = dl(e, {
          type: u,
          namespace: l,
          target: e.context
        });
...
ct.on = ct.addListener = function(r, e, t, a, n) {
  return Qv(this, function(i, s, o, u, l, v, f) {
...
ct.emit = ct.trigger = function(r, e, t) {
  ...
  return this.emitting++, Ve(e) || (e = [e]), lp(this, function(i, s) {
    t != null && (a = [{
      event: s.event,
      type: s.type,
    ...
    for (var o = function() {
      var v = a[u];
      if (v.type === s.type && (!v.namespace || v.namespace === s.namespace || v.namespace === op) && i.eventMatches(i.context, v, s)) {
        var f = [s];
...
var vp = {
  ...
  createEmitter: function() {
    for (var e = 0; e < this.length; e++) {
      ...
      a.emitter || (a.emitter = new Gn(vp, t));
    }
    return this;
  },
  emitter: function() {
...
function vo(r) {
  ...
  return function() {
    ...
    if (i) {
      ...
      return t(u) && (!s || ms(u, t)) && (u === l || t(l) && (!s || ms(l, t)));
    }
  };
}
...
ur.takesUpSpace = Wn("takesUpSpace", vo({
  ok: aa
}));
var hp = Hn("eleInteractive", function(r) {
  return r.pstyle("events").value === "yes" && r.pstyle("visibility").value === "visible" && aa(r);
}), gp = Hn("parentInteractive", function(r) {
  return r.pstyle("visibility").value === "visible" && aa(r);
});
ur.interactive = Wn("interactive", vo({
  ok: hp,
  parentOk: gp,
  edgeOkViaNode: aa
}));
...
ur.isBundledBezier = Wn("isBundledBezier", function() {
...
ye(dr, {
  ...
  parallelEdges: Br(wl(), "parallelEdges"),
  codirectedEdges: Br(wl({
    codirected: !0
  }), "codirectedEdges")
});
function wl(r) {
...
}, _e = In.prototype = lr.prototype = Object.create(Array.prototype);
...
_e.collection = function() {
  return rv(this) ? this : new lr(this._private.cy, [this]);
};
_e.unique = function() {
  ...
  for (f = 0; f < o.length; f++) {
    ...
    if (h.isEdge()) {
      for (var m = h, b = ["source", "target"], w = b.length, E = !1, C = 0; C < w; C++) {
        var x = b[C], S = y[x];
        ae(S) && (S = y[x] = "" + y[x]), S == null || S === "" ? (He("Can not create edge `" + g + "` with unspecified " + x), E = !0) : a.hasElementWithId(S) || (He("Can not create edge `" + g + "` with nonexistent " + x + " `" + S + "`"), E = !0);
      }
      if (E) {
        c();
        continue;
...
[Dv, Dg, vn, it, Qt, Hg, _n, sp, Jv, jv, fp, Sn, fn, ur, st, dr].forEach(function(r) {
  ye(_e, r);
});
var mp = {
  add: function(e) {
...
function xp(r, e, t, a) {
  ...
  if (s.duration === 0 ? g = 1 : g = (t - u) / s.duration, s.applying && (g = s.progress), g < 0 ? g = 0 : g > 1 && (g = 1), s.delay == null) {
    ...
    var S = s.startZoom, k = s.zoom, B = k != null && a;
    B && (da(S, k) && (i.zoom = ka(i.minZoom, Ot(S, k, g, y), i.maxZoom)), r.emit("zoom")), (x || B) && r.emit("viewport");
    var D = s.style;
    if (D && D.length > 0 && n) {
      for (var P = 0; P < D.length; P++) {
        var A = D[P], R = A.name, L = A, I = s.startStyle[R], M = v.properties[I.name], O = Ot(I, L, g, y, M);
...
function Cl(r, e) {
  ...
  function n(v, f) {
    ...
    for (var p = function(C) {
      ...
      !w.playing && !w.applying || (w.playing && w.applying && (w.applying = !1), w.started || Ep(v, b, r), xp(v, b, r, f), w.applying && (w.applying = !1), p(w.frames), w.step != null && w.step(r), b.completed() && (h.splice(m, 1), w.hooked = !1, w.playing = !1, w.started = !1, p(w.completes)), y = !0);
    }
...
var Cp = {
  ...
  createEmitter: function() {
    var e = this._private;
    return e.emitter || (e.emitter = new Gn(Tp, this)), this;
  },
  emitter: function() {
    return this._private.emitter;
  },
...
sr.updateStyleHints = function(r) {
  var e = r._private, t = this, a = t.propertyGroupNames, n = t.propertyGroupKeys, i = function(W, U, te) {
    return t.getPropertiesHash(W, U, te);
  }, s = e.styleKey;
  if (r.removed())
    return !1;
  ...
  for (var f = function(W, U) {
    return e.styleKeys[U][0] = Ca(W, e.styleKeys[U][0]);
  }, c = function(W, U) {
    return e.styleKeys[U][1] = Ta(W, e.styleKeys[U][1]);
  }, h = function(W, U) {
    f(W, U), c(W, U);
  }, d = function(W, U) {
    for (var te = 0; te < W.length; te++) {
      var le = W.charCodeAt(te);
      f(le, U), c(le, U);
    }
  }, y = 2e9, g = function(W) {
    ...
    if (b != null) {
      ...
      var S = w.enums == null ? b.value : null, k = x != null, B = S != null, D = k || B, P = b.units;
  ...
  if (e.labelKey = jr(q), e.labelStyleKey = jr(Xa(O.commonLabel, q)), !o) {
    var _ = i(r, ["source-label"], O.labelDimensions);
    e.sourceLabelKey = jr(_), e.sourceLabelStyleKey = jr(Xa(O.commonLabel, _));
    var N = i(r, ["target-label"], O.labelDimensions);
    e.targetLabelKey = jr(N), e.targetLabelStyleKey = jr(Xa(O.commonLabel, N));
  }
  if (o) {
    var V = e.styleKeys, Y = V.nodeBody, J = V.nodeBorder, Z = V.nodeOutline, ee = V.backgroundImage, re = V.compound, ne = V.pie, X = V.stripe, F = [Y, J, Z, ee, re, ne, X].filter(function(H) {
      return H != null;
    }).reduce(Xa, [Ct, _t]);
    e.nodeKey = jr(F), e.hasPie = ne != null && ne[0] !== Ct && ne[1] !== _t, e.hasStripe = X != null && X[0] !== Ct && X[1] !== _t;
  }
  return s !== e.styleKey;
};
...
sr.applyParsedProperty = function(r, e) {
  var t = this, a = e, n = r._private.style, i, s = t.types, o = t.properties[a.name].type, u = a.bypass, l = n[a.name], v = l && l.bypass, f = r._private, c = "mapping", h = function(Y) {
    return Y == null ? null : Y.pfValue != null ? Y.pfValue : Y.value;
  }, d = function() {
    var Y = h(l), J = h(a);
    t.checkTriggers(r, a.name, Y, J);
  };
  ...
  switch (a.mapped) {
    ...
    case s.mapData: {
      ...
      if (w < 0 ? w = 0 : w > 1 && (w = 1), o.color) {
        var C = a.valueMin[0], x = a.valueMax[0], S = a.valueMin[1], k = a.valueMax[1], B = a.valueMin[2], D = a.valueMax[2], P = a.valueMin[3] == null ? 1 : a.valueMin[3], A = a.valueMax[3] == null ? 1 : a.valueMax[3], R = [Math.round(C + (x - C) * w), Math.round(S + (k - S) * w), Math.round(B + (D - B) * w), Math.round(P + (A - P) * w)];
        i = {
...
_a.applyBypass = function(r, e, t, a) {
  ...
  for (var m = !1, b = 0; b < r.length; b++) {
    for (var w = r[b], E = {}, C = void 0, x = 0; x < i.length; x++) {
      var S = i[x];
      if (a) {
        var k = w.pstyle(S.name);
        C = E[S.name] = {
          prev: k
        };
      }
      m = this.applyParsedProperty(w, _r(S)) || m, a && (C.next = w.pstyle(S.name));
    }
...
Gr.getPropsList = function(r) {
  ...
  if (a)
    for (var i = Object.keys(a), s = 0; s < i.length; s++) {
      var o = i[s], u = a[o], l = n[o] || n[Zs(o)], v = this.parse(l.name, u);
      v && t.push(v);
    }
  return t;
};
...
var Ze = {};
(function() {
  var r = er, e = wc, t = Ec, a = Cc, n = Tc, i = function(H) {
    return "^" + H + "\\s*\\(\\s*([\\w\\.]+)\\s*\\)$";
  }, s = function(H) {
    var W = r + "|\\w+|" + e + "|" + t + "|" + a + "|" + n;
  ...
  var u = {
    ...
    triggersBoundsOfParallelEdges: function(H, W, U) {
      return H === W ? !1 : U.pstyle("curve-style").value === "bezier";
    }
  }, {
    name: "visibility",
    type: l.visibility,
  ...
  [{
    ...
    O.forEach(function(H) {
      var W = H + "-" + F.name, U = F.type, te = F.triggersBounds;
      M.push({
        name: W,
        type: U,
        triggersBounds: te
  ...
  var q = Ze.properties = [].concat(y, b, g, p, m, D, d, h, v, f, c, E, C, x, S, A, L, k, B, M, P), _ = Ze.propertyGroups = {
    // common to all eles
    behavior: y,
    transition: b,
    visibility: g,
    ...
    edgeArrow: M,
    core: P
  }, N = Ze.propertyGroupNames = {}, V = Ze.propertyGroupKeys = Object.keys(_);
  V.forEach(function(F) {
    N[F] = _[F].map(function(H) {
      return H.name;
    }), _[F].forEach(function(H) {
      return H.groupKey = F;
    });
  });
  var Y = Ze.aliases = [{
  ...
  Ze.propertyNames = q.map(function(F) {
    return F.name;
  });
  ...
  for (var ee = 0; ee < Y.length; ee++) {
    var re = Y[ee], ne = q[re.pointsTo], X = {
      name: re.name,
      alias: !0,
      pointsTo: ne
    };
    q.push(X), q[re.name] = X;
  }
})();
...
Un.parseImpl = function(r, e, t, a) {
  ...
  if (l.multiple && a !== "multiple") {
    ...
    if (u ? b = e.split(/\s+/) : Ve(e) ? b = e : b = [e], l.evenMultiple && b.length % 2 !== 0)
      return null;
    for (var w = [], E = [], C = [], x = "", S = !1, k = 0; k < b.length; k++) {
      var B = n.parse(r, b[k], t, "multiple");
      S = S || he(B.value), w.push(B.value), C.push(B.pfValue != null ? B.pfValue : B.value), E.push(B.units), x += (k > 0 ? " " : "") + B.strValue;
    }
    return l.validate && !l.validate(w, E) ? null : l.singleEnum && S ? w.length === 1 && he(w[0]) ? {
      name: r,
      value: w[0],
      strValue: w[0],
      bypass: t
  ...
  var D = function() {
    for (var X = 0; X < l.enums.length; X++) {
      var F = l.enums[X];
      if (F === e)
        return {
          name: r,
  ...
  if (l.number) {
    ...
    if (isNaN(e) && l.enums !== void 0)
      return e = s, D();
    if (l.integer && !dc(e) || l.min !== void 0 && (e < l.min || l.strictMin && e === l.min) || l.max !== void 0 && (e > l.max || l.strictMax && e === l.max))
      return null;
    var I = {
      name: r,
      value: e,
    ...
    return l.unitless || P !== "px" && P !== "em" ? I.pfValue = e : I.pfValue = P === "px" || !P ? e : this.getEmSizeInPixels() * e, (P === "ms" || P === "s") && (I.pfValue = P === "ms" ? e : 1e3 * e), (P === "deg" || P === "rad") && (I.pfValue = P === "rad" ? e : Cd(e)), P === "%" && (I.pfValue = e / 100), I;
  } else if (l.propList) {
    var M = [], O = "" + e;
    if (O !== "none") {
    ...
    for (var J = l.regexes ? l.regexes : [l.regex], Z = 0; Z < J.length; Z++) {
      var ee = new RegExp(J[Z]), re = ee.exec(e);
      if (re)
        return {
          name: r,
...
hr.append = function(r) {
  return tv(r) ? r.appendToStyle(this) : Ve(r) ? this.appendFromJson(r) : he(r) && this.appendFromString(r), this;
};
...
[sr, _a, fo, Gr, $n, co, Ze, Un].forEach(function(r) {
  ye(hr, r);
});
ir.types = hr.types;
...
var Bp = {
  ...
  setStyle: function(e) {
    var t = this._private;
    return tv(e) ? t.style = e.generateStyle(this) : Ve(e) ? t.style = ir.fromJson(this, e) : he(e) ? t.style = ir.fromString(this, e) : t.style = ir(this), t.style;
  },
  ...
  selectionType: function(e) {
    var t = this._private;
    if (t.selectionType == null && (t.selectionType = Pp), e !== void 0)
  ...
  getZoomedViewport: function(e) {
    ...
    if (t.zoomingEnabled || (o = !0), ae(e) ? s = e : Me(e) && (s = e.level, e.position != null ? i = On(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = !0)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !ae(s) || s === n || i != null && (!ae(i.x) || !ae(i.y)))
      return null;
    if (i != null) {
      var u = a, l = n, v = s, f = {
        x: -v / l * (i.x - u.x) + i.x,
...
ye(kn, {
  ...
  mount: function(e) {
    if (e != null) {
      ...
      return !bn(e) && bn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = !0, t.invalidateSize(), t.initRenderer(ye({}, n, n.renderer, {
...
[mp, Cp, tf, zs, dn, Sp, Fs, hn, Bp, Pt, Aa].forEach(function(r) {
  ye(kn, r);
});
var Ap = {
  fit: !0,
...
function af(r) {
  this.options = ye({}, Ap, Rp, r);
}
af.prototype.run = function() {
  var r = this.options, e = r.cy, t = r.eles, a = t.nodes().filter(function(ge) {
    return ge.isChildless();
  }), n = t, i = r.directed, s = r.acyclic || r.maximal || r.maximalAdjustments > 0, o = !!r.boundingBox, u = mr(o ? r.boundingBox : structuredClone(e.extent())), l;
  if (Tr(r.roots))
    l = r.roots;
  else if (Ve(r.roots)) {
    ...
    l = e.collection();
    for (var y = function() {
      var se = d[g], de = se.maxDegree(!1), ce = se.filter(function(xe) {
  ...
  var p = [], m = {}, b = function(se, de) {
    ...
    var ce = Nt(se), xe = ce.depth, be = ce.index;
    p[xe][be] = null, se.isChildless() && b(se, de);
  };
  n.bfs({
    roots: l,
    directed: r.directed,
    visit: function(se, de, ce, xe, be) {
      var Se = se[0], Be = Se.id();
      Se.isChildless() && b(Se, be), m[Be] = !0;
    }
  });
  ...
  var S = function(se) {
    for (var de = p[se], ce = 0; ce < de.length; ce++) {
      var xe = de[ce];
      if (xe == null) {
        de.splice(ce, 1), ce--;
        continue;
    ...
    for (var ce = Nt(se), xe = se.incomers().filter(function(Q) {
      return Q.isNode() && t.has(Q);
    }), be = -1, Se = se.id(), Be = 0; Be < xe.length; Be++) {
      var Oe = xe[Be], Le = Nt(Oe);
  ...
  var V = {}, Y = function(se) {
    if (V[se.id()])
      return V[se.id()];
    for (var de = Nt(se).depth, ce = se.neighborhood(), xe = 0, be = 0, Se = 0; Se < ce.length; Se++) {
      var Be = ce[Se];
    ...
    return be = Math.max(1, be), xe = xe / be, be === 0 && (xe = 0), V[se.id()] = xe, xe;
  }, J = function(se, de) {
    var ce = Y(se), xe = Y(de), be = ce - xe;
    return be === 0 ? nv(se.id(), de.id()) : be;
  };
  r.depthSort !== void 0 && (J = r.depthSort);
  for (var Z = p.length, ee = 0; ee < Z; ee++)
    p[ee].sort(J), S(ee);
  ...
  re.length && (p.unshift(re), Z = p.length, X());
  for (var F = 0, H = 0; H < Z; H++)
    F = Math.max(p[H].length, F);
  var W = {
    x: u.x1 + u.w / 2,
    y: u.y1 + u.h / 2
  }, U = a.reduce(function(ge, se) {
    return (function(de) {
      return {
    ...
    Z === 1 ? 0 : (
      ...
      o ? (u.h - r.padding * 2 - U.h) / (Z - 1) : (u.h - r.padding * 2 - U.h) / (Z + 1)
    ),
    I
  ), le = p.reduce(function(ge, se) {
    return Math.max(ge, se.length);
  }, 0), De = function(se) {
    var de = Nt(se), ce = de.depth, xe = de.index;
    if (r.circle) {
      var be = Math.min(u.w / 2 / Z, u.h / 2 / Z);
      be = Math.max(be, I);
      var Se = be * ce + be - (Z > 0 && p[0].length <= 3 ? be / 2 : 0), Be = 2 * Math.PI / p[ce].length * xe;
      return ce === 0 && p[0].length === 1 && (Se = 1), {
        x: W.x + Se * Math.cos(Be),
        y: W.y + Se * Math.sin(Be)
      };
    } else {
      var Oe = p[ce].length, Le = Math.max(
        // only one depth
        Oe === 1 ? 0 : (
          // inside a bounding box, no need for left & right padding
          o ? (u.w - r.padding * 2 - U.w) / ((r.grid ? le : Oe) - 1) : (u.w - r.padding * 2 - U.w) / ((r.grid ? le : Oe) + 1)
        ),
        I
      ), Ae = {
...
nf.prototype.run = function() {
  ...
  for (var s = mr(e.boundingBox ? e.boundingBox : {
    x1: 0,
    y1: 0,
    w: t.width(),
    h: t.height()
  ...
  var w = function(C, x) {
    var S = e.startAngle + x * l * (n ? 1 : -1), k = v * Math.cos(S), B = v * Math.sin(S), D = {
      x: o.x + k,
      y: o.y + B
    };
    return D;
...
function sf(r) {
  this.options = ye({}, Lp, r);
}
sf.prototype.run = function() {
  for (var r = this.options, e = r, t = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise, a = r.cy, n = e.eles, i = n.nodes().not(":parent"), s = mr(e.boundingBox ? e.boundingBox : {
    x1: 0,
    y1: 0,
    w: a.width(),
    h: a.height()
  ...
  u.sort(function(te, le) {
    return le.value - te.value;
  });
  ...
  if (!e.avoidOverlap) {
    var x = p.length > 0 && p[0].length > 1, S = Math.min(s.w, s.h) / 2 - C, k = S / (p.length + x ? 1 : 0);
    C = Math.min(C, k);
  }
  ...
  for (var Z = {}, ee = 0; ee < p.length; ee++)
    for (var re = p[ee], ne = re.dTheta, X = re.r, F = 0; F < re.length; F++) {
      var H = re[F], W = e.startAngle + (t ? 1 : -1) * ne * F, U = {
        x: o.x + X * Math.cos(W),
        y: o.y + X * Math.sin(W)
      };
      Z[H.node.id()] = U;
...
function Kn(r) {
  this.options = ye({}, Ip, r), this.options.layout = this;
...
Kn.prototype.run = function() {
  ...
  var a = Op(e, t, r);
  bs && zp(a), r.randomize && Fp(a);
  var n = Xr(), i = function() {
    Vp(a, e, r), r.fit === !0 && e.fit(r.padding);
  }, s = function(c) {
    return !(t.stopped || c >= r.numIter || (qp(a, r), a.temperature = a.temperature * r.coolingFactor, a.temperature < r.minTemp));
  }, o = function() {
...
var Op = function(e, t, a) {
  for (var n = a.eles.edges(), i = a.eles.nodes(), s = mr(a.boundingBox ? a.boundingBox : {
    x1: 0,
    y1: 0,
    w: e.width(),
    h: e.height()
  ...
  for (o.graphSet.push(w); m <= b; ) {
    var C = p[m++], x = o.idToIndex[C], h = o.layoutNodes[x], S = h.children;
    if (S.length > 0) {
      o.graphSet.push(S);
  ...
  for (var v = 0; v < o.edgeSize; v++) {
    ...
    var A = $e(a.idealEdgeLength) ? a.idealEdgeLength(D) : a.idealEdgeLength, R = $e(a.edgeElasticity) ? a.edgeElasticity(D) : a.edgeElasticity, L = o.idToIndex[P.sourceId], I = o.idToIndex[P.targetId], M = o.indexToGraph[L], O = o.indexToGraph[I];
    if (M != O) {
      for (var q = Np(P.sourceId, P.targetId, o), _ = o.graphSet[q], N = 0, g = o.layoutNodes[L]; _.indexOf(g.id) === -1; )
  ...
  if (!(i !== s && !a.isCompound)) {
    ...
    o === 0 && u === 0 && (o = Sl(l), u = Sl(l));
    var v = Hp(e, t, o, u);
    if (v > 0)
      var f = n.nodeOverlap * v, c = Math.sqrt(o * o + u * u), h = f * o / c, d = f * u / c;
    else
      var y = Dn(e, o, u), g = Dn(t, -1 * o, -1 * u), p = g.x - y.x, m = g.y - y.y, b = p * p + m * m, c = Math.sqrt(b), f = (e.nodeRepulsion + t.nodeRepulsion) / b, h = f * p / c, d = f * m / c;
  ...
  for (var a = 0; a < e.edgeSize; a++) {
    ...
    if (!(l === 0 && v === 0)) {
      var f = Dn(s, l, v), c = Dn(u, -1 * l, -1 * v), h = c.x - f.x, d = c.y - f.y, y = Math.sqrt(h * h + d * d), g = Math.pow(n.idealLength - y, 2) / n.elasticity;
      if (y !== 0)
        var p = g * h / y, m = g * d / y;
      else
        var p = 0, m = 0;
  ...
  for (var a = 0; a < e.nodeSize; a++) {
    ...
    if (!(0 < n.children.length || n.isLocked)) {
      var i = Xp(n.offsetX, n.offsetY, e.temperature);
...
vf.prototype.run = function() {
  ...
  var i = mr(e.boundingBox ? e.boundingBox : {
    x1: 0,
    y1: 0,
    w: t.width(),
    h: t.height()
  ...
  if (i.h === 0 || i.w === 0)
    ...
    if (e.condense && (m = 0, b = 0), e.avoidOverlap)
      for (var w = 0; w < n.length; w++) {
        ...
        var x = E.layoutDimensions(e), S = e.avoidOverlapPadding, k = x.w + S, B = x.h + S;
        m = Math.max(m, k), b = Math.max(b, B);
      }
    for (var D = {}, P = function(J, Z) {
      return !!D["c-" + J + "-" + Z];
    }, A = function(J, Z) {
      D["c-" + J + "-" + Z] = !0;
    }, R = 0, L = 0, I = function() {
    ...
    var V = function(J, Z) {
      ...
      var ne = M[J.id()];
      if (ne)
        ee = ne.col * m + m / 2 + i.x1, re = ne.row * b + b / 2 + i.y1;
      else {
        for (; P(R, L); )
          I();
        ee = L * m + m / 2 + i.x1, re = R * b + b / 2 + i.y1, A(R, L), I();
      }
      return {
        x: ee,
        y: re
...
function cf(r) {
  this.options = ye({}, Jp, r);
}
cf.prototype.run = function() {
  var r = this.options, e = r.cy, t = r.eles, a = mr(r.boundingBox ? r.boundingBox : {
    x1: 0,
    y1: 0,
    w: e.width(),
    h: e.height()
...
Rt.findNearestElements = function(r, e, t, a) {
  ...
  function p(x) {
    var S = x.outerWidth() + 2 * f, k = x.outerHeight() + 2 * f, B = S / 2, D = k / 2, P = x.position(), A = x.pstyle("corner-radius").value === "auto" ? "auto" : x.pstyle("corner-radius").pfValue, R = x._private.rscratch;
    if (P.x - B <= r && r <= P.x + B && P.y - D <= e && e <= P.y + D) {
      var L = i.nodeShapes[n.getNodeShape(x)];
      if (L.checkPoint(r, e, 0, S, k, P.x, P.y, A, R))
        return g(x, 0), !0;
    }
  }
  function m(x) {
    var S = x._private, k = S.rscratch, B = x.pstyle("width").pfValue, D = x.pstyle("arrow-scale").value, P = B / 2 + v, A = P * P, R = P * 2, O = S.source, q = S.target, L;
    if (k.edgeType === "segments" || k.edgeType === "straight" || k.edgeType === "haystack") {
      for (var I = k.allpts, M = 0; M + 3 < I.length; M += 2)
        if (Md(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], R) && A > (L = zd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3])))
          return g(x, L), !0;
      ...
      for (var I = k.allpts, M = 0; M + 5 < k.allpts.length; M += 4)
        if (Ld(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5], R) && A > (L = Nd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5])))
          return g(x, L), !0;
    }
    for (var O = O || S.source, q = q || S.target, _ = n.getArrowWidth(B, D), N = [{
      name: "source",
      x: k.arrowStartX,
      y: k.arrowStartY,
      ...
      var V = N[M], Y = i.arrowShapes[x.pstyle(V.name + "-arrow-shape").value], J = x.pstyle("width").pfValue;
      if (Y.roughCollide(r, e, _, V.angle, {
        x: V.x,
        y: V.y
      }, J, v) && Y.collide(r, e, _, V.angle, {
        x: V.x,
        y: V.y
      }, J, v))
        return g(x), !0;
  ...
  function w(x, S) {
    ...
    S ? D = S + "-" : D = "", x.boundingBox();
    var P = k.labelBounds[S || "main"], A = x.pstyle(D + "label").value, R = x.pstyle("text-events").strValue === "yes";
    if (!(!R || !A)) {
      var L = b(k.rscratch, "labelX", S), I = b(k.rscratch, "labelY", S), M = b(k.rscratch, "labelAngle", S), O = x.pstyle(D + "text-margin-x").pfValue, q = x.pstyle(D + "text-margin-y").pfValue, _ = P.x1 - B - O, N = P.x2 + B - O, V = P.y1 - B - q, Y = P.y2 + B - q;
      if (M) {
        var J = Math.cos(M), Z = Math.sin(M), ee = function(U, te) {
          return U = U - L, te = te - I, {
            x: U * J - te * Z + L,
            y: U * Z + te * J + I
          };
        }, re = ee(_, V), ne = ee(_, Y), X = ee(N, V), F = ee(N, Y), H = [
...
Rt.getAllInBox = function(r, e, t, a) {
  ...
  function g(U, te) {
    var le = U._private, De = s, we = "";
    U.boundingBox();
    var me = le.labelBounds.main;
    if (!me)
      return null;
    var ge = y(le.rscratch, "labelX", te), se = y(le.rscratch, "labelY", te), de = y(le.rscratch, "labelAngle", te), ce = U.pstyle(we + "text-margin-x").pfValue, xe = U.pstyle(we + "text-margin-y").pfValue, be = me.x1 - De - ce, Se = me.x2 + De - ce, Be = me.y1 - De - xe, Oe = me.y2 + De - xe;
    if (de) {
      var Le = Math.cos(de), Ae = Math.sin(de), Q = function(z, G) {
        return z = z - ge, G = G - se, {
          x: z * Le - G * Ae + ge,
          y: z * Ae + G * Le + se
        };
      };
      return [Q(be, Be), Q(Se, Be), Q(Se, Oe), Q(be, Oe)];
    } else
      return [{
        x: be,
        y: Be
  ...
  function p(U, te, le, De) {
    function we(me, ge, se) {
      return (se.y - me.y) * (ge.x - me.x) > (ge.y - me.y) * (se.x - me.x);
    }
    return we(U, le, De) !== we(te, le, De) && we(U, te, le) !== we(U, te, De);
  }
  for (var m = 0; m < n.length; m++) {
    ...
    if (b.isNode()) {
      ...
      if (C === "none")
        continue;
      var S = (C === "overlap" || x) && E, k = w.boundingBox({
        includeNodes: !0,
        includeEdges: !1,
        includeLabels: S
      });
      ...
      if (O === "contain") {
        ...
        if (M.startX != null && M.startY != null && M.endX != null && M.endY != null && (at(c, M.startX, M.startY) || at(c, M.endX, M.endY)))
          o.push(L), V = !0;
        else if (!V && M.edgeType === "haystack") {
          for (var Y = I.rstyle.haystackPts, J = 0; J < Y.length; J++)
            if (Ko(c, Y[J])) {
              o.push(L), V = !0;
              break;
            }
        ...
        if (!V) {
          ...
          for (var ee = 0; ee < Z.length - 1; ee++) {
            for (var re = Z[ee], ne = Z[ee + 1], X = 0; X < d.length; X++) {
              var F = Qe(d[X], 2), H = F[0], W = F[1];
              if (p(re, ne, H, W)) {
                o.push(L), V = !0;
                break;
              }
...
Bn.calculateArrowAngles = function(r) {
  ...
  if (t && (p = (v + c) / 2, m = (f + h) / 2), u = c - v, l = h - f, i) {
    ...
    var d = e.allpts, E = e.ctrlpts, C, x, S, k;
    if (E.length / 2 % 2 === 0) {
      var B = d.length / 2 - 1, D = B + 2, P = D + 2;
      C = nr(d[B], d[D], d[P], 0), x = nr(d[B + 1], d[D + 1], d[P + 1], 0), S = nr(d[B], d[D], d[P], 1e-4), k = nr(d[B + 1], d[D + 1], d[P + 1], 1e-4);
    } else {
      var D = d.length / 2 - 1, B = D - 2, P = D + 2;
      C = nr(d[B], d[D], d[P], 0.4999), x = nr(d[B + 1], d[D + 1], d[P + 1], 0.4999), S = nr(d[B], d[D], d[P], 0.5), k = nr(d[B + 1], d[D + 1], d[P + 1], 0.5);
    }
    u = S - C, l = k - x;
  }
  if (e.midtgtArrowAngle = Ya(u, l), e.midDispX = u, e.midDispY = l, u *= -1, l *= -1, i) {
    var d = e.allpts;
    if (d.length / 2 % 2 !== 0) {
      if (!e.isRound) {
  ...
  if (e.midsrcArrowAngle = Ya(u, l), i)
...
var Vs, qs, Vr = {}, kr = {}, Pl, Al, Tt, gn, Ur, bt, Et, zr, zt, an, hf, gf, _s, Gs, Rl, Ml = function(e, t, a) {
...
var Ma = 0.01, ty = Math.sqrt(2 * Ma), gr = {};
gr.findMidptPtsEtc = function(r, e) {
  var t = e.posPts, a = e.intersectionPts, n = e.vectorNormInverse, i, s = r.pstyle("source-endpoint"), o = r.pstyle("target-endpoint"), u = s.units != null && o.units != null, l = function(E, C, x, S) {
    var k = S - C, B = x - E, D = Math.sqrt(B * B + k * k);
    return {
      x: -k / D,
      y: B / D
    };
...
gr.findTaxiPoints = function(r, e) {
  ...
  }, Z = J(N), ee = J(Math.abs(M) - Math.abs(N)), re = Z || ee;
  if (re && !_)
    if (I) {
      var ne = Math.abs(O) <= c / 2, X = Math.abs(B) <= h / 2;
      if (ne) {
        var F = (v.x1 + v.x2) / 2, H = v.y1, W = v.y2;
        t.segpts = [F, H, F, W];
      } else if (X) {
        var U = (v.y1 + v.y2) / 2, te = v.x1, le = v.x2;
        t.segpts = [te, U, le, U];
      } else
        t.segpts = [v.x1, v.y2];
    } else {
      var De = Math.abs(O) <= f / 2, we = Math.abs(D) <= d / 2;
      if (De) {
        var me = (v.y1 + v.y2) / 2, ge = v.x1, se = v.x2;
        t.segpts = [ge, me, se, me];
      } else if (we) {
        var de = (v.x1 + v.x2) / 2, ce = v.y1, xe = v.y2;
        t.segpts = [de, ce, de, xe];
      } else
        t.segpts = [v.x2, v.y1];
    }
  else if (I) {
    var be = v.y1 + N + (g ? c / 2 * q : 0), Se = v.x1, Be = v.x2;
    t.segpts = [Se, be, Be, be];
  } else {
    var Oe = v.x1 + N + (g ? f / 2 * q : 0), Le = v.y1, Ae = v.y2;
    t.segpts = [Oe, Le, Oe, Ae];
  }
  if (t.isRound) {
    var Q = r.pstyle("taxi-radius").value, T = r.pstyle("radius-type").value[0] === "arc-radius";
    t.radii = new Array(t.segpts.length / 2).fill(Q), t.isArcRadius = new Array(t.segpts.length / 2).fill(T);
  }
};
gr.tryToCorrectInvalidPoints = function(r, e) {
  ...
  if (t.edgeType === "bezier") {
    ...
    if (p || m || k) {
      ...
      }, V = v.intersectLine(n.x, n.y, o, u, N.x, N.y, 0, c, d);
      k ? (t.ctrlpts[0] = t.ctrlpts[0] + q.x * (E - S), t.ctrlpts[1] = t.ctrlpts[1] + q.y * (E - S)) : (t.ctrlpts[0] = V[0] + q.x * E, t.ctrlpts[1] = V[1] + q.y * E);
    }
...
gr.findEdgeControlPoints = function(r) {
  var e = this;
  if (!(!r || r.length === 0)) {
    for (var t = this, a = t.cy, n = a.hasCompoundNodes(), i = new Kr(), s = function(k, B) {
      return [].concat(mn(k), [B ? 1 : 0]).join("-");
    ...
    for (var C = function() {
      ...
      if (!A.hasUnbundled) {
        var L = A.eles[0].parallelEdges().filter(function(T) {
          return T.isBundledBezier();
        });
        eo(A.eles), L.forEach(function(T) {
          return A.eles.push(T);
        }), A.eles.sort(function(T, z) {
          return T.poolIndex() - z.poolIndex();
        });
      }
      ...
      for (var W = 0; W < A.eles.length; W++) {
        var U = A.eles[W], te = U[0]._private.rscratch, le = U.pstyle("curve-style").value, De = le === "unbundled-bezier" || tt(le, "segments") || tt(le, "taxi"), we = !M.same(U.source());
        if (!A.calculatedIntersection && M !== O && (A.hasBezier || A.hasUnbundled)) {
          A.calculatedIntersection = !0;
          var me = ee.intersectLine(_.x, _.y, V, Y, N.x, N.y, 0, ne, H), ge = A.srcIntn = me, se = re.intersectLine(N.x, N.y, J, Z, _.x, _.y, 0, X, F), de = A.tgtIntn = se, ce = A.intersectionPts = {
            x1: me[0],
            x2: se[0],
            y1: me[1],
            y2: se[1]
            ...
            y1: _.y,
            y2: N.y
          }, be = se[1] - me[1], Se = se[0] - me[0], Be = Math.sqrt(Se * Se + be * be);
          ae(Be) && Be >= ty || (Be = Math.sqrt(Math.max(Se * Se, Ma) + Math.max(be * be, Ma)));
          var Oe = A.vector = {
            x: Se,
            y: be
          }, Le = A.vectorNorm = {
          ...
          A.nodesOverlap = !ae(Be) || re.checkPoint(me[0], me[1], 0, J, Z, N.x, N.y, X, F) || ee.checkPoint(se[0], se[1], 0, V, Y, _.x, _.y, ne, H), A.vectorNormInverse = Ae, R = {
...
Ga.findEndpoints = function(r) {
  ...
  var O, q, _, N, V = (e = (L == null || (t = L.pfValue) === null || t === void 0 ? void 0 : t.length) === 2 ? L.pfValue : null) !== null && e !== void 0 ? e : [0, 0], Y = (a = (P == null || (n = P.pfValue) === null || n === void 0 ? void 0 : n.length) === 2 ? P.pfValue : null) !== null && a !== void 0 ? a : [0, 0];
  if (C) {
    var J = [m.ctrlpts[0], m.ctrlpts[1]], Z = x ? [m.ctrlpts[m.ctrlpts.length - 2], m.ctrlpts[m.ctrlpts.length - 1]] : J;
    O = Z, q = J;
  } else if (S) {
    var ee = k ? m.segpts.slice(0, 2) : [v.x + V[0], v.y + V[1]], re = k ? m.segpts.slice(m.segpts.length - 2) : [l.x + Y[0], l.y + Y[1]];
    O = re, q = ee;
  }
  if (I === "inside-to-node")
    s = [v.x, v.y];
    ...
    var ne = u._private.rscratch, X = ne.labelWidth, F = ne.labelHeight, H = ne.labelX, W = ne.labelY, U = X / 2, te = F / 2, le = u.pstyle("text-valign").value;
    le = jt(le), le === "top" ? W -= te : le === "bottom" && (W += te);
    var De = u.pstyle("text-halign").value;
    De = Jt(De), De === "left" ? H -= U : De === "right" && (H += U);
    var we = Da(_[0], _[1], [H - U, W - te, H + U, W - te, H + U, W + te, H - U, W + te], v.x, v.y);
    if (we.length > 0) {
  ...
  var xe = Za(s, O, i.arrowShapes[f].spacing(r) + h), be = Za(s, O, i.arrowShapes[f].gap(r) + h);
  if (m.endX = be[0], m.endY = be[1], m.arrowEndX = xe[0], m.arrowEndY = xe[1], A === "inside-to-node")
    ...
    var Se = o._private.rscratch, Be = Se.labelWidth, Oe = Se.labelHeight, Le = Se.labelX, Ae = Se.labelY, Q = Be / 2, T = Oe / 2, z = o.pstyle("text-valign").value;
    z = jt(z), z === "top" ? Ae -= T : z === "bottom" && (Ae += T);
    var G = o.pstyle("text-halign").value;
    G = Jt(G), G === "left" ? Le -= Q : G === "right" && (Le += Q);
    var $ = Da(N[0], N[1], [Le - Q, Ae - T, Le + Q, Ae - T, Le + Q, Ae + T, Le - Q, Ae + T], l.x, l.y);
    if ($.length > 0) {
      var K = v, ve = xt(K, Gt(s)), j = xt(K, Gt($)), ie = ve;
      if (j < ve && (s = [$[0], $[1]], ie = j), $.length > 2) {
        var oe = xt(K, {
          x: $[2],
          y: $[3]
        });
  ...
  var pe = Za(s, q, i.arrowShapes[c].spacing(r) + d), Ee = Za(s, q, i.arrowShapes[c].gap(r) + d);
  m.startX = Ee[0], m.startY = Ee[1], m.arrowStartX = pe[0], m.arrowStartY = pe[1], B && (!ae(m.startX) || !ae(m.startY) || !ae(m.endX) || !ae(m.endY) ? m.badLine = !0 : m.badLine = !1);
};
...
yo.storeEdgeProjections = function(r) {
  ...
  if (e.rstyle.bezierPts = null, e.rstyle.linePts = null, e.rstyle.haystackPts = null, a === "multibezier" || a === "bezier" || a === "self" || a === "compound") {
    ...
    for (var n = 0; n + 5 < t.allpts.length; n += 4)
      ay(this, r, t.allpts.slice(n, n + 6));
  } else if (a === "segments")
...
Hr.recalculateEdgeLabelProjections = function(r) {
  ...
  if (i.mid || i.source || i.target) {
    ...
    var u = function() {
      ...
      function m(x, S, k, B, D) {
        var P = Dt(S, k), A = x.segments[x.segments.length - 1], R = {
          p0: S,
          p1: k,
          t0: B,
          t1: D,
      ...
      if (i[f]) {
        ...
        switch (a.edgeType) {
          ...
          case "multibezier": {
            ...
            var S = g.cp, k = g.segment, B = (d - p) / k.length, D = k.t1 - k.t0, P = h ? k.t0 + D * B : k.t1 - D * B;
            P = ka(0, P, 1), e = $t(S.p0, S.p1, S.p2, P), c = ny(S.p0, S.p1, S.p2, P);
            break;
          }
          case "straight":
          case "segments":
          case "haystack": {
            for (var A = 0, R, L, I, M, O = a.allpts.length, q = 0; q + 3 < O && (h ? (I = {
              ...
              ;
            var _ = d - L, N = _ / R;
            N = ka(0, N, 1), e = Sd(I, M, N), c = bf(I, M);
            break;
          }
        }
...
Hr.applyPrefixedLabelDimensions = function(r, e) {
  ...
  if (yr(t.rscratch, "prefixedLabelDimsKey", e) !== n) {
    qr(t.rscratch, "prefixedLabelDimsKey", e, n);
    var i = this.calculateLabelDimensions(r, a), s = r.pstyle("line-height").pfValue, o = r.pstyle("font-size").pfValue, u = r.pstyle("text-wrap").strValue, l = yr(t.rscratch, "labelWrapCachedLines", e) || [], v = u !== "wrap" ? 1 : Math.max(l.length, 1), f = o * s, c = i.width, h = i.height + (v - 1) * (s - 1) * o;
...
Hr.getLabelText = function(r, e) {
  var t = r._private, a = e ? e + "-" : "", n = r.pstyle(a + "label").strValue, i = r.pstyle("text-transform").value, s = function(Y, J) {
    return J ? (qr(t.rscratch, Y, e, J), J) : yr(t.rscratch, Y, e);
  };
  if (!n)
    return "";
...
`), f = r.pstyle("text-max-width").pfValue, c = r.pstyle("text-overflow-wrap").value, h = c === "anywhere", d = [], y = /[\s\u200b]+|$/g, g = 0; g < v.length; g++) {
      ...
      if (b > f) {
        var E = p.matchAll(y), C = "", x = 0, S = Cr(E), k;
        try {
          for (S.s(); !(k = S.n()).done; ) {
...
Hr.getLabelJustification = function(r) {
  ...
  return e === "auto" ? r.isNode() ? $g(t) : "center" : e;
};
...
`), p = g.length, m = 0, b = 0, w = 0; w < p; w++) {
    var E = g[w], C = c.measureText(E), x = Math.ceil(C.width), S = o;
    v === "glyph" && (w === 0 && (b = C.actualBoundingBoxAscent), w === p - 1 && (m = C.actualBoundingBoxDescent)), d = Math.max(x, d), y += S;
  }
...
wf.getNodeShape = function(r) {
  ...
  if (t === "cutrectangle" && (r.width() < Ll || r.height() < Ll))
    return Il || (ze("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Il = !0), "rectangle";
  if (r.isParent())
...
var xf = {};
[Rt, Bn, gr, Ga, yo, Hr, wf, Xn, Yn].forEach(function(r) {
  ye(xf, r);
});
var Ef = {};
...
ia.load = function() {
  var r = this, e = r.cy.window(), t = function(T) {
    ...
    var G = z.addToList, $ = G.has(T);
    !$ && T.grabbable() && !T.locked() && (G.merge(T), iy(T));
  }, c = function(T, z) {
    if (T.cy().hasCompoundNodes() && !(z.inDragLayer == null && z.addToList == null)) {
      var G = T.descendants();
      z.inDragLayer && (G.forEach(o), G.connectedEdges().forEach(o)), z.addToList && f(G, z);
    }
  }, h = function(T, z) {
    z = z || {};
    var G = T.cy().hasCompoundNodes();
    z.inDragLayer && (T.forEach(o), T.neighborhood().stdFilter(function($) {
      return !G || $.isEdge();
    }).forEach(o)), z.addToList && T.forEach(function($) {
      f($, z);
    }), c(T, z), g(T, {
      inDragLayer: z.inDragLayer
    }), r.updateCachedGrabbedEles();
  }, d = h, y = function(T) {
    T && (r.getCachedZSortedEles().forEach(function(z) {
      sy(z), u(z), v(z);
    }), r.updateCachedGrabbedEles());
  }, g = function(T, z) {
    if (!(z.inDragLayer == null && z.addToList == null) && T.cy().hasCompoundNodes()) {
      var G = T.ancestors().orphans();
      if (!G.same(T)) {
        var $ = G.descendants().spawnSelf().merge(G).unmerge(T).unmerge(T.descendants()), K = $.connectedEdges();
        z.inDragLayer && (K.forEach(o), $.forEach(o)), z.addToList && $.forEach(function(ve) {
          f(ve, z);
        });
      }
    }
  ...
  m ? (r.removeObserver = new MutationObserver(function(Q) {
    for (var T = 0; T < Q.length; T++) {
      var z = Q[T], G = z.removedNodes;
      if (G)
        for (var $ = 0; $ < G.length; $++) {
          var K = G[$];
          if (K === r.container) {
    ...
    childList: !0
  })) : r.registerBinding(r.container, "DOMNodeRemoved", function(Q) {
    r.destroy();
  });
  var w = Fa(function() {
    r.cy.resize();
  ...
  E(r.container, function(Q) {
    r.registerBinding(Q, "transitionend", C), r.registerBinding(Q, "animationend", C), r.registerBinding(Q, "scroll", C);
  }), r.registerBinding(r.container, "contextmenu", function(Q) {
    Q.preventDefault();
  });
  var x = function() {
    return r.selection[4] !== 0;
  }, S = function(T) {
    for (var z = r.findContainerClientCoords(), G = z[0], $ = z[1], K = z[2], ve = z[3], j = T.touches ? T.touches : [T], ie = !1, oe = 0; oe < j.length; oe++) {
      var pe = j[oe];
      if (G <= pe.clientX && pe.clientX <= G + K && $ <= pe.clientY && pe.clientY <= $ + ve) {
        ie = !0;
        break;
      }
    }
    if (!ie)
      return !1;
    for (var Ee = r.container, Ce = T.target, fe = Ce.parentNode, ke = !1; fe; ) {
      if (fe === Ee) {
        ke = !0;
        break;
      }
  ...
  r.registerBinding(r.container, "mousedown", function(T) {
    if (S(T) && !(r.hoverData.which === 1 && T.which !== 1)) {
      T.preventDefault(), p(), r.hoverData.capture = !0, r.hoverData.which = T.which;
      var z = r.cy, G = [T.clientX, T.clientY], $ = r.projectIntoViewport(G[0], G[1]), K = r.selection, ve = r.findNearestElements($[0], $[1], !0, !1), j = ve[0], ie = r.dragData.possibleDragElements;
      ...
      if (T.which == 3) {
        ...
        j ? (j.activate(), j.emit(Ee), r.hoverData.down = j) : z.emit(Ee), r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), r.hoverData.cxtDragged = !1;
      } else if (T.which == 1) {
        j && j.activate();
        {
          if (j != null && r.nodeIsGrabbable(j)) {
            ...
            if (l(j), !j.selected())
              ie = r.dragData.possibleDragElements = z.collection(), d(j, {
                addToList: ie
              }), j.emit(oe("grabon")).emit(oe("grab"));
            else {
              ie = r.dragData.possibleDragElements = z.collection();
              var fe = z.$(function(ke) {
                return ke.isNode() && ke.selected() && r.nodeIsGrabbable(ke);
              });
              h(fe, {
                addToList: ie
              }), j.emit(oe("grabon")), fe.forEach(Ce);
            }
            r.redrawHint("eles", !0), r.redrawHint("drag", !0);
          }
          r.hoverData.down = j, r.hoverData.downs = ve, r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime();
        }
        n(j, ["mousedown", "tapstart", "vmousedown"], T, {
          ...
          x: $[0],
          y: $[1]
        }, r.redrawHint("select", !0), r.redraw()) : j.pannable() && (K[4] = 1), pe();
      }
      K[0] = K[2] = $[0], K[1] = K[3] = $[1];
    }
  }, !1);
  var k = a(r.container);
  r.registerBinding([e, k], "mousemove", function(T) {
    var z = r.hoverData.capture;
    if (!(!z && !S(T))) {
      var G = !1, $ = r.cy, K = $.zoom(), ve = [T.clientX, T.clientY], j = r.projectIntoViewport(ve[0], ve[1]), ie = r.hoverData.mdownPos, oe = r.hoverData.mdownGPos, pe = r.selection, Ee = null;
      !r.hoverData.draggingEles && !r.hoverData.dragging && !r.hoverData.selecting && (Ee = r.findNearestElement(j[0], j[1], !0, !1));
      var Ce = r.hoverData.last, fe = r.hoverData.down, ke = [j[0] - pe[2], j[1] - pe[3]], Pe = r.dragData.possibleDragElements, ar;
      if (oe) {
        var Ue = ve[0] - oe[0], Pr = Ue * Ue, Ke = ve[1] - oe[1], Ye = Ke * Ke, Je = Pr + Ye;
      ...
      G = !0, n(Ee, ["mousemove", "vmousemove", "tapdrag"], T, {
        x: j[0],
        y: j[1]
      });
      var We = function(Sr) {
      ...
      if (r.hoverData.which === 3) {
        if (ar) {
          var Ar = We("cxtdrag");
          fe ? fe.emit(Ar) : $.emit(Ar), r.hoverData.cxtDragged = !0, (!r.hoverData.cxtOver || Ee !== r.hoverData.cxtOver) && (r.hoverData.cxtOver && r.hoverData.cxtOver.emit(We("cxtdragout")), r.hoverData.cxtOver = Ee, Ee && Ee.emit(We("cxtdragover")));
        }
      ...
      } else if (pe[4] == 1 && (fe == null || fe.pannable())) {
        if (ar) {
        ...
        if (fe && fe.pannable() && fe.active() && fe.unactivate(), (!fe || !fe.grabbed()) && Ee != Ce && (Ce && n(Ce, ["mouseout", "tapdragout"], T, {
          x: j[0],
          y: j[1]
        }), Ee && n(Ee, ["mouseover", "tapdragover"], T, {
          x: j[0],
          y: j[1]
        }), r.hoverData.last = Ee), fe)
          if (ar) {
            if ($.boxSelectionEnabled() && or)
              fe && fe.grabbed() && (y(Pe), fe.emit(We("freeon")), Pe.emit(We("free")), r.dragData.didDrag && (fe.emit(We("dragfreeon")), Pe.emit(We("dragfree")))), $r();
              ...
              if (ae(ke[0]) && ae(ke[1]) && (cr.x += ke[0], cr.y += ke[1], wr)) {
                var xr = r.hoverData.dragDelta;
                xr && ae(xr[0]) && ae(xr[1]) && (cr.x += xr[0], cr.y += xr[1]);
              }
  ...
  r.registerBinding(e, "mouseup", function(T) {
    if (!(r.hoverData.which === 1 && T.which !== 1 && r.hoverData.capture)) {
      ...
      if (z) {
        ...
        var G = r.cy, $ = r.projectIntoViewport(T.clientX, T.clientY), K = r.selection, ve = r.findNearestElement($[0], $[1], !0, !1), j = r.dragData.possibleDragElements, ie = r.hoverData.down, oe = i(T);
        ...
        if (r.hoverData.which === 3) {
          ...
          if (n(ve, ["mouseup", "tapend", "vmouseup"], T, {
            x: $[0],
            y: $[1]
          }), !r.dragData.didDrag && // didn't move a node around
          !r.hoverData.dragged && // didn't pan
          !r.hoverData.selecting && // not box selection
          !r.hoverData.isOverThresholdDrag && (n(ie, ["click", "tap", "vclick"], T, {
            x: $[0],
            y: $[1]
          }), D = !1, T.timeStamp - P <= G.multiClickDebounceTime() ? (B && clearTimeout(B), D = !0, P = null, n(ie, ["dblclick", "dbltap", "vdblclick"], T, {
            x: $[0],
            y: $[1]
          })) : (B = setTimeout(function() {
            D || n(ie, ["oneclick", "onetap", "voneclick"], T, {
              x: $[0],
              y: $[1]
            });
          }, G.multiClickDebounceTime()), P = T.timeStamp)), ie == null && !r.dragData.didDrag && !r.hoverData.selecting && !r.hoverData.dragged && !i(T) && (G.$(t).unselect(["tapunselect"]), j.length > 0 && r.redrawHint("eles", !0), r.dragData.possibleDragElements = j = G.collection()), ve == ie && !r.dragData.didDrag && !r.hoverData.selecting && ve != null && ve._private.selectable && (r.hoverData.dragging || (G.selectionType() === "additive" || oe ? ve.selected() ? ve.unselect(["tapunselect"]) : ve.select(["tapselect"]) : oe || (G.$(t).unmerge(ve).unselect(["tapunselect"]), ve.select(["tapselect"]))), r.redrawHint("eles", !0)), r.hoverData.selecting) {
            var fe = G.collection(r.getAllInBox(K[0], K[1], K[2], K[3]));
            r.redrawHint("select", !0), fe.length > 0 && r.redrawHint("eles", !0), G.emit(pe("boxend"));
            var ke = function(Ue) {
              return Ue.selectable() && !Ue.selected();
            };
            G.selectionType() === "additive" || oe || G.$(t).unmerge(fe).unselect(), fe.emit(pe("box")).stdFilter(ke).select().emit(pe("boxselect")), r.redraw();
          }
          if (r.hoverData.dragging && (r.hoverData.dragging = !1, r.redrawHint("select", !0), r.redrawHint("eles", !0), r.redraw()), !K[4]) {
            ...
            y(j), Pe && (ie.emit(pe("freeon")), j.emit(pe("free")), r.dragData.didDrag && (ie.emit(pe("dragfreeon")), j.emit(pe("dragfree"))));
          }
        }
  ...
  var A = [], R = 4, L, I = 1e5, M = function(T, z) {
    for (var G = 0; G < T.length; G++)
      if (T[G] % z !== 0)
        return !1;
    return !0;
  }, O = function(T) {
    for (var z = Math.abs(T[0]), G = 1; G < T.length; G++)
      if (Math.abs(T[G]) !== z)
        return !1;
    return !0;
  }, q = function(T) {
    var z = !1, G = T.deltaY;
    if (G == null && (T.wheelDeltaY != null ? G = T.wheelDeltaY / 4 : T.wheelDelta != null && (G = T.wheelDelta / 4)), G !== 0) {
      if (L == null)
        if (A.length >= R) {
          var $ = A;
          if (L = M($, 5), !L) {
          ...
          if (L)
            for (var ve = 0; ve < $.length; ve++)
              I = Math.min(Math.abs($[ve]), I);
        } else
          A.push(G), z = !0;
      else L && (I = Math.min(Math.abs(G), I));
      if (!r.scrollingPage) {
        var j = r.cy, ie = j.zoom(), oe = j.pan(), pe = r.projectIntoViewport(T.clientX, T.clientY), Ee = [pe[0] * ie + oe.x, pe[1] * ie + oe.y];
        ...
        if (j.panningEnabled() && j.userPanningEnabled() && j.zoomingEnabled() && j.userZoomingEnabled()) {
          ...
          var Ce;
          z && Math.abs(G) > 5 && (G = to(G) * 5), Ce = G / -250, L && (Ce /= I, Ce *= 3), Ce = Ce * r.wheelSensitivity;
          var fe = T.deltaMode === 1;
          fe && (Ce *= 33);
          var ke = j.zoom() * Math.pow(10, Ce);
          T.type === "gesturechange" && (ke = r.gestureStartZoom * T.scale), j.zoom({
            level: ke,
            renderedPosition: {
              x: Ee[0],
              y: Ee[1]
  ...
  r.registerBinding(r.container, "wheel", q, !0), r.registerBinding(e, "scroll", function(T) {
  ...
  }, !0), r.registerBinding(r.container, "gesturechange", function(Q) {
    r.hasTouchStarted || q(Q);
  }, !0), r.registerBinding(r.container, "mouseout", function(T) {
    var z = r.projectIntoViewport(T.clientX, T.clientY);
    r.cy.emit({
      originalEvent: T,
      type: "mouseout",
      position: {
  ...
  var _, N, V, Y, J, Z, ee, re, ne, X, F, H, W, U = function(T, z, G, $) {
    return Math.sqrt((G - T) * (G - T) + ($ - z) * ($ - z));
  }, te = function(T, z, G, $) {
    return (G - T) * (G - T) + ($ - z) * ($ - z);
  }, le;
  r.registerBinding(r.container, "touchstart", le = function(T) {
    if (r.hasTouchStarted = !0, !!S(T)) {
      p(), r.touchData.capture = !0, r.data.bgActivePosistion = void 0;
      var z = r.cy, G = r.touchData.now, $ = r.touchData.earlier;
      if (T.touches[0]) {
        var K = r.projectIntoViewport(T.touches[0].clientX, T.touches[0].clientY);
        G[0] = K[0], G[1] = K[1];
      }
      if (T.touches[1]) {
        var K = r.projectIntoViewport(T.touches[1].clientX, T.touches[1].clientY);
        G[2] = K[0], G[3] = K[1];
      }
      if (T.touches[2]) {
        var K = r.projectIntoViewport(T.touches[2].clientX, T.touches[2].clientY);
        G[4] = K[0], G[5] = K[1];
      }
      var ve = function(or) {
        return {
      ...
      if (T.touches[1]) {
        ...
        var j = r.findContainerClientCoords();
        ne = j[0], X = j[1], F = j[2], H = j[3], _ = T.touches[0].clientX - ne, N = T.touches[0].clientY - X, V = T.touches[1].clientX - ne, Y = T.touches[1].clientY - X, W = 0 <= _ && _ <= F && 0 <= V && V <= F && 0 <= N && N <= H && 0 <= Y && Y <= H;
        var ie = z.pan(), oe = z.zoom();
        J = U(_, N, V, Y), Z = te(_, N, V, Y), ee = [(_ + V) / 2, (N + Y) / 2], re = [(ee[0] - ie.x) / oe, (ee[1] - ie.y) / oe];
        var pe = 200, Ee = pe * pe;
        if (Z < Ee && !T.touches[2]) {
          var Ce = r.findNearestElement(G[0], G[1], !0, !0), fe = r.findNearestElement(G[2], G[3], !0, !0);
          Ce && Ce.isNode() ? (Ce.activate().emit(ve("cxttapstart")), r.touchData.start = Ce) : fe && fe.isNode() ? (fe.activate().emit(ve("cxttapstart")), r.touchData.start = fe) : z.emit(ve("cxttapstart")), r.touchData.start && (r.touchData.start._private.grabbed = !1), r.touchData.cxt = !0, r.touchData.cxtDragged = !1, r.data.bgActivePosistion = void 0, r.redraw();
          return;
        }
      }
      if (T.touches[2])
        z.boxSelectionEnabled() && T.preventDefault();
      else if (!T.touches[1]) {
        if (T.touches[0]) {
          ...
          if (Pe != null && (Pe.activate(), r.touchData.start = Pe, r.touchData.starts = ke, r.nodeIsGrabbable(Pe))) {
            ...
            r.redrawHint("eles", !0), r.redrawHint("drag", !0), Pe.selected() ? (Ue = z.$(function(Je) {
              ...
              addToList: ar
            }), l(Pe), Pe.emit(ve("grabon")), Ue ? Ue.forEach(function(Je) {
              Je.emit(ve("grab"));
            }) : Pe.emit(ve("grab"));
          }
          n(Pe, ["touchstart", "tapstart", "vmousedown"], T, {
            x: G[0],
            y: G[1]
  ...
  var De;
  r.registerBinding(e, "touchmove", De = function(T) {
    var z = r.touchData.capture;
    if (!(!z && !S(T))) {
      var G = r.selection, $ = r.cy, K = r.touchData.now, ve = r.touchData.earlier, j = $.zoom();
      if (T.touches[0]) {
        var ie = r.projectIntoViewport(T.touches[0].clientX, T.touches[0].clientY);
        K[0] = ie[0], K[1] = ie[1];
      }
      if (T.touches[1]) {
        var ie = r.projectIntoViewport(T.touches[1].clientX, T.touches[1].clientY);
        K[2] = ie[0], K[3] = ie[1];
      }
      if (T.touches[2]) {
        var ie = r.projectIntoViewport(T.touches[2].clientX, T.touches[2].clientY);
        K[4] = ie[0], K[5] = ie[1];
      }
      var oe = function(ec) {
        return {
      ...
      if (z && T.touches[0] && pe) {
        for (var Ce = [], fe = 0; fe < K.length; fe++)
          Ce[fe] = K[fe] - ve[fe];
        var ke = T.touches[0].clientX - pe[0], Pe = ke * ke, ar = T.touches[0].clientY - pe[1], Ue = ar * ar, Pr = Pe + Ue;
        Ee = Pr >= r.touchTapThreshold2;
      }
      if (z && r.touchData.cxt) {
        T.preventDefault();
        var Ke = T.touches[0].clientX - ne, Ye = T.touches[0].clientY - X, Je = T.touches[1].clientX - ne, or = T.touches[1].clientY - X, Nr = te(Ke, Ye, Je, or), We = Nr / Z, $r = 150, Ar = $r * $r, Jr = 1.5, $a = Jr * Jr;
        if (We >= $a || Nr >= Ar) {
      ...
      if (z && r.touchData.cxt) {
        ...
        var wr = r.findNearestElement(K[0], K[1], !0, !0);
        (!r.touchData.cxtOver || wr !== r.touchData.cxtOver) && (r.touchData.cxtOver && r.touchData.cxtOver.emit(oe("cxtdragout")), r.touchData.cxtOver = wr, wr && wr.emit(oe("cxtdragover")));
      } else if (z && T.touches[2] && $.boxSelectionEnabled())
      ...
      else if (z && T.touches[1] && !r.touchData.didSelect && $.zoomingEnabled() && $.panningEnabled() && $.userZoomingEnabled() && $.userPanningEnabled()) {
        T.preventDefault(), r.data.bgActivePosistion = void 0, r.redrawHint("select", !0);
        var cr = r.dragData.touchDragEles;
        if (cr) {
          r.redrawHint("drag", !0);
          for (var xr = 0; xr < cr.length; xr++) {
            var oa = cr[xr]._private;
            oa.grabbed = !1, oa.rscratch.inDragLayer = !1;
          }
        }
        var Sr = r.touchData.start, Ke = T.touches[0].clientX - ne, Ye = T.touches[0].clientY - X, Je = T.touches[1].clientX - ne, or = T.touches[1].clientY - X, wo = U(Ke, Ye, Je, or), $f = wo / J;
        if (W) {
          var Uf = Ke - _, Kf = Ye - N, Xf = Je - V, Yf = or - Y, Zf = (Uf + Xf) / 2, Qf = (Kf + Yf) / 2, ua = $.zoom(), Zn = ua * $f, Ua = $.pan(), xo = re[0] * ua + Ua.x, Eo = re[1] * ua + Ua.y, Jf = {
            x: -Zn / ua * (xo - Ua.x - Zf) + xo,
            y: -Zn / ua * (Eo - Ua.y - Qf) + Eo
          };
          if (Sr && Sr.active()) {
            var cr = r.dragData.touchDragEles;
          ...
          }), $.emit(oe("pinchzoom")), J = wo, _ = Ke, N = Ye, V = Je, Y = or, r.pinching = !0;
        }
        if (T.touches[0]) {
          var ie = r.projectIntoViewport(T.touches[0].clientX, T.touches[0].clientY);
          K[0] = ie[0], K[1] = ie[1];
        ...
        var Rr = r.touchData.start, Qn = r.touchData.last, wr;
        if (!r.hoverData.draggingEles && !r.swipePanning && (wr = r.findNearestElement(K[0], K[1], !0, !0)), z && Rr != null && T.preventDefault(), z && Rr != null && r.nodeIsDraggable(Rr))
          if (Ee) {
            var cr = r.dragData.touchDragEles, Co = !r.dragData.didDrag;
            Co && h(cr, {
              inDragLayer: !0
            ...
            if (ae(Ce[0]) && ae(Ce[1]) && (la.x += Ce[0], la.y += Ce[1], Co)) {
              r.redrawHint("eles", !0);
              var Mr = r.touchData.dragDelta;
              Mr && ae(Mr[0]) && ae(Mr[1]) && (la.x += Mr[0], la.y += Mr[1]);
            }
            r.hoverData.draggingEles = !0, cr.silentShift(la).emit(oe("position")).emit(oe("drag")), r.redrawHint("drag", !0), r.touchData.startPosition[0] == ve[0] && r.touchData.startPosition[1] == ve[1] && r.redrawHint("eles", !0), r.redraw();
          } else {
            var Mr = r.touchData.dragDelta = r.touchData.dragDelta || [];
            Mr.length === 0 ? (Mr.push(Ce[0]), Mr.push(Ce[1])) : (Mr[0] += Ce[0], Mr[1] += Ce[1]);
          }
        if (n(Rr || wr, ["touchmove", "tapdrag", "vmousemove"], T, {
          x: K[0],
          y: K[1]
        }), (!Rr || !Rr.grabbed()) && wr != Qn && (Qn && Qn.emit(oe("tapdragout")), wr && wr.emit(oe("tapdragover"))), r.touchData.last = wr, z)
          for (var xr = 0; xr < K.length; xr++)
            K[xr] && r.touchData.startPosition[xr] && Ee && (r.touchData.singleTouchMoved = !0);
        if (z && (Rr == null || Rr.pannable()) && $.panningEnabled() && $.userPanningEnabled()) {
          var jf = s(Rr, r.touchData.starts);
          jf && (T.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = Gt(r.touchData.startPosition)), r.swipePanning ? ($.panBy({
            x: Ce[0] * j,
            y: Ce[1] * j
      ...
      for (var fe = 0; fe < K.length; fe++)
        ve[fe] = K[fe];
      z && T.touches.length > 0 && !r.hoverData.draggingEles && !r.swipePanning && r.data.bgActivePosistion != null && (r.data.bgActivePosistion = void 0, r.redrawHint("select", !0), r.redraw());
    }
  }, !1);
  var we;
  r.registerBinding(e, "touchcancel", we = function(T) {
    var z = r.touchData.start;
    r.touchData.capture = !1, z && z.unactivate();
  });
  var me, ge, se, de;
  if (r.registerBinding(e, "touchend", me = function(T) {
    ...
    var K = r.cy, ve = K.zoom(), j = r.touchData.now, ie = r.touchData.earlier;
    if (T.touches[0]) {
      var oe = r.projectIntoViewport(T.touches[0].clientX, T.touches[0].clientY);
      j[0] = oe[0], j[1] = oe[1];
    }
    if (T.touches[1]) {
      var oe = r.projectIntoViewport(T.touches[1].clientX, T.touches[1].clientY);
      j[2] = oe[0], j[3] = oe[1];
    }
    if (T.touches[2]) {
      var oe = r.projectIntoViewport(T.touches[2].clientX, T.touches[2].clientY);
      j[4] = oe[0], j[5] = oe[1];
    }
    var pe = function(Ar) {
      return {
    ...
    if (!T.touches[2] && K.boxSelectionEnabled() && r.touchData.selecting) {
      r.touchData.selecting = !1;
      var fe = K.collection(r.getAllInBox($[0], $[1], $[2], $[3]));
      $[0] = void 0, $[1] = void 0, $[2] = void 0, $[3] = void 0, $[4] = 0, r.redrawHint("select", !0), K.emit(pe("boxend"));
      var ke = function(Ar) {
        return Ar.selectable() && !Ar.selected();
      };
      fe.emit(pe("box")).stdFilter(ke).select().emit(pe("boxselect")), fe.nonempty() && r.redrawHint("eles", !0), r.redraw();
    }
    if (z?.unactivate(), T.touches[2])
      ...
      if (!T.touches[0]) {
        if (!T.touches[0]) {
          ...
          if (z != null) {
            ...
            y(Pe), r.redrawHint("drag", !0), r.redrawHint("eles", !0), ar && (z.emit(pe("freeon")), Pe.emit(pe("free")), r.dragData.didDrag && (z.emit(pe("dragfreeon")), Pe.emit(pe("dragfree")))), n(z, ["touchend", "tapend", "vmouseup", "tapdragout"], T, {
              x: j[0],
              y: j[1]
            }), z.unactivate(), r.touchData.start = null;
          } else {
            var Ue = r.findNearestElement(j[0], j[1], !0, !0);
            n(Ue, ["touchend", "tapend", "vmouseup", "tapdragout"], T, {
              x: j[0],
              y: j[1]
            });
          }
          var Pr = r.touchData.startPosition[0] - j[0], Ke = Pr * Pr, Ye = r.touchData.startPosition[1] - j[1], Je = Ye * Ye, or = Ke + Je, Nr = or * ve * ve;
          r.touchData.singleTouchMoved || (z || K.$(":selected").unselect(["tapunselect"]), n(z, ["tap", "vclick"], T, {
            x: j[0],
            y: j[1]
          }), ge = !1, T.timeStamp - de <= K.multiClickDebounceTime() ? (se && clearTimeout(se), ge = !0, de = null, n(z, ["dbltap", "vdblclick"], T, {
            x: j[0],
            y: j[1]
          })) : (se = setTimeout(function() {
            ge || n(z, ["onetap", "voneclick"], T, {
              x: j[0],
              y: j[1]
            });
          }, K.multiClickDebounceTime()), de = T.timeStamp)), z != null && !r.dragData.didDrag && z._private.selectable && Nr < r.touchTapThreshold2 && !r.pinching && (K.selectionType() === "single" ? (K.$(t).unmerge(z).unselect(["tapunselect"]), z.select(["tapselect"])) : z.selected() ? z.unselect(["tapunselect"]) : z.select(["tapselect"]), r.redrawHint("eles", !0)), r.touchData.singleTouchMoved = !0;
        }
      }
    }
    ...
    var ce = [], xe = function(T) {
      ...
      for (var z = 0; z < ce.length; z++) {
        var G = ce[z];
        if (G.event.pointerId === T.pointerId) {
          ce.splice(z, 1);
          return;
        }
      }
    }, Oe = function(T) {
      var z = ce.filter(function(G) {
        return G.event.pointerId === T.pointerId;
      })[0];
      z.event = T, z.touch = xe(T);
    }, Le = function(T) {
      T.touches = ce.map(function(z) {
        return z.touch;
      });
    }, Ae = function(T) {
      return T.pointerType === "mouse" || T.pointerType === 4;
    };
    r.registerBinding(r.container, "pointerdown", function(Q) {
      Ae(Q) || (Q.preventDefault(), Se(Q), Le(Q), le(Q));
    }), r.registerBinding(r.container, "pointerup", function(Q) {
      Ae(Q) || (Be(Q), Le(Q), me(Q));
    }), r.registerBinding(r.container, "pointercancel", function(Q) {
      Ae(Q) || (Be(Q), Le(Q), we(Q));
    }), r.registerBinding(r.container, "pointermove", function(Q) {
      Ae(Q) || (Q.preventDefault(), Oe(Q), Le(Q), De(Q));
    });
  }
};
var Zr = {};
  ...
  return this.nodeShapes[r] = {
    ...
    getOrCreateCorners: function(a, n, i, s, o, u, l) {
      ...
      for (y = c[m - 1], d = 0; d < m; d++)
        g = c[d % m], p = c[(d + 1) % m], u[l][d] = po(y, g, p, o), y = g, g = p;
      return u[l];
    },
    ...
    intersectLine: function(a, n, i, s, o, u, l, v, f) {
      return _d(o, u, this.points, a, n, i, s, l, this.getOrCreateCorners(a, n, i, s, v, f, "corners"));
    },
    checkPoint: function(a, n, i, s, o, u, l, v, f) {
      return Fd(a, n, this.points, u, l, s, o, this.getOrCreateCorners(u, l, s, o, v, f, "corners"));
    }
  };
};
...
Zr.generateBarrel = function() {
  return this.nodeShapes.barrel = {
    ...
    generateBarrelBezierPts: function(e, t, a, n) {
      var i = t / 2, s = e / 2, o = a - s, u = a + s, l = n - i, v = n + i, f = As(e, t), c = f.heightOffset, h = f.widthOffset, d = f.ctrlPtOffsetPct * e, y = {
    ...
    checkPoint: function(e, t, a, n, i, s, o, u) {
      var l = As(n, i), v = l.heightOffset, f = l.widthOffset;
      if (Yr(e, t, this.points, s, o, n, i - 2 * v, [0, -1], a) || Yr(e, t, this.points, s, o, n - 2 * f, i, [0, -1], a))
        return !0;
      for (var c = this.generateBarrelBezierPts(n, i, s, o), h = function(S, k, B) {
        var D = B[4], P = B[2], A = B[0], R = B[5], L = B[1], I = Math.min(D, A), M = Math.max(D, A), O = Math.min(R, L), q = Math.max(R, L);
        if (I <= S && S <= M && O <= k && k <= q) {
          var _ = Gd(D, P, A), N = Id(_[0], _[1], _[2], S), V = N.filter(function(Y) {
            return 0 <= Y && Y <= 1;
          });
          if (V.length > 0)
            return V[0];
...
Zr.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, u) {
      ...
      return h.length > 0 ? h : wv(i, s, e, t, a, n, o, u);
    },
    checkPoint: function(e, t, a, n, i, s, o, u) {
      u = u === "auto" ? lt(n, i) : u;
      var l = 2 * u;
...
[go, xf, Ef, ia, Zr, Ha].forEach(function(r) {
  ye(sa, r);
});
var ws = 1e3 / 60, Sf = {
...
})(), Nl = 25, nn = 50, pn = -4, Hs = 3, kf = 7.99, ly = 8, vy = 1024, fy = 1024, cy = 1024, dy = 0.2, hy = 0.8, gy = 10, py = 0.15, yy = 0.1, my = 0.9, by = 0.9, wy = 100, xy = 1, Wt = {
  dequeue: "dequeue",
  downscale: "downscale",
  ...
  var n = Ey(t);
  ye(a, n), a.lookup = new uy(n.getKey, n.doesEleInvalidateKey), a.setupDequeueing();
}, tr = ba.prototype;
tr.reasons = Wt;
...
tr.getElement = function(r, e, t, a, n) {
  ...
  if (h && h.invalidated && (h.invalidated = !1, h.texture.invalidatedWidth -= h.width), h)
    return h;
  var d;
  if (v <= Nl ? d = Nl : v <= nn ? d = nn : d = Math.ceil(v / nn) * nn, v > cy || f > fy)
    return null;
  ...
  }, b = n && n === Wt.dequeue, w = n && n === Wt.highQuality, E = n && n === Wt.downscale, C, x = a + 1; x <= Hs; x++) {
    var S = u.get(r, x);
    if (S) {
      C = S;
      break;
  ...
  return h = {
    ...
    height: v,
    scaledLabelShown: c
  }, g.usedWidth += Math.ceil(f + ly), g.eleCaches.push(h), u.set(r, a, h), i.checkTextureFullness(g), h;
};
...
tr.checkTextureUtility = function(r) {
  r.invalidatedWidth >= dy * r.width && this.retireTexture(r);
};
tr.checkTextureFullness = function(r) {
  var e = this, t = e.getTextureQueue(r.height);
  r.usedWidth / r.width > hy && r.fullnessChecks >= gy ? ut(t, r) : r.fullnessChecks++;
};
...
tr.addTexture = function(r, e) {
  ...
  return a.push(n), n.eleCaches = [], n.height = r, n.width = Math.max(vy, e), n.usedWidth = 0, n.invalidatedWidth = 0, n.fullnessChecks = 0, n.canvas = t.renderer.makeOffscreenCanvas(n.width, n.height), n.context = n.canvas.getContext("2d"), n;
};
...
tr.dequeue = function(r) {
  for (var e = this, t = e.getElementQueue(), a = e.getElementKeyToQueue(), n = [], i = e.lookup, s = 0; s < xy && t.size() > 0; s++) {
...
tr.setupDequeueing = Sf.setupDequeueing({
  deqRedrawThreshold: wy,
  deqCost: py,
  deqAvgCost: yy,
  deqNoDrawCost: my,
  deqFastCost: by,
...
var Cy = 1, xa = -4, Pn = 2, Ty = 3.99, Sy = 50, ky = 50, Dy = 0.15, By = 0.1, Py = 0.9, Ay = 0.9, Ry = 1, zl = 250, My = 4e3 * 4e3, Fl = 32767, Ly = !0, Df = function(e) {
  var t = this, a = t.renderer = e, n = a.cy;
  t.layersByLevel = {}, t.firstGet = !0, t.lastInvalidationTime = Xr() - 2 * zl, t.skipping = !1, t.eleTxrDeqs = n.collection(), t.scheduleElementRefinement = Fa(function() {
    t.refineElementTextures(t.eleTxrDeqs), t.eleTxrDeqs.unmerge(t.eleTxrDeqs);
  }, ky), a.beforeRender(function(s, o) {
...
}, fr = Df.prototype, Vl = 0, Iy = Math.pow(2, 53) - 1;
...
fr.getLayers = function(r, e, t) {
  ...
  var u = a.layersByLevel, l = Math.pow(2, t), v = u[t] = u[t] || [], f, c = a.levelIsComplete(t, r), h, d = function() {
    var B = function(L) {
      ...
      if (!h)
        for (var I = t + L; xa <= I && I <= Pn && !B(I); I += L)
          ;
    };
    D(1), D(-1);
  ...
  if (a.skipping && !o)
    return null;
  for (var p = null, m = r.length / Cy, b = !o, w = 0; w < r.length; w++) {
    var E = r[w], C = E._private.rscratch, x = C.imgLayerCaches = C.imgLayerCaches || {}, S = x[t];
    if (S) {
      p = S;
      continue;
    }
...
fr.drawEleInLayer = function(r, e, t, a) {
  ...
  o.w === 0 || o.h === 0 || !e.visible() || (t = n.getEleLevelForLayerLevel(t, a), i.setImgSmoothing(s, !1), i.drawCachedElement(s, e, null, null, t, Ly), i.setImgSmoothing(s, !0));
};
...
fr.updateElementsInLayers = function(r, e) {
  for (var t = this, a = Ia(r[0]), n = 0; n < r.length; n++)
    for (var i = a ? null : r[n], s = a ? r[n] : r[n].ele, o = s._private.rscratch, u = o.imgLayerCaches = o.imgLayerCaches || {}, l = xa; l <= Pn; l++) {
      var v = u[l];
...
fr.dequeue = function(r) {
  for (var e = this, t = e.layersQueue, a = [], n = 0; n < Ry && t.size() !== 0; ) {
    var i = t.peek();
    if (i.replacement) {
      t.pop();
      continue;
...
fr.requestRedraw = Fa(function() {
  var r = this.renderer;
  r.redrawHint("eles", !0), r.redrawHint("drag", !0), r.redraw();
}, 100);
fr.setupDequeueing = Sf.setupDequeueing({
  deqRedrawThreshold: Sy,
  deqCost: Dy,
  deqAvgCost: By,
  deqNoDrawCost: Py,
  deqFastCost: Ay,
  ...
  if (!(l.w === 0 || l.h === 0)) {
    ...
    if (v != null) {
      ...
      if (c !== 0) {
        ...
        p = h, m = d;
      var S;
      f !== 1 && (S = r.globalAlpha, r.globalAlpha = S * f), r.drawImage(v.texture.canvas, v.x, 0, v.width, v.height, p, m, y, g), f !== 1 && (r.globalAlpha = S), c !== 0 && (r.rotate(-c), r.translate(-b, -w), E || u.setImgSmoothing(r, !1));
    } else
      t.drawElement(r, e);
  }
};
...
Wr.drawCachedElement = function(r, e, t, a, n, i) {
  ...
  if (!(c.w === 0 || c.h === 0 || !e.visible()) && (!a || ao(c, a))) {
    ...
    s.drawElementUnderlay(r, e), s.drawCachedElementPortion(r, e, u, t, n, h, Vy, Hy), (!d || !y) && s.drawCachedElementPortion(r, e, l, t, n, h, qy, xs), d && !y && (s.drawCachedElementPortion(r, e, v, t, n, h, _y, xs), s.drawCachedElementPortion(r, e, f, t, n, h, Gy, xs)), s.drawElementOverlay(r, e);
  }
};
...
Qr.drawEdge = function(r, e, t) {
  ...
  if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
    ...
    if (k) {
      ...
      w();
    C(), b(), x(), E(), S(), t && r.translate(u.x1, u.y1);
  }
};
var Pf = function(e) {
...
Qr.drawEdgeOverlay = Pf("overlay");
Qr.drawEdgeUnderlay = Pf("underlay");
...
var mo = {};
mo.safeDrawImage = function(r, e, t, a, n, i, s, o, u, l) {
  if (!(n <= 0 || i <= 0 || u <= 0 || l <= 0))
    try {
...
mo.drawInscribedImage = function(r, e, t, a, n) {
  ...
  var S = e.width || e.cachedW, k = e.height || e.cachedH;
  (S == null || k == null) && (document.body.appendChild(e), S = e.cachedW = e.width || e.offsetWidth, k = e.cachedH = e.height || e.offsetHeight, document.body.removeChild(e));
  var B = S, D = k;
  if (v(t, "background-width", "value", a) !== "auto" && (v(t, "background-width", "units", a) === "%" ? B = v(t, "background-width", "pfValue", a) * g : B = v(t, "background-width", "pfValue", a)), v(t, "background-height", "value", a) !== "auto" && (v(t, "background-height", "units", a) === "%" ? D = v(t, "background-height", "pfValue", a) * p : D = v(t, "background-height", "pfValue", a)), !(B === 0 || D === 0)) {
    ...
    q === "%" ? O += (p - D) * _ : O += _;
    var N = v(t, "background-offset-y", "units", a), V = v(t, "background-offset-y", "pfValue", a);
    N === "%" ? O += (p - D) * V : O += V, m.pathCache && (A -= o, O -= u, o = 0, u = 0);
    var Y = r.globalAlpha;
    r.globalAlpha = E;
    var J = i.getImgSmoothing(r), Z = !1;
    if (C === "no" && J ? (i.setImgSmoothing(r, !1), Z = !0) : C === "yes" && !J && (i.setImgSmoothing(r, !0), Z = !0), c === "no-repeat")
      w && (r.save(), m.pathCache ? r.clip(m.pathCache) : (i.nodeShapes[i.getNodeShape(t)].draw(r, o, u, g, p, x, m), r.clip())), i.safeDrawImage(r, e, 0, 0, S, k, A, O, B, D), w && r.restore();
    else {
      var ee = r.createPattern(e, c);
      r.fillStyle = ee, i.nodeShapes[i.getNodeShape(t)].draw(r, o, u, g, p, x, m), r.translate(A, O), r.fill(), r.translate(-A, -O);
    }
    r.globalAlpha = Y, Z && i.setImgSmoothing(r, J);
  }
};
var Mt = {};
...
Mt.drawText = function(r, e, t) {
  ...
  if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
    t === "main" && (t = null);
    var u = yr(s, "labelX", t), l = yr(s, "labelY", t), v, f, c = this.getLabelText(e, t);
    if (c != null && c !== "" && !isNaN(u) && !isNaN(l)) {
      this.setupTextStyle(r, e, n);
      var h = t ? t + "-" : "", d = yr(s, "labelWidth", t), y = yr(s, "labelHeight", t), g = yr(s, "labelActualDescent", t), p = e.pstyle(h + "text-margin-x").pfValue, m = e.pstyle(h + "text-margin-y").pfValue, b = e.isEdge(), w = e.pstyle("text-halign").value, E = e.pstyle("text-valign").value;
      ...
      if (k > 0 || D > 0 && B > 0) {
        var M = r.fillStyle, O = r.strokeStyle, q = r.lineWidth, _ = e.pstyle("text-background-color").value, N = e.pstyle("text-border-color").value, V = e.pstyle("text-border-style").value, Y = k > 0, J = D > 0 && B > 0, Z = u - P;
        switch (x) {
          case "left":
            Z -= d;
            break;
        ...
        var ee = l - y - P, re = d + 2 * P, ne = y + 2 * P;
        if (Y && (r.fillStyle = "rgba(".concat(_[0], ",").concat(_[1], ",").concat(_[2], ",").concat(k * o, ")")), J && (r.strokeStyle = "rgba(".concat(N[0], ",").concat(N[1], ",").concat(N[2], ",").concat(B * o, ")"), r.lineWidth = D, r.setLineDash))
          switch (V) {
            case "dotted":
              r.setLineDash([1, 1]);
              break;
        ...
        if (R ? (r.beginPath(), Gl(r, Z, ee, re, ne, I)) : L ? (r.beginPath(), Wy(r, Z, ee, re, ne)) : (r.beginPath(), r.rect(Z, ee, re, ne)), Y && r.fill(), J && r.stroke(), J && V === "double") {
          var X = D / 2;
          r.beginPath(), R ? Gl(r, Z + X, ee + X, re - 2 * X, ne - 2 * X, I) : r.rect(Z + X, ee + X, re - 2 * X, ne - 2 * X), r.stroke();
        }
        r.fillStyle = M, r.strokeStyle = O, r.lineWidth = q, r.setLineDash && r.setLineDash([]);
      }
      var F = 2 * e.pstyle("text-outline-width").pfValue;
      if (F > 0 && (r.lineWidth = F), l -= g, e.pstyle("text-wrap").value === "wrap") {
        var H = yr(s, "labelWrapCachedLines", t), W = yr(s, "labelLineHeight", t), U = d / 2, te = this.getLabelJustification(e);
        switch (te === "auto" || (x === "left" ? te === "left" ? u += -d : te === "center" && (u += -U) : x === "center" ? te === "left" ? u += -U : te === "right" && (u += U) : x === "right" && (te === "center" ? u += U : te === "right" && (u += d))), S) {
          case "top":
            l -= (H.length - 1) * W;
            break;
          case "center":
        ...
        for (var le = 0; le < H.length; le++)
          F > 0 && r.strokeText(H[le], u, l), r.fillText(H[le], u, l), l += W;
      } else
        F > 0 && r.strokeText(c, u, l), r.fillText(c, u, l);
...
pt.drawNode = function(r, e, t) {
  ...
  if (!(!ae(f.x) || !ae(f.y)) && !(i && !e.visible())) {
    ...
    for (var m = e.pstyle("background-image"), b = m.value, w = new Array(b.length), E = new Array(b.length), C = 0, x = 0; x < b.length; x++) {
      var S = b[x], k = w[x] = S != null && S !== "none";
      if (k) {
        var B = e.cy().style().getIndexedStyle(e, "background-image-crossorigin", "value", x);
        C++, E[x] = s.getCachedImage(S, B, function() {
          l.backgroundTimestamp = Date.now(), e.emitAndNotify("background");
        });
      }
    }
    var D = e.pstyle("background-blacken").value, P = e.pstyle("border-width").pfValue, A = e.pstyle("background-opacity").value * c, R = e.pstyle("border-color").value, L = e.pstyle("border-style").value, I = e.pstyle("border-join").value, M = e.pstyle("border-cap").value, O = e.pstyle("border-position").value, q = e.pstyle("border-dash-pattern").pfValue, _ = e.pstyle("border-dash-offset").pfValue, N = e.pstyle("border-opacity").value * c, V = e.pstyle("outline-width").pfValue, Y = e.pstyle("outline-color").value, J = e.pstyle("outline-style").value, Z = e.pstyle("outline-opacity").value * c, ee = e.pstyle("outline-offset").value, re = e.pstyle("corner-radius").value;
    re !== "auto" && (re = e.pstyle("corner-radius").pfValue);
    var ne = function() {
      var T = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : A;
      s.eleFillStyle(r, e, T);
    }, X = function() {
      var T = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : N;
      s.colorStrokeStyle(r, R[0], R[1], R[2], T);
    }, F = function() {
      var T = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Z;
      s.colorStrokeStyle(r, Y[0], Y[1], Y[2], T);
    }, H = function(T, z, G, $) {
      var K = s.nodePathCache = s.nodePathCache || [], ve = cv(G === "polygon" ? G + "," + $.join(",") : G, "" + z, "" + T, "" + re), j = K[ve], ie, oe = !1;
      return j != null ? (ie = j, oe = !0, v.pathCache = ie) : (ie = new Path2D(), K[ve] = v.pathCache = ie), {
        path: ie,
        cacheHit: oe
      };
    }, W = e.pstyle("shape").strValue, U = e.pstyle("shape-polygon-points").pfValue;
    if (h) {
      r.translate(f.x, f.y);
      var te = H(o, u, W, U);
    ...
    var le = function() {
      if (!y) {
        ...
        h && (T = {
          x: 0,
          y: 0
        }), s.nodeShapes[s.getNodeShape(e)].draw(d || r, T.x, T.y, o, u, re, v);
      }
      h ? r.fill(d) : r.fill();
    }, De = function() {
      for (var T = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, z = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, G = l.backgrounding, $ = 0, K = 0; K < E.length; K++) {
        var ve = e.cy().style().getIndexedStyle(e, "background-image-containment", "value", K);
        if (z && ve === "over" || !z && ve === "inside") {
          $++;
          continue;
        }
        w[K] && E[K].complete && !E[K].error && ($++, s.drawInscribedImage(r, E[K], e, K, T));
      }
      l.backgrounding = $ !== C, G !== l.backgrounding && e.updateStyle(!1);
    }, we = function() {
      var T = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, z = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
      s.hasPie(e) && (s.drawPie(r, e, z), T && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, u, re, v)));
    }, me = function() {
      var T = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, z = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
      s.hasStripe(e) && (r.save(), h ? r.clip(v.pathCache) : (s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, u, re, v), r.clip()), s.drawStripe(r, e, z), r.restore(), T && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, u, re, v)));
    }, ge = function() {
      var T = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, z = (D > 0 ? D : -D) * T, G = D > 0 ? 0 : 255;
      D !== 0 && (s.colorFillStyle(r, G, G, G, z), h ? r.fill(d) : r.fill());
    }, se = function() {
      if (P > 0) {
        ...
        if (O !== "center") {
          if (r.save(), r.lineWidth *= 2, O === "inside")
            ...
            var T = new Path2D();
            T.rect(-o / 2 - P, -u / 2 - P, o + 2 * P, u + 2 * P), T.addPath(d), r.clip(T, "evenodd");
          }
      ...
      if (V > 0) {
        ...
        var $ = (o + G + (V + ee)) / o, K = (u + G + (V + ee)) / u, ve = o * $, j = u * K, ie = s.nodeShapes[z].points, oe;
        if (h) {
          var pe = H(ve, j, z, ie);
          oe = pe.path;
        }
        if (z === "ellipse")
          s.drawEllipsePath(oe || r, T.x, T.y, ve, j);
          ...
          var Ee = 0, Ce = 0, fe = 0;
          z === "round-diamond" ? Ee = (G + ee + V) * 1.4 : z === "round-heptagon" ? (Ee = (G + ee + V) * 1.075, fe = -(G / 2 + ee + V) / 35) : z === "round-hexagon" ? Ee = (G + ee + V) * 1.12 : z === "round-pentagon" ? (Ee = (G + ee + V) * 1.13, fe = -(G / 2 + ee + V) / 15) : z === "round-tag" ? (Ee = (G + ee + V) * 1.12, Ce = (G / 2 + V + ee) * 0.07) : z === "round-triangle" && (Ee = (G + ee + V) * (Math.PI / 2), fe = -(G + ee / 2 + V) / Math.PI), Ee !== 0 && ($ = (o + Ee) / o, ve = o * $, ["round-hexagon", "round-tag"].includes(z) || (K = (u + Ee) / u, j = u * K)), re = re === "auto" ? Ev(ve, j) : re;
          for (var ke = ve / 2, Pe = j / 2, ar = re + (G + V + ee) / 2, Ue = new Array(ie.length / 2), Pr = new Array(ie.length / 2), Ke = 0; Ke < ie.length / 2; Ke++)
            Ue[Ke] = {
              x: T.x + Ce + ke * ie[Ke * 2],
              y: T.y + fe + Pe * ie[Ke * 2 + 1]
            };
          var Ye, Je, or, Nr, We = Ue.length;
          for (Je = Ue[We - 1], Ye = 0; Ye < We; Ye++)
            or = Ue[Ye % We], Nr = Ue[(Ye + 1) % We], Pr[Ye] = po(Je, or, Nr, ar), Je = or, or = Nr;
          s.drawRoundPolygonPath(oe || r, T.x + Ce, T.y + fe, o * $, u * K, ie, Pr);
        } else if (["roundrectangle", "round-rectangle"].includes(z))
          re = re === "auto" ? lt(ve, j) : re, s.drawRoundRectanglePath(oe || r, T.x, T.y, ve, j, re + (G + V + ee) / 2);
        else if (["cutrectangle", "cut-rectangle"].includes(z))
          re = re === "auto" ? no() : re, s.drawCutRectanglePath(oe || r, T.x, T.y, ve, j, null, re + (G + V + ee) / 4);
        else if (["bottomroundrectangle", "bottom-round-rectangle"].includes(z))
          re = re === "auto" ? lt(ve, j) : re, s.drawBottomRoundRectanglePath(oe || r, T.x, T.y, ve, j, re + (G + V + ee) / 2);
        else if (z === "barrel")
          s.drawBarrelPath(oe || r, T.x, T.y, ve, j);
        else if (z.startsWith("polygon") || ["rhomboid", "right-rhomboid", "round-tag", "tag", "vee"].includes(z)) {
          var $r = (G + V + ee) / o;
          ie = En(Cn(ie, $r)), s.drawPolygonPath(oe || r, T.x, T.y, o, u, ie);
        } else {
          var Ar = (G + V + ee) / o;
          ie = En(Cn(ie, -Ar)), s.drawPolygonPath(oe || r, T.x, T.y, o, u, ie);
        }
    ...
    if (Se) {
      var Be = e.pstyle("ghost-offset-x").pfValue, Oe = e.pstyle("ghost-offset-y").pfValue, Le = e.pstyle("ghost-opacity").value, Ae = Le * c;
      r.translate(Be, Oe), F(), de(), ne(Le * A), le(), De(Ae, !0), X(Le * N), se(), we(D !== 0 || P !== 0), me(D !== 0 || P !== 0), De(Ae, !1), ge(Ae), r.translate(-Be, -Oe);
    }
    h && r.translate(-f.x, -f.y), xe(), h && r.translate(f.x, f.y), F(), de(), ne(), le(), De(c, !0), X(), se(), we(D !== 0 || P !== 0), me(D !== 0 || P !== 0), De(c, !1), ge(), h && r.translate(-f.x, -f.y), be(), ce(), t && r.translate(p.x1, p.y1);
  }
};
var Af = function(e) {
  if (!["overlay", "underlay"].includes(e))
...
pt.drawNodeOverlay = Af("overlay");
pt.drawNodeUnderlay = Af("underlay");
...
br.createGradientStyleFor = function(r, e, t, a, n) {
  ...
  if (a === "radial-gradient")
    ...
    var b = s ? {
      x: 0,
      y: 0
    } : t.position(), w = t.paddedWidth(), E = t.paddedHeight(), C = w / 2, x = E / 2, S = t.pstyle("background-gradient-direction").value;
    switch (S) {
      case "to-bottom":
...
br.gradientFillStyle = function(r, e, t, a) {
  var n = this.createGradientStyleFor(r, "background", e, t, a);
  if (!n) return null;
  r.fillStyle = n;
};
br.colorFillStyle = function(r, e, t, a, n) {
  r.fillStyle = "rgba(" + e + "," + t + "," + a + "," + n + ")";
};
br.eleFillStyle = function(r, e, t) {
...
br.gradientStrokeStyle = function(r, e, t, a) {
  var n = this.createGradientStyleFor(r, "line", e, t, a);
  if (!n) return null;
  r.strokeStyle = n;
};
br.colorStrokeStyle = function(r, e, t, a, n) {
  r.strokeStyle = "rgba(" + e + "," + t + "," + a + "," + n + ")";
};
br.eleStrokeStyle = function(r, e, t) {
...
br.render = function(r) {
  ...
  }, S = e.prevViewport, k = S === void 0 || x.zoom !== S.zoom || x.pan.x !== S.pan.x || x.pan.y !== S.pan.y;
  ...
  function D(X, F, H, W, U) {
    ...
    X.globalCompositeOperation = "destination-out", e.colorFillStyle(X, 255, 255, 255, e.motionBlurTransparency), X.fillRect(F, H, W, U), X.globalCompositeOperation = te;
  }
  function P(X, F) {
    var H, W, U, te;
    !e.clearingMotionBlur && (X === l.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] || X === l.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG]) ? (H = {
      x: E.x * h,
      y: E.y * h
    }, W = b * h, U = e.canvasWidth * h, te = e.canvasHeight * h) : (H = C, W = w, U = e.canvasWidth, te = e.canvasHeight), X.setTransform(1, 0, 0, 1, 0, 0), F === "motionBlur" ? D(X, 0, 0, U, te) : !a && (F === void 0 || F) && X.clearRect(0, 0, U, te), n || (X.translate(H.x, H.y), X.scale(W, W)), o && X.translate(o.x, o.y), s && X.scale(s, s);
  }
  ...
  if (N[e.NODE] = !v[e.NODE] && c && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, N[e.NODE] && (e.clearedForMotionBlur[e.NODE] = !0), N[e.DRAG] = !v[e.DRAG] && c && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, N[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = !0), v[e.NODE] || n || i || N[e.NODE]) {
    var V = c && !N[e.NODE] && h !== 1, R = a || (V ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] : l.contexts[e.NODE]), Y = c && !V ? "motionBlur" : void 0;
    P(R, Y), _ ? e.drawCachedNodes(R, B.nondrag, u, O) : e.drawLayeredElements(R, B.nondrag, u, O), e.debug && e.drawDebugPoints(R, B.nondrag), !n && !c && (v[e.NODE] = !1);
  }
  if (!i && (v[e.DRAG] || n || N[e.DRAG])) {
    var V = c && !N[e.DRAG] && h !== 1, R = a || (V ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : l.contexts[e.DRAG]);
    P(R, c && !V ? "motionBlur" : void 0), _ ? e.drawCachedNodes(R, B.drag, u, O) : e.drawCachedElements(R, B.drag, u, O), e.debug && e.drawDebugPoints(R, B.drag), !n && !c && (v[e.DRAG] = !1);
  }
  if (this.drawSelectionRectangle(r, P), c && h !== 1) {
    var J = l.contexts[e.NODE], Z = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_NODE], ee = l.contexts[e.DRAG], re = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_DRAG], ne = function(F, H, W) {
      F.setTransform(1, 0, 0, 1, 0, 0), W || !p ? F.clearRect(0, 0, e.canvasWidth, e.canvasHeight) : D(F, 0, 0, e.canvasWidth, e.canvasHeight);
      var U = h;
      F.drawImage(
        H,
        // img
    ...
    (v[e.NODE] || N[e.NODE]) && (ne(J, Z, N[e.NODE]), v[e.NODE] = !1), (v[e.DRAG] || N[e.DRAG]) && (ne(ee, re, N[e.DRAG]), v[e.DRAG] = !1);
  }
...
var ha;
br.drawSelectionRectangle = function(r, e) {
...
function rm(r, e, t, a) {
  var n = Rf(r, e), i = Qe(n, 2), s = i[0], o = i[1], u = Mf(r, o, a), l = r.createBuffer();
...
function Fr(r, e, t, a) {
  var n = Rf(r, t), i = Qe(n, 3), s = i[0], o = i[1], u = i[2], l = Mf(r, o, e * s), v = s * u, f = r.createBuffer();
...
var sm = /* @__PURE__ */ (function() {
  ...
  return ht(r, [{
    ...
    value: function(t, a, n) {
      ...
      var s = this.texSize, o = this.texRows, u = this.texHeight, l = this.getScale(a), v = l.scale, f = l.texW, c = l.texH, h = function(b, w) {
        if (n && w) {
          var E = w.context, C = b.x, x = b.row, S = C, k = u * x;
          E.save(), E.translate(S, k), E.scale(v, v), n(E, a), E.restore();
        }
        ...
        {
          var S = i.freePointer.x, k = i.freePointer.row * u, B = E;
          w.context.drawImage(b, 0, 0, B, x, S, k, B, x), d[0] = {
            x: S,
            y: k,
            w: B,
            h: c
    ...
    key: "bufferIfNeeded",
    value: function(t) {
      this.texture || (this.texture = jy(t, this.debugID)), this.needsBuffer && (this.texture.buffer(this.canvas), this.needsBuffer = !1, this.locked && (this.canvas = null, this.scratch = null));
    }
  }, {
    key: "dispose",
    value: function() {
  ...
  return ht(r, [{
    ...
    value: function() {
      ...
      try {
        var l = function() {
          var f = u.value, c = f.getKeys(), h = um(a, c);
          if (h.size === 0)
...
var lm = /* @__PURE__ */ (function() {
  ...
  return ht(r, [{
    ...
    value: function(t, a) {
      var n = this.globalOptions, i = n.webglTexSize, s = n.createTextureCanvas, o = a.texRows, u = this._cacheScratchCanvas(s), l = new om(this.r, i, o, u);
          ...
          if (u(y)) {
            ...
            try {
              var m = function() {
                ...
                if (v(E)) {
                  var C = a.collections.get(w.collection), x = w.getKey(y), S = Array.isArray(x) ? x : [x];
                  if (s)
                    ...
                    D !== void 0 && !Qy(S, D) && (f = !0, a.typeAndIdToKey.delete(B), D.forEach(function(P) {
                      return C.markKeyForGC(P);
                    }));
                  }
                }
    ...
    */
          ...
          for (v.s(); !(f = v.n()).done; ) {
            ...
            for (var g = s.getAtlasIndexForBatch(h), p = 0, m = [[d, !0], [y, !1]]; p < m.length; p++) {
              ...
              if (w.w != 0) {
                ...
                Ft(a, x);
                var S = this.atlasIdBuffer.getView(C);
                S[0] = g;
    ...
    value: function(t, a, n) {
      ...
      if (this._isVisible(t, i)) {
        ...
        if (this.vertTypeBuffer.getView(u)[0] = o, o === sn || o === ga) {
        ...
        this.setTransformMatrix(t, S, i), this.simpleCount++, this.instanceCount++, this.instanceCount >= this.maxInstances && this.endBatch();
      }
    }
  }, {
      ...
      if (t.visible()) {
        ...
        if (n === "source" ? (s = i.arrowStartX, o = i.arrowStartY, u = i.srcArrowAngle) : (s = i.arrowEndX, o = i.arrowEndY, u = i.tgtArrowAngle), !(isNaN(s) || s == null || isNaN(o) || o == null || isNaN(u) || u == null)) {
          ...
          if (l !== "none") {
            ...
            $l(m), yn(m, m, [s, o]), Ws(m, m, [g, g]), Ul(m, m, u), this.vertTypeBuffer.getView(p)[0] = Ts;
        ...
        if (n) {
          ...
          if (n.length / 2 + this.instanceCount > this.maxInstances && this.endBatch(), n.length == 4) {
            ...
            for (var y = 0; y < n.length - 2; y += 2) {
              ...
              b[0] = o;
              var w = n[y - 2], E = n[y - 1], C = n[y], x = n[y + 1], S = n[y + 2], k = n[y + 3], B = n[y + 4], D = n[y + 5];
              y == 0 && (w = 2 * C - S + 1e-3, E = 2 * x - k + 1e-3), y == n.length - 4 && (B = 2 * S - C + 1e-3, D = 2 * k - x + 1e-3);
              var P = this.pointAPointBBuffer.getView(g);
              P[0] = w, P[1] = E, P[2] = C, P[3] = x;
              var A = this.pointCPointDBuffer.getView(g);
              A[0] = S, A[1] = k, A[2] = B, A[3] = D, this.instanceCount++, this.instanceCount >= this.maxInstances && this.endBatch();
            }
        }
      }
    }
    ...
    value: function() {
      ...
      if (i !== 0) {
        ...
        t.uniform1f(s.uZoom, Xy(this.r)), t.uniformMatrix3fv(s.uPanZoomMatrix, !1, this.panZoomMatrix), t.uniform1i(s.uAtlasSize, this.batchManager.getAtlasSize());
...
Lf.initWebgl = function(r, e) {
  ...
  r.bgColor = pm(t), r.webglTexSize = Math.min(r.webglTexSize, a.getParameter(a.MAX_TEXTURE_SIZE)), r.webglTexRows = Math.min(r.webglTexRows, 54), r.webglTexRowsNodes = Math.min(r.webglTexRowsNodes, 54), r.webglBatchSize = Math.min(r.webglBatchSize, 16384), r.webglTexPerBatch = Math.min(r.webglTexPerBatch, a.getParameter(a.MAX_TEXTURE_IMAGE_UNITS)), t.webglDebug = r.webglDebug, t.webglDebugShowAtlases = r.webglDebugShowAtlases, t.pickingFrameBuffer = am(a), t.pickingFrameBuffer.needsDraw = !0, t.drawing = new gm(t, a, r);
  var n = function(f) {
    return function(c) {
...
function If(r, e) {
  var t = r._private.rscratch;
  return yr(t, "labelWrapCachedLines", e) || [];
}
var Ss = function(e, t) {
  return function(a) {
    var n = e(a), i = If(a, t);
  ...
  return function(a, n) {
    ...
    if (typeof n == "string") {
      var s = n.indexOf("_");
      if (s > 0) {
        var o = Number(n.substring(s + 1)), u = If(a, t), l = i.h / u.length, v = l * o, f = i.y1 + v;
        return {
          x1: i.x1,
          w: i.w,
          y1: f,
...
function ym(r) {
  {
    ...
    r.render = function(i) {
      i = i || {};
      var s = r.cy;
      r.webgl && (s.zoom() > kf ? (mm(r), e.call(r, i)) : (bm(r), Nf(r, i, Ea.SCREEN)));
    };
  }
  {
...
function Tm(r, e, t, a, n) {
  var i, s, o, u, l = bo(r), v = l.pan, f = l.zoom;
  {
    var c = Yy(r, v, f, e, t), h = Qe(c, 2), d = h[0], y = h[1], g = 6;
    i = d - g / 2, s = y - g / 2, o = g, u = g;
  }
  if (o === 0 || u === 0)
    return [];
  var p = r.data.contexts[r.WEBGL];
  p.bindFramebuffer(p.FRAMEBUFFER, r.pickingFrameBuffer), r.pickingFrameBuffer.needsDraw && (p.viewport(0, 0, p.canvas.width, p.canvas.height), Nf(r, null, Ea.PICKING), r.pickingFrameBuffer.needsDraw = !1);
...
function Sm(r, e, t) {
  var a = Tm(r, e, t), n = r.getCachedZSortedEles(), i, s, o = Cr(a), u;
  try {
    for (o.s(); !(u = o.n()).done; ) {
      var l = u.value, v = n[l];
...
function Nf(r, e, t) {
  ...
  var n = r.drawing, i = 0;
  if (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && xm(r, e), r.data.canvasNeedsRedraw[r.NODE] || t.picking) {
    ...
    var o = wm(r), u = r.getCachedZSortedEles();
    if (i = u.length, n.startFrame(o, t), t.screen) {
      ...
      for (var f = 0; f < u.length; f++)
        Ds(r, f, u[f]);
    n.endFrame(), t.screen && r.webglDebugShowAtlases && (Em(r), Cm(r)), r.data.canvasNeedsRedraw[r.NODE] = !1, r.data.canvasNeedsRedraw[r.DRAG] = !1;
  }
  if (r.webglDebug) {
...
yt.drawBarrelPath = function(r, e, t, a, n) {
  var i = a / 2, s = n / 2, o = e - i, u = e + i, l = t - s, v = t + s, f = As(a, n), c = f.widthOffset, h = f.heightOffset, d = f.ctrlPtOffsetPct * c;
...
var Yl = Math.sin(0), Zl = Math.cos(0), $s = {}, Us = {}, zf = Math.PI / 40;
for (var qt = 0 * Math.PI; qt < 2 * Math.PI; qt += zf)
  $s[qt] = Math.sin(qt), Us[qt] = Math.cos(qt);
yt.drawEllipsePath = function(r, e, t, a, n) {
  if (r.beginPath && r.beginPath(), r.ellipse)
    ...
    for (var i, s, o = a / 2, u = n / 2, l = 0 * Math.PI; l < 2 * Math.PI; l += zf)
      i = e - o * $s[l] * Yl + o * Us[l] * Zl, s = t + u * Us[l] * Yl + u * $s[l] * Zl, l === 0 ? r.moveTo(i, s) : r.lineTo(i, s);
  r.closePath();
};
var Wa = {};
...
function qf(r) {
  ...
  for (var l = 0; l < Te.CANVAS_LAYERS; l++) {
    ...
    e.data.contexts[l] = v.getContext(f), e.data.contexts[l] || He("Could not create canvas of type " + f), Object.keys(u).forEach(function(X) {
      v.style[X] = u[X];
  ...
  var c = mr(), h = function(F) {
    ...
    var H = F[0]._private, W = H.oldBackgroundTimestamp === H.backgroundTimestamp;
    return !W;
  }, g = function(F) {
  ...
  }, w = function(F, H, W, U, te) {
    return e.drawElement(F, H, W, !1, !1, te);
  }, E = function(F, H, W, U, te) {
    return e.drawElementText(F, H, W, U, "main", te);
  }, C = function(F, H, W, U, te) {
    return e.drawElementText(F, H, W, U, "source", te);
  }, x = function(F, H, W, U, te) {
    return e.drawElementText(F, H, W, U, "target", te);
  }, S = function(F) {
    return F.boundingBox(), F[0]._private.bodyBounds;
  }, k = function(F) {
    return F.boundingBox(), F[0]._private.labelBounds.main || c;
  }, B = function(F) {
    return F.boundingBox(), F[0]._private.labelBounds.source || c;
  }, D = function(F) {
    return F.boundingBox(), F[0]._private.labelBounds.target || c;
  }, P = function(F, H) {
    return H;
  }, A = function(F) {
    return h(S(F));
    ...
    var U = F ? F + "-" : "";
    return {
      x: H.x + W.pstyle(U + "text-margin-x").pfValue,
      y: H.y + W.pstyle(U + "text-margin-y").pfValue
    };
  }, L = function(F, H, W) {
    var U = F[0]._private.rscratch;
    return {
      x: U[H],
      y: U[W]
    };
  }, I = function(F) {
    return R("", L(F, "labelX", "labelY"), F);
  }, M = function(F) {
    return R("source", L(F, "sourceLabelX", "sourceLabelY"), F);
  }, O = function(F) {
    return R("target", L(F, "targetLabelX", "targetLabelY"), F);
  }, q = function(F) {
    return d(S(F));
  }, _ = function(F) {
    return d(B(F));
    ...
    var H = k(F), W = d(k(F));
    if (F.isNode()) {
      switch (Jt(F.pstyle("text-halign").value)) {
        case "left":
          W.x = -H.w - (H.leftPad || 0);
          break;
        case "right":
      ...
      switch (jt(F.pstyle("text-valign").value)) {
        case "top":
          W.y = -H.h - (H.topPad || 0);
          break;
        case "bottom":
    ...
    getRotationOffset: _,
    isVisible: P
  }), ee = e.data.tlbTxrCache = new ba(e, {
    getKey: b,
    drawElement: x,
    getBoundingBox: D,
    getRotationPoint: O,
    getRotationOffset: N,
    isVisible: P
  }), re = e.data.lyrTxrCache = new Df(e);
  e.onUpdateEleCalcs(function(F, H) {
    Y.invalidateElements(H), J.invalidateElements(H), Z.invalidateElements(H), ee.invalidateElements(H), re.invalidateElements(H);
  ...
  var ne = function(F) {
    for (var H = 0; H < F.length; H++)
      re.enqueueElementRefinement(F[H].ele);
  };
  Y.onDequeue(ne), J.onDequeue(ne), Z.onDequeue(ne), ee.onDequeue(ne), r.webgl && e.initWebgl(r, {
    getStyleKey: g,
    getLabelKey: p,
    getSourceLabelKey: m,
    getTargetLabelKey: b,
...
[Bf, Wr, Qr, mo, Mt, pt, br, Lf, yt, Wa, Vf].forEach(function(r) {
  ye(Te, r);
});
var Pm = [{
  name: "null",
...
function Hf(r, e, t) {
  var a = t, n = function(S) {
    ze("Can not register `" + e + "` for `" + r + "` since `" + S + "` already exists in the prototype and can not be overridden");
  };
  if (r === "core") {
    if (Ra.prototype[e])
      return n(e);
    ...
    for (var i = function(S) {
      this.options = S, t.call(this, S), Me(this._private) || (this._private = {}), this._private.cy = S.cy, this._private.listeners = [], this.createEmitter();
    ...
    var f = function(S) {
      ...
      addEventFields: function(S, k) {
        k.layout = S, k.cy = f(S), k.target = S;
      },
      bubble: function() {
        return !0;
      },
    ...
    ye(s, {
      ...
      on: function(S, k) {
        return this.emitter().on(S, k), this;
      },
      one: function(S, k) {
        return this.emitter().one(S, k), this;
      },
      once: function(S, k) {
        return this.emitter().one(S, k), this;
      },
      removeListener: function(S, k) {
        return this.emitter().removeListener(S, k), this;
      },
      removeAllListeners: function() {
        return this.emitter().removeAllListeners(), this;
      },
      emit: function(S, k) {
        return this.emitter().emit(S, k), this;
      }
...
At.css = function(r, e) {
  ...
  if (he(r))
    ...
    for (var a = r, n = Object.keys(a), i = 0; i < n.length; i++) {
      var s = n[i], o = a[s];
      if (o != null) {
        var u = ir.properties[s] || ir.properties[Mn(s)];
        if (u != null) {
          var l = u.name, v = o;
          this[t].properties.push({
            name: l,
