import { _ as dt, L as ke, af as Ze, l as Se, b as qe, a as Qe, q as Je, t as Ke, g as je, s as _e, A as tr, H as er, F as rr, I as ir, c as Ee, aO as me, b4 as pe, i as ar, d as nr, y as or, b5 as sr, b6 as hr } from "./index.js";
import { p as lr } from "./chunk-4BX2VUAB.js";
import { p as fr } from "./wardley-L42UT6IY.js";
import { c as Fe } from "./cytoscape.esm.js";
import { g as cr } from "./percentages-BXMCSKIN.js";
      ...
      return (
        ...
        (function(A) {
          ...
          function N(g) {
            ...
            return A[g].call(h.exports, h, h.exports, N), h.l = !0, h.exports;
          }
          return N.m = A, N.c = G, N.i = function(g) {
            return g;
          }, N.d = function(g, h, a) {
            N.o(g, h) || Object.defineProperty(g, h, {
              /******/
              configurable: !1,
              /******/
              enumerable: !0,
          ...
          /***/
          (function(A, G, N) {
            var g = N(2), h = N(8), a = N(9);
            function e(f, r, d) {
              g.call(this, d), this.isOverlapingSourceAndTarget = !1, this.vGraphObject = d, this.bendpoints = [], this.source = f, this.target = r;
            }
          ...
          /***/
          (function(A, G, N) {
            var g = N(2), h = N(10), a = N(13), e = N(0), i = N(16), f = N(5);
            function r(t, s, o, c) {
          ...
          /***/
          (function(A, G, N) {
            var g = N(2), h = N(10), a = N(0), e = N(7), i = N(3), f = N(1), r = N(13), d = N(12), t = N(11);
            function s(c, l, T) {
              g.call(this, T), this.estimatedSize = h.MIN_VALUE, this.margin = a.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = !1, this.parent = c, l != null && l instanceof e ? this.graphManager = l : l != null && l instanceof Layout && (this.graphManager = l.graphManager);
            }
            ...
            s.prototype.getNodes = function() {
              ...
              if (c instanceof i) {
                ...
                for (var T = l.edges.slice(), u, v = T.length, L = 0; L < v; L++)
                  u = T[L], u.isInterGraph ? this.graphManager.remove(u) : u.source.owner.remove(u);
                ...
                var C = u.source.edges.indexOf(u), F = u.target.edges.indexOf(u);
                if (!(C > -1 && F > -1))
                  throw "Source and/or target doesn't know this edge!";
                u.source.edges.splice(C, 1), u.target != u.source && u.target.edges.splice(F, 1);
              ...
              for (var c = h.MAX_VALUE, l = h.MAX_VALUE, T, u, v, L = this.getNodes(), P = L.length, C = 0; C < P; C++) {
                var F = L[C];
                T = F.getTop(), u = F.getLeft(), c > T && (c = T), l > u && (l = u);
              }
              return c == h.MAX_VALUE ? null : (L[0].getParent().paddingLeft != null ? v = L[0].getParent().paddingLeft : v = this.margin, this.left = l - v, this.top = c - v, new d(this.left, this.top));
            }, s.prototype.updateBounds = function(c) {
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, u = h.MAX_VALUE, v = -h.MAX_VALUE, L, P, C, F, V, X = this.nodes, Z = X.length, D = 0; D < Z; D++) {
                var _ = X[D];
                c && _.child != null && _.updateBounds(), L = _.getLeft(), P = _.getRight(), C = _.getTop(), F = _.getBottom(), l > L && (l = L), T < P && (T = P), u > C && (u = C), v < F && (v = F);
              }
              var n = new r(l, u, T - l, v - u);
              ...
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, u = h.MAX_VALUE, v = -h.MAX_VALUE, L, P, C, F, V = c.length, X = 0; X < V; X++) {
                var Z = c[X];
                L = Z.getLeft(), P = Z.getRight(), C = Z.getTop(), F = Z.getBottom(), l > L && (l = L), T < P && (T = P), u > C && (u = C), v < F && (v = F);
              }
              var D = new r(l, u, T - l, v - u);
              return D;
              ...
              var l = new t(), T = /* @__PURE__ */ new Set(), u = this.nodes[0], v, L, P = u.withChildren();
              for (P.forEach(function(D) {
                l.push(D), T.add(D);
              }); l.length !== 0; ) {
                u = l.shift(), v = u.getEdges();
                for (var C = v.length, F = 0; F < C; F++) {
                  var V = v[F];
                  if (L = V.getOtherEndInGraph(u, this), L != null && !T.has(L)) {
          ...
          (function(A, G, N) {
            var g, h = N(1);
            function a(e) {
              g = N(6), this.layout = e, this.graphs = [], this.edges = [];
            }
          ...
          (function(A, G, N) {
            ...
            h.calcSeparationAmount = function(a, e, i, f) {
              ...
              var s = a.getX(), o = a.getY(), c = a.getRight(), l = a.getX(), T = a.getBottom(), u = a.getRight(), v = a.getWidthHalf(), L = a.getHeightHalf(), P = e.getX(), C = e.getY(), F = e.getRight(), V = e.getX(), X = e.getBottom(), Z = e.getRight(), D = e.getWidthHalf(), _ = e.getHeightHalf(), n = !1, m = !1;
              if (f === d) {
                if (r > t)
                ...
                if (f > d)
                  return i[0] = s, i[1] = r, i[2] = F, i[3] = t, !1;
                if (f < d)
                ...
                if (-p === y ? f > d ? (i[0] = l, i[1] = T, n = !0) : (i[0] = c, i[1] = o, n = !0) : p === y && (f > d ? (i[0] = s, i[1] = o, n = !0) : (i[0] = u, i[1] = T, n = !0)), -E === y ? d > f ? (i[2] = V, i[3] = X, m = !0) : (i[2] = F, i[3] = C, m = !0) : E === y && (d > f ? (i[2] = P, i[3] = C, m = !0) : (i[2] = Z, i[3] = X, m = !0)), n && m)
                  return !1;
                ...
                if (!m)
                  switch (w) {
                    case 1:
                      Q = C, x = d + -_ / y, i[2] = x, i[3] = Q;
                      break;
                    case 2:
                      x = Z, Q = t + D * y, i[2] = x, i[3] = Q;
                      break;
                    case 3:
                      Q = X, x = d + _ / y, i[2] = x, i[3] = Q;
                      break;
                    case 4:
              ...
              var r = a.x, d = a.y, t = e.x, s = e.y, o = i.x, c = i.y, l = f.x, T = f.y, u = void 0, v = void 0, L = void 0, P = void 0, C = void 0, F = void 0, V = void 0, X = void 0, Z = void 0;
              return L = s - d, C = r - t, V = t * d - r * s, P = T - c, F = o - l, X = l * c - o * T, Z = L * F - P * C, Z === 0 ? null : (u = (C * X - F * V) / Z, v = (P * V - L * X) / Z, new g(u, v));
              ...
              var r = a.x, d = a.y, t = e.x, s = e.y, o = i.x, c = i.y, l = f.x, T = f.y, u = (t - r) * (T - c) - (l - o) * (s - d);
              if (u === 0)
                return !1;
              var v = ((T - c) * (l - r) + (o - l) * (T - d)) / u, L = ((d - s) * (l - r) + (t - r) * (T - d)) / u;
              ...
              if (l >= 0) {
                var T = (-o + Math.sqrt(o * o - 4 * s * c)) / (2 * s), u = (-o - Math.sqrt(o * o - 4 * s * c)) / (2 * s), v = null;
          ...
          (function(A, G, N) {
            ...
            g.prototype.getX = function() {
              ...
              return new g(this.x, this.y);
            }, g.prototype.setLocation = function(h, a, e) {
          ...
          (function(A, G, N) {
            ...
            var h = N(0), a = N(7), e = N(3), i = N(1), f = N(6), r = N(5), d = N(17), t = N(29);
            function s(o) {
            ...
            s.RANDOM_SEED = 1, s.prototype = Object.create(t.prototype), s.prototype.getGraphManager = function() {
              ...
              if (o == null)
                ...
                if (l != null) {
                  ...
                  for (var T = this.getAllNodes(), u, v = 0; v < T.length; v++)
                    u = T[v], u.transform(c);
                }
              }
              ...
              if (o == null)
                ...
                for (var c, l, T = o.getNodes(), u = 0; u < T.length; u++)
              ...
              for (var o = [], c = !0, l = this.graphManager.getRoot().getNodes(), T = !0, u = 0; u < l.length; u++)
                l[u].getChild() != null && (T = !1);
              if (!T)
                return o;
              var v = /* @__PURE__ */ new Set(), L = [], P = /* @__PURE__ */ new Map(), C = [];
              for (C = C.concat(l); C.length > 0 && c; ) {
                for (L.push(C[0]); L.length > 0 && c; ) {
                  var F = L[0];
                  L.splice(0, 1), v.add(F);
                  for (var V = F.getEdges(), u = 0; u < V.length; u++) {
                    var X = V[u].getOtherEnd(F);
                    if (P.get(F) != X)
                      if (!v.has(X))
                        L.push(X), P.set(X, F);
                      else {
              ...
              for (var c = [], l = o.source, T = this.graphManager.calcLowestCommonAncestor(o.source, o.target), u = 0; u < o.bendpoints.length; u++) {
              ...
              for (var c = 0; c < o.length; c++) {
                ...
                if (l.bendpoints.length > 0) {
                  for (var T = this.edgeToDummyNodes.get(l), u = 0; u < T.length; u++) {
                    var v = T[u], L = new r(v.getCenterX(), v.getCenterY()), P = l.bendpoints.get(u);
              ...
              var c = [];
              c = c.concat(o);
              var l = [], T = /* @__PURE__ */ new Map(), u = !1, v = null;
              (c.length == 1 || c.length == 2) && (u = !0, v = c[0]);
              for (var L = 0; L < c.length; L++) {
                var P = c[L], C = P.getNeighborsList().size;
              ...
              for (F = F.concat(l); !u; ) {
                ...
                V = V.concat(F), F = [];
                for (var L = 0; L < c.length; L++) {
                  var P = c[L], X = c.indexOf(P);
                  X >= 0 && c.splice(X, 1);
                  var Z = P.getNeighborsList();
                  Z.forEach(function(n) {
                    if (l.indexOf(n) < 0) {
                      var m = T.get(n), p = m - 1;
                      p == 1 && F.push(n), T.set(n, p);
                    }
                  });
                }
                l = l.concat(F), (c.length == 1 || c.length == 2) && (u = !0, v = c[0]);
              }
              return v;
          ...
          (function(A, G, N) {
            ...
            r.prototype.initParameters = function() {
              ...
              for (var t, s, o, c, l, T, u, v = this.getGraphManager().getAllEdges(), L = 0; L < v.length; L++)
                t = v[L], s = t.idealLength, t.isInterGraph && (c = t.getSource(), l = t.getTarget(), T = t.getSourceInLca().getEstimatedSize(), u = t.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (t.idealLength += T + u - 2 * e.SIMPLE_NODE_SIZE), o = t.getLca().getInclusionTreeDepth(), t.idealLength += s * a.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (c.getInclusionTreeDepth() + l.getInclusionTreeDepth() - 2 * o));
              ...
              var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0, s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, o, c, l, T, u = this.getAllNodes(), v;
              if (this.useFRGridVariant)
                for (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && t && this.updateGrid(), v = /* @__PURE__ */ new Set(), o = 0; o < u.length; o++)
                  l = u[o], this.calculateRepulsionForceOfANode(l, v, t, s), v.add(l);
              else
                for (o = 0; o < u.length; o++)
                  for (l = u[o], c = o + 1; c < u.length; c++)
              ...
              var o = t.getSource(), c = t.getTarget(), l, T, u, v;
              if (this.uniformLeafNodeSizes && o.getChild() == null && c.getChild() == null)
                ...
                return;
              l = t.getLength(), l != 0 && (T = t.edgeElasticity * (l - s), u = T * (t.lengthX / l), v = T * (t.lengthY / l), o.springForceX += u, o.springForceY += v, c.springForceX -= u, c.springForceY -= v);
            }, r.prototype.calcRepulsionForce = function(t, s) {
              var o = t.getRect(), c = s.getRect(), l = new Array(2), T = new Array(4), u, v, L, P, C, F, V;
              if (o.intersects(c)) {
                i.calcSeparationAmount(o, c, l, a.DEFAULT_EDGE_LENGTH / 2), F = 2 * l[0], V = 2 * l[1];
                var X = t.noOfChildren * s.noOfChildren / (t.noOfChildren + s.noOfChildren);
                t.repulsionForceX -= X * F, t.repulsionForceY -= X * V, s.repulsionForceX += X * F, s.repulsionForceY += X * V;
              } else
                this.uniformLeafNodeSizes && t.getChild() == null && s.getChild() == null ? (u = c.getCenterX() - o.getCenterX(), v = c.getCenterY() - o.getCenterY()) : (i.getIntersection(o, c, T), u = T[2] - T[0], v = T[3] - T[1]), Math.abs(u) < a.MIN_REPULSION_DIST && (u = f.sign(u) * a.MIN_REPULSION_DIST), Math.abs(v) < a.MIN_REPULSION_DIST && (v = f.sign(v) * a.MIN_REPULSION_DIST), L = u * u + v * v, P = Math.sqrt(L), C = (t.nodeRepulsion / 2 + s.nodeRepulsion / 2) * t.noOfChildren * s.noOfChildren / L, F = C * u / P, V = C * v / P, t.repulsionForceX -= F, t.repulsionForceY -= V, s.repulsionForceX += F, s.repulsionForceY += V;
              ...
              var c = 0, l = 0, T = 0, u = 0;
              c = parseInt(Math.floor((t.getRect().x - s) / this.repulsionRange)), l = parseInt(Math.floor((t.getRect().width + t.getRect().x - s) / this.repulsionRange)), T = parseInt(Math.floor((t.getRect().y - o) / this.repulsionRange)), u = parseInt(Math.floor((t.getRect().height + t.getRect().y - o) / this.repulsionRange));
              for (var v = c; v <= l; v++)
                for (var L = T; L <= u; L++)
                  this.grid[v][L].push(t), t.setGridCoordinates(c, l, T, u);
              ...
              if (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && o || c) {
                ...
                for (var T, u = this.grid, v = t.startX - 1; v < t.finishX + 2; v++)
                  for (var L = t.startY - 1; L < t.finishY + 2; L++)
                    if (!(v < 0 || L < 0 || v >= u.length || L >= u[0].length)) {
                      for (var P = 0; P < u[v][L].length; P++)
                        if (T = u[v][L][P], !(t.getOwner() != T.getOwner() || t == T) && !s.has(T) && !l.has(T)) {
                          var C = Math.abs(t.getCenterX() - T.getCenterX()) - (t.getWidth() / 2 + T.getWidth() / 2), F = Math.abs(t.getCenterY() - T.getCenterY()) - (t.getHeight() / 2 + T.getHeight() / 2);
                          C <= this.repulsionRange && F <= this.repulsionRange && l.add(T);
                        }
                    }
          ...
          (function(A, G, N) {
            var g = N(1), h = N(4);
            function a(i, f, r) {
              g.call(this, i, f, r), this.idealLength = h.DEFAULT_EDGE_LENGTH, this.edgeElasticity = h.DEFAULT_SPRING_STRENGTH;
            }
          ...
          (function(A, G, N) {
            var g = N(3), h = N(4);
            function a(i, f, r, d) {
              g.call(this, i, f, r, d), this.nodeRepulsion = h.DEFAULT_REPULSION_STRENGTH, this.springForceX = 0, this.springForceY = 0, this.repulsionForceX = 0, this.repulsionForceY = 0, this.gravitationForceX = 0, this.gravitationForceY = 0, this.displacementX = 0, this.displacementY = 0, this.startX = 0, this.finishX = 0, this.startY = 0, this.finishY = 0, this.surrounding = [];
            }
            a.prototype = Object.create(g.prototype);
            for (var e in g)
              a[e] = g[e];
            ...
            g.svd = function(h) {
              ...
              for (var z = this.n - 1; z >= 0; z--) {
                if (/* @__PURE__ */ (function(Tt, Ct) {
                  ...
                  for (var Y = z + 1; Y < a; Y++) {
                    ...
                    rt = -rt / this.V[z + 1][z];
                    for (var M = z + 1; M < this.n; M++)
                      this.V[M][Y] += rt * this.V[M][z];
                  }
              ...
              for (var $ = n - 1, tt = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                ...
                switch (J++, It) {
                  case 1:
                    {
                      ...
                      for (var gt = n - 2; gt >= J; gt--) {
                        var mt = g.hypot(this.s[gt], it), At = this.s[gt] / mt, Ot = it / mt;
                  ...
                  case 2:
                    {
                      ...
                      for (var Rt = J; Rt < n; Rt++) {
                        var Ht = g.hypot(this.s[Rt], Dt), Ut = this.s[Rt] / Ht, Pt = Dt / Ht;
                  ...
                  case 3:
                    {
                      var Yt = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(e[n - 2])), Math.abs(this.s[J])), Math.abs(e[J])), Vt = this.s[n - 1] / Yt, b = this.s[n - 2] / Yt, U = e[n - 2] / Yt, k = this.s[J] / Yt, K = e[J] / Yt, q = ((b + Vt) * (b - Vt) + U * U) / 2, at = Vt * U * (Vt * U), ct = 0;
                      /* @__PURE__ */ (function(Tt, Ct) {
                        return Tt || Ct;
                      })(q !== 0, at !== 0) && (ct = Math.sqrt(q * q + at), q < 0 && (ct = -ct), ct = at / (q + ct));
                      for (var nt = (k + Vt) * (k - Vt) + ct, et = k * K, j = J; j < n - 1; j++) {
                        var ut = g.hypot(nt, et), wt = nt / ut, pt = et / ut;
                        ...
                        if (ut = g.hypot(nt, et), wt = nt / ut, pt = et / ut, this.s[j] = ut, nt = wt * e[j] + pt * this.s[j + 1], this.s[j + 1] = -pt * e[j] + wt * this.s[j + 1], et = pt * e[j + 1], e[j + 1] = wt * e[j + 1], j < this.m - 1)
          ...
          (function(A, G, N) {
            ...
            g.FDLayout = N(18), g.FDLayoutConstants = N(4), g.FDLayoutEdge = N(19), g.FDLayoutNode = N(20), g.DimensionD = N(21), g.HashMap = N(22), g.HashSet = N(23), g.IGeometry = N(8), g.IMath = N(9), g.Integer = N(10), g.Point = N(12), g.PointD = N(5), g.RandomSeed = N(16), g.RectangleD = N(13), g.Transform = N(17), g.UniqueIDGeneretor = N(14), g.Quicksort = N(25), g.LinkedList = N(11), g.LGraphObject = N(2), g.LGraph = N(6), g.LEdge = N(1), g.LGraphManager = N(7), g.LNode = N(3), g.Layout = N(15), g.LayoutConstants = N(0), g.NeedlemanWunsch = N(27), g.Matrix = N(24), g.SVD = N(26), A.exports = g;
          }),
          /* 29 */
          /***/
          (function(A, G, N) {
        ...
        (() => {
          var G = {
            ...
            765: (
              /***/
              ((a, e, i) => {
                var f = i(551).FDLayout, r = i(578), d = i(880), t = i(991), s = i(767), o = i(806), c = i(902), l = i(551).FDLayoutConstants, T = i(551).LayoutConstants, u = i(551).Point, v = i(551).PointD, L = i(551).DimensionD, P = i(551).Layout, C = i(551).Integer, F = i(551).IGeometry, V = i(551).LGraph, X = i(551).Transform, Z = i(551).LinkedList;
                function D() {
                ...
                D.prototype.newGraphManager = function() {
                  ...
                  var y = function M(H) {
                    for (var $ = H.getChild().getNodes(), tt, ht = 0, J = 0; J < $.length; J++)
                      tt = $[J], tt.getChild() == null ? n.fixedNodeSet.has(tt.id) && (ht += 100) : ht += M(tt);
                    return ht;
                  };
                  ...
                  if (this.constraints.relativePlacementConstraint) {
                    ...
                    if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      this.shuffle = function(M) {
                        var H, $, tt;
                        for (tt = M.length - 1; tt >= 2 * M.length / 3; tt--)
                          H = Math.floor(Math.random() * (tt + 1)), $ = M[tt], M[tt] = M[H], M[H] = $;
                        return M;
                  ...
                  if (this.constraints.fixedNodeConstraint && this.constraints.fixedNodeConstraint.forEach(function(B) {
                    var M = n.idToNodeMap.get(B.nodeId);
                    ...
                    if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      this.totalIterations % 10 == 0 && (this.shuffle(this.nodesInRelativeHorizontal), this.shuffle(this.nodesInRelativeVertical)), this.nodesInRelativeHorizontal.forEach(function(B) {
                        if (!n.fixedNodesOnHorizontal.has(B)) {
                          var M = 0;
                          n.dummyToNodeForVerticalAlignment.has(B) ? M = n.idToNodeMap.get(n.dummyToNodeForVerticalAlignment.get(B)[0]).displacementX : M = n.idToNodeMap.get(B).displacementX, n.nodeToRelativeConstraintMapHorizontal.get(B).forEach(function(H) {
                            if (H.right) {
                              var $ = n.nodeToTempPositionMapHorizontal.get(H.right) - n.nodeToTempPositionMapHorizontal.get(B) - M;
                              $ < H.gap && (M -= H.gap - $);
                            } else {
                              var $ = n.nodeToTempPositionMapHorizontal.get(B) - n.nodeToTempPositionMapHorizontal.get(H.left) + M;
                              $ < H.gap && (M += H.gap - $);
                            }
                          }), n.nodeToTempPositionMapHorizontal.set(B, n.nodeToTempPositionMapHorizontal.get(B) + M), n.dummyToNodeForVerticalAlignment.has(B) ? n.dummyToNodeForVerticalAlignment.get(B).forEach(function(H) {
                            n.idToNodeMap.get(H).displacementX = M;
                          }) : n.idToNodeMap.get(B).displacementX = M;
                        }
                      }), this.nodesInRelativeVertical.forEach(function(B) {
                        if (!n.fixedNodesOnHorizontal.has(B)) {
                          var M = 0;
                          n.dummyToNodeForHorizontalAlignment.has(B) ? M = n.idToNodeMap.get(n.dummyToNodeForHorizontalAlignment.get(B)[0]).displacementY : M = n.idToNodeMap.get(B).displacementY, n.nodeToRelativeConstraintMapVertical.get(B).forEach(function(H) {
                            if (H.bottom) {
                              var $ = n.nodeToTempPositionMapVertical.get(H.bottom) - n.nodeToTempPositionMapVertical.get(B) - M;
                              $ < H.gap && (M -= H.gap - $);
                            } else {
                              var $ = n.nodeToTempPositionMapVertical.get(B) - n.nodeToTempPositionMapVertical.get(H.top) + M;
                              $ < H.gap && (M += H.gap - $);
                            }
                          }), n.nodeToTempPositionMapVertical.set(B, n.nodeToTempPositionMapVertical.get(B) + M), n.dummyToNodeForHorizontalAlignment.has(B) ? n.dummyToNodeForHorizontalAlignment.get(B).forEach(function(H) {
                            n.idToNodeMap.get(H).displacementY = M;
                          }) : n.idToNodeMap.get(B).displacementY = M;
                        }
                      });
                    else {
                  ...
                  for (var m = new u(0, 0), p = Math.ceil(Math.sqrt(n.length)), E = 0, y = 0, R = 0, w = new v(0, 0), S = 0; S < n.length; S++) {
                  ...
                  var y = V.calculateBounds(n), R = new X();
                  ...
                  var w = (E - p + 1) / 2;
                  w < 0 && (w += 180);
                  var S = (w + p) % 360, W = S * F.TWO_PI / 360, x = y * Math.cos(W), Q = y * Math.sin(W);
                  n.setCenter(x, Q);
                  var z = [];
                  z = z.concat(n.getEdges());
                  var Y = z.length;
                  m != null && Y--;
                  for (var rt = 0, B = z.length, M, H = n.getEdgesBetween(m); H.length > 1; ) {
                    var $ = H[0];
                    H.splice(0, 1);
                    var tt = z.indexOf($);
                    tt >= 0 && z.splice(tt, 1), B--, Y--;
                  }
                  m != null ? M = (z.indexOf(H[0]) + 1) % B : M = 0;
                  for (var ht = Math.abs(E - p) / Y, J = M; rt != Y; J = ++J % B) {
                    var It = z[J].getOtherEnd(n);
                    if (It != m) {
                      var Nt = (p + rt * ht) % 360, vt = (Nt + ht) % 360;
                      D.branchRadialLayout(It, n, Nt, vt, y + R, R), rt++;
                    }
                  }
                  ...
                  n.forEach(function(B) {
                    R += B.getWidth(), w += B.getHeight(), B.getWidth() > S && (S = B.getWidth());
                  });
                  var W = R / y, x = w / y, Q = Math.pow(p - E, 2) + 4 * (W + E) * (x + p) * y, z = (E - p + Math.sqrt(Q)) / (2 * (W + E)), Y;
                  m ? (Y = Math.ceil(z), Y == z && Y++) : Y = Math.floor(z);
                  var rt = Y * (W + E) - E;
                  return S > rt && (rt = S), rt += E * 2, rt;
                  ...
                  n.sort(function(B, M) {
                    var H = W;
                    return w.idealRowWidth ? (H = R, H(B.id, M.id)) : H(B, M);
                  });
                  ...
                  for (var z = 0; z < n.length; z++) {
                    ...
                    if (w.rows.length == 0)
                      ...
                      var rt = w.rows.length - 1;
                      w.idealRowWidth || (rt = this.getShortestRowIndex(w)), this.insertNodeToRow(w, Y, rt, m);
                    } else
                    ...
                    for (var R = 0; R < E.length; R++)
                      if (p = E[R], p.getEdges().length == 1 && !p.getEdges()[0].isInterGraph && p.getChild() == null) {
                        if (o.PURE_INCREMENTAL) {
                          var w = p.getEdges()[0].getOtherEnd(p), S = new L(p.getCenterX() - w.getCenterX(), p.getCenterY() - w.getCenterY());
                  ...
                  if (E == n[1].source ? p = n[1].target : p = n[1].source, o.PURE_INCREMENTAL)
                    ...
                    var y = p.startX, R = p.finishX, w = p.startY, S = p.finishY, W = 0, x = 0, Q = 0, z = 0, Y = [W, Q, x, z];
                    if (w > 0)
                      for (var rt = y; rt <= R; rt++)
                        Y[0] += this.grid[rt][w - 1].length + this.grid[rt][w].length - 1;
                    if (R < this.grid.length - 1)
                      for (var rt = w; rt <= S; rt++)
                        Y[1] += this.grid[R + 1][rt].length + this.grid[R][rt].length - 1;
                    if (S < this.grid[0].length - 1)
                      for (var rt = y; rt <= R; rt++)
                        Y[2] += this.grid[rt][S + 1].length + this.grid[rt][S].length - 1;
                    if (y > 0)
                      for (var rt = w; rt <= S; rt++)
                        Y[3] += this.grid[y - 1][rt].length + this.grid[y][rt].length - 1;
                    for (var B = C.MAX_VALUE, M, H, $ = 0; $ < Y.length; $++)
                      Y[$] < B ? (B = Y[$], M = 1, H = $) : Y[$] == B && M++;
                    if (M == 3 && B == 0)
            ...
            902: (
              ...
              ((a, e, i) => {
                ...
                o.handleConstraints = function(c) {
                  ...
                  for (var T = /* @__PURE__ */ new Map(), u = /* @__PURE__ */ new Map(), v = [], L = [], P = c.getAllNodes(), C = 0, F = 0; F < P.length; F++) {
                    var V = P[F];
                    V.getChild() == null && (u.set(V.id, C++), v.push(V.getCenterX()), L.push(V.getCenterY()), T.set(V.id, V));
                  }
                  ...
                  var X = function(U, k) {
                    return { x: U.x - k.x, y: U.y - k.y };
                  }, Z = function(U) {
                    var k = 0, K = 0;
                    return U.forEach(function(q) {
                      k += v[u.get(q)], K += L[u.get(q)];
                    }), { x: k / U.size, y: K / U.size };
                  }, D = function(U, k, K, q, at) {
                    function ct(lt, ot) {
                    ...
                    var et = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), ut = new d();
                    nt.forEach(function(lt, ot) {
                      lt == 0 ? (ut.push(ot), K || (k == "horizontal" ? et.set(ot, u.has(ot) ? v[u.get(ot)] : q.get(ot)) : et.set(ot, u.has(ot) ? L[u.get(ot)] : q.get(ot)))) : et.set(ot, Number.NEGATIVE_INFINITY), K && j.set(ot, /* @__PURE__ */ new Set([ot]));
                      ...
                      if (lt.forEach(function(st) {
                        ...
                        ot.forEach(function(st) {
                          k == "horizontal" ? (et.set(st, u.has(st) ? v[u.get(st)] : q.get(st)), Lt += et.get(st)) : (et.set(st, u.has(st) ? L[u.get(st)] : q.get(st)), Lt += et.get(st));
                        ...
                        lt.forEach(function(st) {
                          k == "horizontal" ? ft += u.has(st) ? v[u.get(st)] : q.get(st) : ft += u.has(st) ? L[u.get(st)] : q.get(st);
                    ...
                    for (var wt = function() {
                      ...
                      Lt.forEach(function(ft) {
                        if (et.get(ft.id) < et.get(ot) + ft.gap)
                          if (K && K.has(ft.id)) {
                            var st = void 0;
                            if (k == "horizontal" ? st = u.has(ft.id) ? v[u.get(ft.id)] : q.get(ft.id) : st = u.has(ft.id) ? L[u.get(ft.id)] : q.get(ft.id), et.set(ft.id, st), st < et.get(ot) + ft.gap) {
                      ...
                      j.forEach(function(lt, ot) {
                        ...
                        try {
                          for (var bt = lt[Symbol.iterator](), zt; !(Tt = (zt = bt.next()).done); Tt = !0) {
                            ...
                            k == "horizontal" ? kt = u.has(St) ? v[u.get(St)] : q.get(St) : kt = u.has(St) ? L[u.get(St)] : q.get(St);
                            var Kt = et.get(St);
                    ...
                    if (U.forEach(function(j) {
                      j.left ? v[u.get(j.left)] - v[u.get(j.right)] >= 0 ? k++ : K++ : L[u.get(j.top)] - L[u.get(j.bottom)] >= 0 ? q++ : at++;
                    }), k > K && q > at)
                    ...
                    var k = [], K = new d(), q = /* @__PURE__ */ new Set(), at = 0;
                  ...
                  if (l.fixedNodeConstraint && l.fixedNodeConstraint.forEach(function(b) {
                    ...
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1)
                      l.fixedNodeConstraint.forEach(function(b, U) {
                        E[U] = [b.position.x, b.position.y], y[U] = [v[u.get(b.nodeId)], L[u.get(b.nodeId)]];
                      }), R = !0;
                    else if (l.alignmentConstraint)
                      (function() {
                        var b = 0;
                        if (l.alignmentConstraint.vertical) {
                          for (var U = l.alignmentConstraint.vertical, k = function(et) {
                            ...
                            ut.size > 0 ? wt = v[u.get(ut.values().next().value)] : wt = Z(j).x, U[et].forEach(function(pt) {
                              E[b] = [wt, L[u.get(pt)]], y[b] = [v[u.get(pt)], L[u.get(pt)]], b++;
                            });
                          }, K = 0; K < U.length; K++)
                            k(K);
                          R = !0;
                        ...
                        if (l.alignmentConstraint.horizontal) {
                          for (var q = l.alignmentConstraint.horizontal, at = function(et) {
                            ...
                            ut.size > 0 ? wt = v[u.get(ut.values().next().value)] : wt = Z(j).y, q[et].forEach(function(pt) {
                              E[b] = [v[u.get(pt)], wt], y[b] = [v[u.get(pt)], L[u.get(pt)]], b++;
                            });
                          }, ct = 0; ct < q.length; ct++)
                            at(ct);
                          R = !0;
                      ...
                      if (z < x.size / 2)
                        _(l.relativePlacementConstraint), R = !1, w = !1;
                      else {
                        var B = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), H = [];
                        Q[Y].forEach(function(b) {
                          W.get(b).forEach(function(U) {
                            U.direction == "horizontal" ? (B.has(b) ? B.get(b).push(U) : B.set(b, [U]), B.has(U.id) || B.set(U.id, []), H.push({ left: b, right: U.id })) : (M.has(b) ? M.get(b).push(U) : M.set(b, [U]), M.has(U.id) || M.set(U.id, []), H.push({ top: b, bottom: U.id }));
                          });
                        }), _(H), w = !1;
                        var $ = D(B, "horizontal"), tt = D(M, "vertical");
                        Q[Y].forEach(function(b, U) {
                          y[U] = [v[u.get(b)], L[u.get(b)]], E[U] = [], $.has(b) ? E[U][0] = $.get(b) : E[U][0] = v[u.get(b)], tt.has(b) ? E[U][1] = tt.get(b) : E[U][1] = L[u.get(b)];
                        }), R = !0;
                      }
                    }
                    if (R) {
                      ...
                      w && _(l.relativePlacementConstraint);
                    }
                  }
                  if (r.ENFORCE_CONSTRAINTS) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                      var Et = { x: 0, y: 0 };
                      l.fixedNodeConstraint.forEach(function(b, U) {
                        var k = { x: v[u.get(b.nodeId)], y: L[u.get(b.nodeId)] }, K = b.position, q = X(K, k);
                        Et.x += q.x, Et.y += q.y;
                        ...
                        v[u.get(b.nodeId)] = b.position.x, L[u.get(b.nodeId)] = b.position.y;
                      });
                    }
                    if (l.alignmentConstraint) {
                      if (l.alignmentConstraint.vertical)
                        for (var Dt = l.alignmentConstraint.vertical, Rt = function(U) {
                          ...
                          K.size > 0 ? q = v[u.get(K.values().next().value)] : q = Z(k).x, k.forEach(function(at) {
                            S.has(at) || (v[u.get(at)] = q);
                          });
                      ...
                      if (l.alignmentConstraint.horizontal)
                        for (var Ut = l.alignmentConstraint.horizontal, Pt = function(U) {
                          ...
                          K.size > 0 ? q = L[u.get(K.values().next().value)] : q = Z(k).y, k.forEach(function(at) {
                            S.has(at) || (L[u.get(at)] = q);
                          });
                        }, Ft = 0; Ft < Ut.length; Ft++)
                          Pt(Ft);
                    }
                    l.relativePlacementConstraint && (function() {
                      var b = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), q = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map(), ct = /* @__PURE__ */ new Set(), nt = /* @__PURE__ */ new Set();
                        ...
                        if (l.alignmentConstraint.vertical)
                          for (var et = l.alignmentConstraint.vertical, j = function(yt) {
                            k.set("dummy" + yt, []), et[yt].forEach(function(Mt) {
                              b.set(Mt, "dummy" + yt), k.get("dummy" + yt).push(Mt), S.has(Mt) && ct.add("dummy" + yt);
                        ...
                        if (l.alignmentConstraint.horizontal)
                          for (var wt = l.alignmentConstraint.horizontal, pt = function(yt) {
                            K.set("dummy" + yt, []), wt[yt].forEach(function(Mt) {
                              U.set(Mt, "dummy" + yt), K.get("dummy" + yt).push(Mt), S.has(Mt) && nt.add("dummy" + yt);
                            }), at.set("dummy" + yt, L[u.get(wt[yt][0])]);
                      ...
                      var _t = D(lt, "horizontal", ct, q, Qt), Jt = D(ot, "vertical", nt, at, jt), oe = function(yt) {
                        k.get(yt) ? k.get(yt).forEach(function(Mt) {
                          v[u.get(Mt)] = _t.get(yt);
                  ...
                  for (var Yt = 0; Yt < P.length; Yt++) {
                    var Vt = P[Yt];
                    Vt.getChild() == null && Vt.setCenter(v[u.get(Vt.id)], L[u.get(Vt.id)]);
                  }
                }, a.exports = o;
              })
            ),
          ...
          function g(a) {
            ...
            return G[a](i, i.exports, g), i.exports;
          }
          var h = g(45);
          return h;
        })()
        ...
        (() => {
          var G = {
              ...
              ((a, e, i) => {
                var f = /* @__PURE__ */ (function() {
                  function t(s, o) {
                    ...
                    try {
                      for (var v = s[Symbol.iterator](), L; !(l = (L = v.next()).done) && (c.push(L.value), !(o && c.length === o)); l = !0)
                        ;
                    } catch (P) {
                      T = !0, u = P;
                    } finally {
                ...
                d.getTopMostNodes = function(t) {
                  ...
                  var l = new r(), T = /* @__PURE__ */ new Set(), u = [], v = void 0, L = void 0, P = void 0, C = !1, F = 1, V = [], X = [], Z = function() {
                    var _ = t.collection();
                    X.push(_);
                    var n = o[0], m = t.collection();
                    m.merge(n).merge(n.descendants().intersection(s)), u.push(n), m.forEach(function(y) {
                    ...
                    for (var p = function() {
                      ...
                      for (var w = 0; w < R.length; w++) {
                        ...
                        if (v = o.intersection(S.union(S.ancestors())), v != null && !T.has(v[0])) {
                          ...
                          W.forEach(function(x) {
                            l.push(x), T.add(x), _.merge(x), o.has(x) && u.push(x);
                          });
                        }
                      }
                    }; l.length != 0; )
                    ...
                    if (_.forEach(function(y) {
                      s.intersection(y.connectedEdges()).forEach(function(R) {
                        _.has(R.source()) && _.has(R.target()) && _.merge(R);
                      });
                    }), u.length == o.length && (C = !0), !C || C && F > 1) {
                      L = u[0], P = L.connectedEdges().length, u.forEach(function(y) {
                        y.connectedEdges().length < P && (P = y.connectedEdges().length, L = y);
                      }), V.push(L.id());
                      var E = t.collection();
                      E.merge(u[0]), u.forEach(function(y) {
                        E.merge(y);
                      }), u = [], o = o.difference(E), F++;
                    }
                  };
                  do
                    Z();
                  ...
                  if (!o.fixedNodeConstraint) {
                    ...
                    if (o.quality == "draft") {
                      var v = !0, L = !1, P = void 0;
                      try {
                        for (var C = s.nodeIndexes[Symbol.iterator](), F; !(v = (F = C.next()).done); v = !0) {
                          var V = F.value, X = f(V, 2), Z = X[0], D = X[1], _ = o.cy.getElementById(Z);
                          if (_) {
                      ...
                      Object.keys(s).forEach(function(x) {
                        ...
                        z < c && (c = z), Y > l && (l = Y), rt < T && (T = rt), B > u && (u = B);
                      });
                      var S = t.x - (l + c) / 2, W = t.y - (u + T) / 2;
                      Object.keys(s).forEach(function(x) {
                        var Q = s[x];
                  ...
                  for (var l = Number.MAX_SAFE_INTEGER, T = Number.MIN_SAFE_INTEGER, u = Number.MAX_SAFE_INTEGER, v = Number.MIN_SAFE_INTEGER, L = void 0, P = void 0, C = void 0, F = void 0, V = t.descendants().not(":parent"), X = V.length, Z = 0; Z < X; Z++) {
                    var D = V[Z];
                    L = s[c.get(D.id())] - D.width() / 2, P = s[c.get(D.id())] + D.width() / 2, C = o[c.get(D.id())] - D.height() / 2, F = o[c.get(D.id())] + D.height() / 2, l > L && (l = L), T < P && (T = P), u > C && (u = C), v < F && (v = F);
                  }
                  var _ = {};
                  return _.topLeftX = l, _.topLeftY = u, _.width = T - l, _.height = v - u, _;
            ...
            816: (
              /***/
              ((a, e, i) => {
                var f = i(548), r = i(140).CoSELayout, d = i(140).CoSENode, t = i(140).layoutBase.PointD, s = i(140).layoutBase.DimensionD, o = i(140).layoutBase.LayoutConstants, c = i(140).layoutBase.FDLayoutConstants, l = i(140).CoSEConstants, T = function(v, L) {
                  var P = v.cy, C = v.eles, F = C.nodes(), V = C.edges(), X = void 0, Z = void 0, D = void 0, _ = {};
                  v.randomize && (X = L.nodeIndexes, Z = L.xCoords, D = L.yCoords);
                  var n = function(x) {
                    return typeof x == "function";
                  }, m = function(x, Q) {
                    return n(x) ? x(Q) : x;
                  }, p = f.calcParentsWithoutChildren(P, C), E = function W(x, Q, z, Y) {
                    for (var rt = Q.length, B = 0; B < rt; B++) {
                      var M = Q[B], H = null;
                      M.intersection(p).length == 0 && (H = M.children());
                      var $ = void 0, tt = M.layoutDimensions({
                        nodeDimensionsIncludeLabels: Y.nodeDimensionsIncludeLabels
                      });
                      if (M.outerWidth() != null && M.outerHeight() != null)
                        if (Y.randomize)
                          if (!M.isParent())
                            $ = x.add(new d(z.graphManager, new t(Z[X.get(M.id())] - tt.w / 2, D[X.get(M.id())] - tt.h / 2), new s(parseFloat(tt.w), parseFloat(tt.h))));
                          else {
                            var ht = f.calcBoundingBox(M, Z, D, X);
                            M.intersection(p).length == 0 ? $ = x.add(new d(z.graphManager, new t(ht.topLeftX, ht.topLeftY), new s(ht.width, ht.height))) : $ = x.add(new d(z.graphManager, new t(ht.topLeftX, ht.topLeftY), new s(parseFloat(tt.w), parseFloat(tt.h))));
                          }
                        else
                          $ = x.add(new d(z.graphManager, new t(M.position("x") - tt.w / 2, M.position("y") - tt.h / 2), new s(parseFloat(tt.w), parseFloat(tt.h))));
                      else
                    ...
                    for (var Y = 0, rt = 0, B = 0; B < z.length; B++) {
                      var M = z[B], H = _[M.data("source")], $ = _[M.data("target")];
                      if (H && $ && H !== $ && H.getEdgesBetween($).length == 0) {
                        var tt = Q.add(x.newEdge(), H, $);
                        tt.id = M.id(), tt.idealLength = m(v.idealEdgeLength, M), tt.edgeElasticity = m(v.edgeElasticity, M), Y += tt.idealLength, rt++;
                      }
                    }
                    v.idealEdgeLength != null && (rt > 0 ? l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = Y / rt : n(v.idealEdgeLength) ? l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = 50 : l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = v.idealEdgeLength, l.MIN_REPULSION_DIST = c.MIN_REPULSION_DIST = c.DEFAULT_EDGE_LENGTH / 10, l.DEFAULT_RADIAL_SEPARATION = c.DEFAULT_EDGE_LENGTH);
                  }, R = function(x, Q) {
                  ...
                  return E(S.addRoot(), f.getTopMostNodes(F), w, v), y(w, S, V), R(w, v), w.runLayout(), _;
                };
            ...
            212: (
              ...
              ((a, e, i) => {
                ...
                var d = i(658), t = i(548), s = i(657), o = s.spectralLayout, c = i(816), l = c.coseLayout, T = Object.freeze({
                  ...
                  function v(L) {
                    r(this, v), this.options = d({}, T, L);
                  }
                  return f(v, [{
                    key: "run",
                    value: function() {
                      var P = this, C = this.options, F = C.cy, V = C.eles, X = [], Z = [], D = void 0, _ = [];
                      ...
                      var m = void 0, p = !1;
                      if (F.layoutUtilities && C.packComponents && (m = F.layoutUtilities("get"), m || (m = F.layoutUtilities()), p = !0), V.nodes().length > 0)
                        if (p) {
                          var R = t.getTopMostNodes(C.eles.nodes());
                          if (D = t.connectComponents(F, C.eles, R), D.forEach(function(vt) {
                            ...
                            var w = F.collection();
                            if (C.tile) {
                              var S = /* @__PURE__ */ new Map(), W = [], x = [], Q = 0, z = { nodeIndexes: S, xCoords: W, yCoords: x }, Y = [];
                              if (D.forEach(function(vt, it) {
                                vt.edges().length == 0 && (vt.nodes().forEach(function(gt, mt) {
                                  w.merge(vt.nodes()[mt]), gt.isParent() || (z.nodeIndexes.set(vt.nodes()[mt].id(), Q++), z.xCoords.push(vt.nodes()[0].position().x), z.yCoords.push(vt.nodes()[0].position().y));
                                }), Y.push(it));
                              }), w.length > 1) {
                                var rt = w.boundingBox();
                                _.push({ x: rt.x1 + rt.w / 2, y: rt.y1 + rt.h / 2 }), D.push(w), X.push(z);
                                for (var B = Y.length - 1; B >= 0; B--)
                                  D.splice(Y[B], 1), X.splice(Y[B], 1), _.splice(Y[B], 1);
                              }
                            }
                            D.forEach(function(vt, it) {
                              C.eles = vt, Z.push(l(C, X[it])), t.relocateComponent(_[it], Z[it], C);
                            });
                          } else
                            D.forEach(function(vt, it) {
                              t.relocateComponent(_[it], X[it], C);
                            });
                          ...
                          if (D.length > 1) {
                            ...
                            var tt = m.packComponents(H, C.randomize).shifts;
                            if (C.quality == "draft")
                          ...
                          if (_.push({ x: E.x1 + E.w / 2, y: E.y1 + E.h / 2 }), C.randomize) {
                            var y = o(C);
                            X.push(y);
                          }
                          C.quality == "default" || C.quality == "proof" ? (Z.push(l(C, X[0])), t.relocateComponent(_[0], Z[0], C)) : t.relocateComponent(_[0], X[0], C);
                        }
                      ...
                      if (C.quality == "default" || C.quality == "proof" || C.randomize) {
                        var It = t.calcParentsWithoutChildren(F, V), Nt = V.filter(function(vt) {
                          return vt.css("display") == "none";
                        });
                        C.eles = V.not(Nt), V.nodes().not(":parent").not(Nt).layoutPositions(P, C, J), It.length > 0 && It.forEach(function(vt) {
                          vt.position(J(vt));
                        });
                      } else
            ...
            657: (
              ...
              ((a, e, i) => {
                var f = i(548), r = i(140).layoutBase.Matrix, d = i(140).layoutBase.SVD, t = function(o) {
                  var c = o.cy, l = o.eles, T = l.nodes(), u = l.nodes(":parent"), v = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map(), C = [], F = [], V = [], X = [], Z = [], D = [], _ = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = o.piTol, R = o.samplingType, w = o.nodeSeparation, S = void 0, W = function() {
                    for (var U = 0, k = 0, K = !1; k < S; ) {
                    ...
                    for (var q = [], at = 0, ct = 0, nt = 0, et = void 0, j = [], ut = 0, wt = 1, pt = 0; pt < m; pt++)
                      j[pt] = p;
                    for (q[ct] = U, j[U] = 0; ct >= at; ) {
                      nt = q[at++];
                      for (var xt = C[nt], lt = 0; lt < xt.length; lt++)
                        et = L.get(xt[lt]), j[et] == p && (j[et] = j[nt] + 1, q[++ct] = et);
                      D[nt][k] = j[nt] * w;
                    }
                    if (K) {
                    ...
                    for (var U = d.svd(_), k = U.S, K = U.U, q = U.V, at = k[0] * k[0] * k[0], ct = [], nt = 0; nt < S; nt++) {
                      ct[nt] = [];
                      for (var et = 0; et < S; et++)
                    ...
                    for (var U = void 0, k = void 0, K = [], q = [], at = [], ct = [], nt = 0; nt < m; nt++)
                      K[nt] = Math.random(), q[nt] = Math.random();
                    K = r.normalize(K), q = r.normalize(q);
                    for (var et = E, j = E, ut = void 0; ; ) {
                      for (var wt = 0; wt < m; wt++)
                        at[wt] = K[wt];
                      if (K = r.multGamma(r.multL(r.multGamma(at), D, n)), U = r.dotProduct(at, K), K = r.normalize(K), et = r.dotProduct(at, K), ut = Math.abs(et / j), ut <= 1 + y && ut >= 1)
                        break;
                      j = et;
                    }
                    ...
                    for (var lt = 0; lt < m; lt++)
                      ct[lt] = q[lt];
                    F = r.multCons(at, Math.sqrt(Math.abs(U))), V = r.multCons(ct, Math.sqrt(Math.abs(k)));
                  };
                  f.connectComponents(c, l, f.getTopMostNodes(T), v), u.forEach(function(b) {
                  ...
                  var M = !0, H = !1, $ = void 0;
                  try {
                    for (var tt = v.keys()[Symbol.iterator](), ht; !(M = (ht = tt.next()).done); M = !0) {
                      var J = ht.value;
                      L.set(J, rt++);
                    }
                  } catch (b) {
                  ...
                  u.forEach(function(b) {
                    ...
                    var k = 0, K = U.nodes(":childless")[0].connectedEdges().length;
                    U.nodes(":childless").forEach(function(q, at) {
                      q.connectedEdges().length < K && (K = q.connectedEdges().length, k = at);
                    }), P.set(b.id(), U.nodes(":childless")[k].id());
                  }), T.forEach(function(b) {
                    var U = void 0;
                    b.isParent() ? U = L.get(P.get(b.id())) : U = L.get(b.id()), b.neighborhood().nodes().forEach(function(k) {
                      l.intersection(b.edgesWith(k)).length > 0 && (k.isParent() ? C[U].push(P.get(k.id())) : C[U].push(k.id()));
                    });
                  });
                  var Nt = function(U) {
                    var k = L.get(U), K = void 0;
                    v.get(U).forEach(function(q) {
                      c.getElementById(q).isParent() ? K = P.get(q) : K = q, C[k].push(K), C[L.get(K)].push(U);
                    });
                  }, vt = !0, it = !1, gt = void 0;
                  try {
                  ...
                  if (m > 2) {
                    ...
                    for (var Rt = 0; Rt < S; Rt++)
                      n[Rt] = [];
                    return o.quality == "draft" || o.step == "all" ? (Q(R), z(), Y(), Et = { nodeIndexes: L, xCoords: F, yCoords: V }) : (L.forEach(function(b, U) {
                      F.push(c.getElementById(U).position("x")), V.push(c.getElementById(U).position("y"));
                    }), Et = { nodeIndexes: L, xCoords: F, yCoords: V }), Et;
                  } else {
                    var Ht = L.keys(), Ut = c.getElementById(Ht.next().value), Pt = Ut.position(), Ft = Ut.outerWidth();
                    if (F.push(Pt.x), V.push(Pt.y), m == 2) {
                      var Yt = c.getElementById(Ht.next().value), Vt = Yt.outerWidth();
                      F.push(Pt.x + Ft / 2 + Vt / 2 + o.idealEdgeLength), V.push(Pt.y);
                    }
                    return Et = { nodeIndexes: L, xCoords: F, yCoords: V }, Et;
                  }
                };
...
var xe = {
  ...
  const A = Wt(I) && qt(O), G = qt(I) && Wt(O);
  return A || G;
}, "isArchitectureDirectionXY"), Nr = /* @__PURE__ */ dt(function(I) {
  const O = I[0], A = I[1], G = Wt(O) && qt(A), N = qt(O) && Wt(A);
  return G || N;
  ...
  const G = A[0], N = A[1];
  return Wt(G) ? qt(N) ? [I + (G === "L" ? -1 : 1), O + (N === "T" ? 1 : -1)] : [I + (G === "L" ? -1 : 1), O] : Wt(N) ? [I + (N === "L" ? 1 : -1), O + (G === "T" ? 1 : -1)] : [I, O + (G === "T" ? 1 : -1)];
  ...
  addGroup({ id: O, icon: A, in: G, title: N }) {
    if (this.registeredIds?.[O] !== void 0)
      throw new Error(
  ...
  addEdge({
    ...
    if (!Re(G))
      throw new Error(
        `Invalid direction given for left hand side of edge ${O}--${A}. Expected (L,R,T,B) got ${String(G)}`
      );
    if (!Re(N))
      throw new Error(
  ...
  getDataStructures() {
    if (this.dataStructures === void 0) {
      const O = {}, A = Object.entries(this.nodes).reduce((e, [i, f]) => (e[i] = f.edges.reduce((r, d) => {
        ...
        return r;
      }, {}), e), {}), G = Object.keys(A)[0], N = { [G]: 1 }, g = Object.keys(A).reduce(
        (e, i) => i === G ? e : { ...e, [i]: 1 },
        {}
      ), h = /* @__PURE__ */ dt((e) => {
        const i = { [e]: [0, 0] }, f = [e];
      ...
      for (; Object.keys(g).length > 0; )
        a.push(h(Object.keys(g)[0]));
      this.dataStructures = {
        adjList: A,
        spatialMaps: a,
        groupAlignments: O
...
}, Sr = /* @__PURE__ */ dt(async function(I, O, A, G) {
  const N = A.getConfigField("padding"), g = A.getConfigField("iconSize"), h = g / 2, a = g / 6, e = a / 2;
  await Promise.all(
    O.edges().map(async (i) => {
      const {
        source: f,
      ...
      let { x: C, y: F } = i[0].targetEndpoint();
      const V = N + 4;
      if (t && (Wt(r) ? u += r === "L" ? -V : V : v += r === "T" ? -V : V + 18), l && (Wt(o) ? C += o === "L" ? -V : V : F += o === "T" ? -V : V + 18), !t && A.getNode(f)?.type === "junction" && (Wt(r) ? u += r === "L" ? h : -h : v += r === "T" ? h : -h), !l && A.getNode(s)?.type === "junction" && (Wt(o) ? C += o === "L" ? h : -h : F += o === "T" ? h : -h), i[0]._private.rscratch) {
        const X = I.insert("g");
        if (X.insert("path").attr("d", `M ${u},${v} L ${L},${P} L${C},${F} `).attr("class", "edge").attr("id", `${G}-${or(f, s, { prefix: "L" })}`), d) {
          const Z = Wt(r) ? se[r](u, a) : u - e, D = qt(r) ? se[r](v, a) : v - e;
          X.insert("polygon").attr("points", Ie[r](a)).attr("transform", `translate(${Z},${D})`).attr("class", "arrow");
        }
        if (c) {
          const Z = Wt(o) ? se[o](C, a) : C - e, D = qt(o) ? se[o](F, a) : F - e;
          X.insert("polygon").attr("points", Ie[o](a)).attr("transform", `translate(${Z},${D})`).attr("class", "arrow");
        }
        if (T) {
          const Z = Te(r, o) ? "XY" : Wt(r) ? "X" : "Y";
          let D = 0;
          Z === "X" ? D = Math.abs(u - C) : Z === "Y" ? D = Math.abs(v - F) / 1.5 : D = Math.abs(u - C) / 2;
          const _ = X.append("g");
          if (await me(
            _,
            T,
            ...
            _.attr("transform", "translate(" + L + ", " + P + ")");
          else if (Z === "Y")
            _.attr("transform", "translate(" + L + ", " + P + ") rotate(-90)");
          else if (Z === "XY") {
            const n = ye(r, o);
            if (n && Nr(n)) {
              const m = _.node().getBoundingClientRect(), [p, E] = Ar(n);
...
}, "drawEdges"), Fr = /* @__PURE__ */ dt(async function(I, O, A, G) {
  const g = A.getConfigField("padding") * 0.75, h = A.getConfigField("fontSize"), e = A.getConfigField("iconSize") / 2;
  await Promise.all(
    O.nodes().map(async (i) => {
      const f = ie(i);
      if (f.type === "group") {
        const { h: r, w: d, x1: t, y1: s } = i.boundingBox(), o = I.append("rect");
        o.attr("id", `${G}-group-${f.id}`).attr("x", t + e).attr("y", s + e).attr("width", d).attr("height", r).attr("class", "node-bkg");
        const c = I.append("g");
        let l = t, T = s;
        if (f.icon) {
          const u = c.append("g");
          u.html(
            `<g>${await pe(f.icon, { height: g, width: g, fallbackPrefix: ne.prefix })}</g>`
          ), u.attr(
            "transform",
        ...
        if (f.label) {
          ...
          await me(
            ...
            Ee()
          ), u.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), u.attr(
            "transform",
...
}, "drawGroups"), br = /* @__PURE__ */ dt(async function(I, O, A, G) {
  const N = Ee();
  for (const g of A) {
    ...
    if (g.icon)
      e.html(
        `<g>${await pe(g.icon, { height: a, width: a, fallbackPrefix: ne.prefix })}</g>`
      );
    else if (g.iconText) {
      e.html(
        `<g>${await pe("blank", { height: a, width: a, fallbackPrefix: ne.prefix })}</g>`
      );
      const t = e.append("g").append("foreignObject").attr("width", a).attr("height", a).append("div").attr("class", "node-icon-text").attr("style", `height: ${a}px;`).append("div").html(ar(g.iconText, N)), s = parseInt(
      ...
      e.append("path").attr("class", "node-bkg").attr("id", `${G}-node-${g.id}`).attr(
        "d",
        `M0,${a} V5 Q0,0 5,0 H${a - 5} Q${a},0 ${a},5 V${a} Z`
      );
    h.attr("id", `${G}-service-${g.id}`).attr("class", "architecture-service");
    const { width: i, height: f } = h.node().getBBox();
    g.width = i, g.height = f, I.setElementForId(g.id, h);
  }
  return 0;
}, "drawServices"), Pr = /* @__PURE__ */ dt(function(I, O, A, G) {
  A.forEach((N) => {
    const g = O.append("g"), h = I.getConfigField("iconSize");
    g.append("g").append("rect").attr("id", `${G}-node-${N.id}`).attr("fill-opacity", "0").attr("width", h).attr("height", h), g.attr("class", "architecture-junction");
    const { width: e, height: i } = g._groups[0][0].getBBox();
    g.width = e, g.height = i, I.setElementForId(N.id, g);
  });
}, "drawJunctions");
sr([
  {
...
function Xe(I, O) {
  O.nodes().map((A) => {
    ...
    if (G.type === "group")
      return;
    G.x = A.position().x, G.y = A.position().y, I.getElementById(G.id).attr("transform", "translate(" + (G.x || 0) + "," + (G.y || 0) + ")");
  });
}
dt(Xe, "positionNodes");
function He(I, O) {
...
function We(I, O) {
  I.forEach((A) => {
    const { lhsId: G, rhsId: N, lhsInto: g, lhsGroup: h, rhsInto: a, lhsDir: e, rhsDir: i, rhsGroup: f, title: r } = A, d = Te(A.lhsDir, A.rhsDir) ? "segments" : "straight", t = {
      id: `${G}-${N}`,
      label: r,
      source: G,
      sourceDir: e,
...
dt(We, "addEdges");
function Ve(I, O, A) {
  const G = /* @__PURE__ */ dt((a, e) => Object.entries(a).reduce(
    (i, [f, r]) => {
      let d = 0;
    ...
    return Object.entries(a).forEach(([f, [r, d]]) => {
      ...
      horiz: Object.values(G(e, "horizontal")).filter(
        (f) => f.length > 1
      ),
      vert: Object.values(G(i, "vertical")).filter(
        (f) => f.length > 1
      )
    };
  }), [g, h] = N.reduce(
...
dt(Ve, "getAlignments");
function ze(I, O) {
  const A = [], G = /* @__PURE__ */ dt((g) => `${g[0]},${g[1]}`, "posToStr"), N = /* @__PURE__ */ dt((g) => g.split(",").map((h) => parseInt(h)), "strToPos");
  return I.forEach((g) => {
    const h = Object.fromEntries(
      Object.entries(g).map(([f, r]) => [G(r), f])
    ), a = [G([0, 0])], e = {}, i = {
      L: [-1, 0],
      R: [1, 0],
      T: [0, 1],
      ...
      if (f) {
        ...
        if (r) {
          ...
          Object.entries(i).forEach(([t, s]) => {
            const o = G([d[0] + s[0], d[1] + s[1]]), c = h[o];
...
function Be(I, O, A, G, N, { spatialMaps: g, groupAlignments: h }) {
  return new Promise((a) => {
    ...
    e.remove(), He(A, i), Ue(I, i, N), Ye(O, i, N), We(G, i);
    const f = Ve(N, g, h), r = ze(g, N), d = N.getConfigField("iconSize"), t = N.getConfigField("idealEdgeLengthMultiplier") * d, s = 0.5 * d, o = N.getConfigField("edgeElasticity"), c = i.layout({
      name: "fcose",
      quality: "proof",
      ...
      idealEdgeLength(l) {
        const [T, u] = l.connectedNodes(), { parent: v } = ie(T), { parent: L } = ie(u);
        return v === L ? t : s;
      },
      edgeElasticity(l) {
        const [T, u] = l.connectedNodes(), { parent: v } = ie(T), { parent: L } = ie(u);
    ...
    c.one("layoutstop", () => {
      function l(T, u, v, L) {
        let P, C;
        const { x: F, y: V } = T, { x: X, y: Z } = u;
        C = (L - V + (F - v) * (V - Z) / (F - X)) / Math.sqrt(1 + Math.pow((V - Z) / (F - X), 2)), P = Math.sqrt(Math.pow(L - V, 2) + Math.pow(v - F, 2) - Math.pow(C, 2));
        const D = Math.sqrt(Math.pow(X - F, 2) + Math.pow(Z - V, 2));
        P = P / D;
        let _ = (X - F) * (L - V) - (Z - V) * (v - F);
        switch (!0) {
          case _ >= 0:
            _ = 1;
            break;
      ...
      for (const T of Object.values(i.edges()))
        if (T.data?.()) {
          const { x: u, y: v } = T.source().position(), { x: L, y: P } = T.target().position();
          if (u !== L && v !== P) {
            const C = T.sourceEndpoint(), F = T.targetEndpoint(), { sourceDir: V } = be(T), [X, Z] = qt(V) ? [C.x, F.y] : [F.x, C.y], { weights: D, distances: _ } = l(C, F, X, Z);
...
var Gr = /* @__PURE__ */ dt(async (I, O, A, G) => {
  const N = G.db;
  N.setDiagramId(O);
  const g = N.getServices(), h = N.getJunctions(), a = N.getGroups(), e = N.getEdges(), i = N.getDataStructures(), f = ke(O), r = f.append("g");
  r.attr("class", "architecture-edges");
  const d = f.append("g");
  d.attr("class", "architecture-services");
  const t = f.append("g");
  t.attr("class", "architecture-groups"), await br(N, d, g, O), Pr(N, d, h, O);
  const s = await Be(g, h, a, e, N, i);
  await Sr(r, s, N, O), await Fr(t, s, N, O), Xe(N, s), Ze(void 0, f, N.getConfigField("padding"), N.getConfigField("useMaxWidth"));
}, "draw"), Ur = { draw: Gr }, zr = {
  parser: Ge,
  get db() {
    return new Pe();
...
//# sourceMappingURL=architectureDiagram-3BPJPVTR.js.map
