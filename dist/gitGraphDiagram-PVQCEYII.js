import { p as le } from "./chunk-4BX2VUAB.js";
import { I as he } from "./chunk-QZHKN3VN.js";
import { t as $e, q as fe, s as ge, g as ue, a as ye, b as xe, _ as h, F as J, l as w, d as me, c as W, u as pe, G as be, A as we, k as B, H as ke, I as ve, K as Ce } from "./index.js";
import { p as Ee } from "./wardley-L42UT6IY.js";
var m = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
...
}, "getOptions"), Ie = /* @__PURE__ */ h(function(e) {
  let r = e.msg, t = e.id;
  const s = e.type;
  let o = e.tags;
...
}, "commit"), Re = /* @__PURE__ */ h(function(e) {
  let r = e.name;
  const t = e.order;
...
var Ge = /* @__PURE__ */ h(function() {
  ...
  const s = {
    ...
    Checkout: /* @__PURE__ */ h((o) => r.checkout(Ke(o)), "Checkout"),
    CherryPicking: /* @__PURE__ */ h((o) => r.cherryPick(Ue(o)), "CherryPicking")
  }[e.$type];
  ...
  tags: e.tags ?? void 0
}), "parseMerge"), Ke = /* @__PURE__ */ h((e) => e.branch, "parseCheckout"), Ue = /* @__PURE__ */ h((e) => ({
  id: e.id,
  targetId: "",
...
}, O = 10, _ = 40, L = 4, I = 2, G = 8, j = /* @__PURE__ */ new Set(["redux", "redux-dark", "redux-color", "redux-dark-color"]), X = 12, Z = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), Xe = /* @__PURE__ */ new Set(["dark", "redux-dark", "redux-dark-color", "neo-dark"]), H = /* @__PURE__ */ h((e, r, t = !1) => t && e > 0 ? (e - 1) % (r - 1) + 1 : e % r, "calcColorIndex"), C = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), F = 30, q = /* @__PURE__ */ new Map(), z = [], R = 0, y = "LR", Je = /* @__PURE__ */ h(() => {
  C.clear(), E.clear(), q.clear(), R = 0, z = [], y = "LR";
  ...
  if (r.type !== m.CHERRY_PICK && (r.customId && r.type === m.MERGE || r.type !== m.MERGE) && o.showCommitLabel) {
    ...
    if (l && (n.attr("x", t.posWithOffset - l.width / 2 - I).attr("y", t.y + 13.5).attr("width", l.width + 2 * I).attr("height", l.height + 2 * I), y === "TB" || y === "BT" ? (n.attr("x", t.x - (l.width + 4 * L + 5)).attr("y", t.y - 12), a.attr("x", t.x - (l.width + 4 * L)).attr("y", t.y + l.height - 12)) : a.attr("x", t.posWithOffset - l.width / 2), o.rotateCommitLabel))
      if (y === "TB" || y === "BT")
        a.attr(
          "transform",
          "rotate(-45, " + t.x + ", " + t.y + ")"
  ...
  y === "BT" && (l && Ze(g, r, n), g = g.reverse()), g.forEach(($) => {
    ...
    y === "TB" || y === "BT" ? E.set(c.id, { x: x.x, y: x.posWithOffset }) : E.set(c.id, { x: x.posWithOffset, y: x.y }), n = y === "BT" && l ? n + _ : n + _ + O, n > R && (R = n);
  });
  ...
  r.forEach((c, x) => {
    ...
    k.attr("x1", 0), k.attr("y1", b), k.attr("x2", R), k.attr("y2", b), k.attr("class", "branch branch" + u), y === "TB" ? (k.attr("y1", F), k.attr("x1", p), k.attr("y2", R), k.attr("x2", p)) : y === "BT" && (k.attr("y1", R), k.attr("x1", p), k.attr("y2", F), k.attr("x2", p)), z.push(b);
    const K = c.name, D = oe(K), T = $.insert("rect"), M = $.insert("g").attr("class", "branchLabel").insert("g").attr("class", "label branch-label" + u);
    ...
    ))) : y === "BT" ? (T.attr("x", p - v.width / 2 - 10).attr("y", R), M.attr("transform", "translate(" + (p - v.width / 2 - 5) + ", " + R + ")"), f && (T.attr("transform", `translate(${-N / 2 - 3}, ${A + 10})`), M.attr(
      "transform",
      "translate(" + (p - v.width / 2 - 5) + ", " + (R + A * 2 + 4) + ")"
...
`, "id:", r, t);
  ...
  let b = 0;
  a.forEach((k, K) => {
    const D = oe(k.name), T = l.append("g"), U = T.insert("g").attr("class", "branchLabel"), M = U.insert("g").attr("class", "label branch-label");
    M.node()?.appendChild(D);
    const v = D.getBBox();
    b = gr(k.name, b, K, v, n), M.remove(), U.remove(), T.remove();
