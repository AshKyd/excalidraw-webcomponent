import { g as ae } from "./chunk-55IACEB6.js";
import { s as ce } from "./chunk-2J33WTMH.js";
import { _ as h, l as C, p as le, r as he, F as de, I as j, c as P, i as G, b3 as ge, ac as ue, ad as pe, ae as fe } from "./index.js";
const _ = [];
for (let t = 0; t < 256; ++t)
...
function _e(t, e, a) {
  return crypto.randomUUID ? crypto.randomUUID() : be(t);
}
function be(t, e, a) {
  t = t || {};
  const l = t.random ?? t.rng?.() ?? Ee();
  if (l.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return l[6] = l[6] & 15 | 64, l[8] = l[8] & 63 | 128, me(l);
}
var q = (function() {
  var t = /* @__PURE__ */ h(function(L, s, i, o) {
    for (i = i || {}, o = L.length; o--; i[L[o]] = s) ;
    return i;
  }, "o"), e = [1, 4], a = [1, 13], l = [1, 12], n = [1, 15], d = [1, 16], f = [1, 20], y = [1, 19], E = [6, 7, 8], b = [1, 26], v = [1, 24], R = [1, 25], g = [6, 7, 11], A = [1, 6, 13, 15, 16, 19, 22], J = [1, 33], K = [1, 34], $ = [1, 6, 7, 11, 13, 15, 16, 19, 22], H = {
    ...
    performAction: /* @__PURE__ */ h(function(s, i, o, c, p, r, B) {
      var u = r.length - 1;
      switch (p) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: e }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: e }, { 6: a, 7: [1, 10], 9: 9, 12: 11, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: f, 22: y }, t(E, [2, 3]), { 1: [2, 2] }, t(E, [2, 4]), t(E, [2, 5]), { 1: [2, 6], 6: a, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: f, 22: y }, { 6: a, 9: 22, 12: 11, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: f, 22: y }, { 6: b, 7: v, 10: 23, 11: R }, t(g, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: f, 22: y }), t(g, [2, 18]), t(g, [2, 19]), t(g, [2, 20]), t(g, [2, 21]), t(g, [2, 23]), t(g, [2, 24]), t(g, [2, 26], { 19: [1, 30] }), { 20: [1, 31] }, { 6: b, 7: v, 10: 32, 11: R }, { 1: [2, 7], 6: a, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: f, 22: y }, t(A, [2, 14], { 7: J, 11: K }), t($, [2, 8]), t($, [2, 9]), t($, [2, 10]), t(g, [2, 15]), t(g, [2, 16]), t(g, [2, 17]), { 20: [1, 35] }, { 21: [1, 36] }, t(A, [2, 13], { 7: J, 11: K }), t($, [2, 11]), t($, [2, 12]), { 21: [1, 37] }, t(g, [2, 25]), t(g, [2, 27])],
    ...
    parse: /* @__PURE__ */ h(function(s) {
      var i = this, o = [0], c = [], p = [null], r = [], B = this.table, u = "", U = 0, Q = 0, ie = 2, Z = 1, se = r.slice.call(arguments, 1), m = Object.create(this.lexer), T = { yy: {} };
      ...
      var z = m.yylloc;
      r.push(z);
      var re = m.options && m.options.ranges;
      ...
      function ee() {
        var S;
        return S = c.pop() || m.lex() || Z, typeof S != "number" && (S instanceof Array && (c = S, S = c.pop()), S = i.symbols_[S] || S), S;
      }
      h(ee, "lex");
      for (var k, O, x, X, I = {}, V, N, te, F; ; ) {
        if (O = o[o.length - 1], this.defaultActions[O] ? x = this.defaultActions[O] : ((k === null || typeof k > "u") && (k = ee()), x = B[O] && B[O][k]), typeof x > "u" || !x.length || !x[0]) {
          var Y = "";
          F = [];
          for (V in B[O])
            this.terminals_[V] && V > ie && F.push("'" + this.terminals_[V] + "'");
          m.showPosition ? Y = "Parse error on line " + (U + 1) + `:
` + m.showPosition() + `
Expecting ` + F.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : Y = "Parse error on line " + (U + 1) + ": Unexpected " + (k == Z ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(Y, {
            text: m.match,
        ...
        switch (x[0]) {
          case 1:
            o.push(k), p.push(m.yytext), r.push(m.yylloc), o.push(x[1]), k = null, Q = m.yyleng, u = m.yytext, U = m.yylineno, z = m.yylloc;
            break;
          case 2:
            if (N = this.productions_[x[1]][1], I.$ = p[p.length - N], I._$ = {
              ...
              p,
              r
            ].concat(se)), typeof X < "u")
              return X;
            N && (o = o.slice(0, -1 * N * 2), p = p.slice(0, -1 * N), r = r.slice(0, -1 * N)), o.push(this.productions_[x[1]][0]), p.push(I.$), r.push(I._$), te = B[o[o.length - 2]][o[o.length - 1]], o.push(te);
            break;
          case 3:
            return !0;
        }
...
` + this.showPosition(), {
  ...
  return h(M, "Parser"), M.prototype = H, H.Parser = M, new M();
})();
q.parser = q;
var ke = q, Se = 12, D = {
  DEFAULT: 0,
  ...
  decorateNode(e) {
    if (!e)
      return;
    const a = P(), l = this.nodes[this.nodes.length - 1];
   ...
   */
  getData() {
    const e = this.getMindmap(), a = P(), n = ge().layout !== void 0, d = a;
...
}, h(w, "MindmapDB"), w), Ne = /* @__PURE__ */ h(async (t, e, a, l) => {
  C.debug(`Rendering mindmap diagram
` + t);
  const n = l.db, d = n.getData(), f = ae(e, d.config.securityLevel);
  if (d.type = l.type, d.layoutAlgorithm = le(d.config.layout, {
  ...
  const { themeVariables: E } = de(), { useGradient: b, gradientStart: v, gradientStop: R } = E;
  if (b && v && R) {
  ...
  for (let n = 0; n < t.THEME_COLOR_LIMIT; n++)
    t["lineColor" + n] = t["lineColor" + n] || t["cScaleInv" + n], ue(t["lineColor" + n]) ? t["lineColor" + n] = pe(t["lineColor" + n], 20) : t["lineColor" + n] = fe(t["lineColor" + n], 20);
  for (let n = 0; n < t.THEME_COLOR_LIMIT; n++) {
  ...
  return l;
}, "genSections"), ve = /* @__PURE__ */ h((t, e, a) => {
  let l = "";
  for (let n = 0; n < t; n++)
    l += `
    [data-look="neo"].mindmap-node.section-${n - 1} rect, [data-look="neo"].mindmap-node.section-${n - 1} path, [data-look="neo"].mindmap-node.section-${n - 1} circle, [data-look="neo"].mindmap-node.section-${n - 1} polygon {
...
//# sourceMappingURL=mindmap-definition-RKZ34NQL.js.map
