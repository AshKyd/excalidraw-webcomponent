import { _ as b, H as m, L as B, e as C, l as w, b as S, a as D, q as T, t as F, g as P, s as z, F as A, I as E, A as W } from "./index.js";
import { p as _ } from "./chunk-4BX2VUAB.js";
import { p as L } from "./wardley-L42UT6IY.js";
var N = E.packet, u, v = (u = class {
  constructor() {
    this.packet = [], this.setAccTitle = S, this.getAccTitle = D, this.setDiagramTitle = T, this.getDiagramTitle = F, this.getAccDescription = P, this.setAccDescription = z;
  }
  getConfig() {
    const t = m({
      ...N,
...
}, b(u, "PacketDB"), u), I = 1e4, M = /* @__PURE__ */ b((e, t) => {
  _(e, t);
  let r = -1, s = [], n = 1;
  ...
  for (let { start: a, end: i, bits: d, label: c } of e.blocks) {
    ...
    for (i ??= a + (d ?? 1) - 1, d ??= i - a + 1, r = i, w.debug(`Packet block ${a} - ${r} with label ${c}`); s.length <= l + 1 && t.getPacket().length < I; ) {
  ...
  parse: /* @__PURE__ */ b(async (e) => {
    const t = await L("packet", e), r = x.parser?.yy;
    if (!(r instanceof v))
      throw new Error(
...
//# sourceMappingURL=diagram-LMA3HP47.js.map
